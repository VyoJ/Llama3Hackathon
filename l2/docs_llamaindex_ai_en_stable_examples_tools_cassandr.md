...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/tools/cassandra/#cassandra-database-tools)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Tools
        ...
        *    Cassandra Database Tools [Cassandra Database Tools](https://docs.llamaindex.ai/en/stable/examples/tools/cassandra/)
            ...
            *   [Tools Provided](https://docs.llamaindex.ai/en/stable/examples/tools/cassandra/#tools-provided)
                ...
                *   [cassandra\_db\_schema](https://docs.llamaindex.ai/en/stable/examples/tools/cassandra/#cassandra_db_schema)
                *   [cassandra\_db\_select\_table\_data](https://docs.llamaindex.ai/en/stable/examples/tools/cassandra/#cassandra_db_select_table_data)
                *   [cassandra\_db\_query](https://docs.llamaindex.ai/en/stable/examples/tools/cassandra/#cassandra_db_query)
...
Cassandra Database Tools[¶](https://docs.llamaindex.ai/en/stable/examples/tools/cassandra/#cassandra-database-tools)
====================================================================================================================
...
=== Calling Function ===
Calling function: cassandra\_db\_select\_table\_data with args: {"keyspace":"llamaindex\_agent\_test","table":"user\_credentials","predicate":"user\_email = 'patrick@datastax.com'","limit":1}
Got output: \[Document(id\_='e5620177-c735-46f8-a09a-a0e062efcdec', embedding=None, metadata={}, excluded\_embed\_metadata\_keys=\[\], excluded\_llm\_metadata\_keys=\[\], relationships={}, text="Row(user\_email='patrick@datastax.com', password=None, user\_id=UUID('522b1fe2-2e36-4cef-a667-cd4237d08b89'))", start\_char\_idx=None, end\_char\_idx=None, text\_template='{metadata\_str}\\n\\n{content}', metadata\_template='{key}: {value}', metadata\_seperator='\\n')\]
========================
