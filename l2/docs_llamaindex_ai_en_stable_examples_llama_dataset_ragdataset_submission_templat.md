...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/llama_dataset/ragdataset_submission_template/#llamadataset-submission-template-notebook)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Llama Datasets
        ...
        *    LlamaDataset Submission Template Notebook [LlamaDataset Submission Template Notebook](https://docs.llamaindex.ai/en/stable/examples/llama_dataset/ragdataset_submission_template/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/llama_datasets/ragdataset_submission_template.ipynb)

`LlamaDataset` Submission Template Notebook[¶](https://docs.llamaindex.ai/en/stable/examples/llama_dataset/ragdataset_submission_template/#llamadataset-submission-template-notebook)
=====================================================================================================================================================================================
