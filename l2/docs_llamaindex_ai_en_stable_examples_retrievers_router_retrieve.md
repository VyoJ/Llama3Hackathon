Title: Router Retriever - LlamaIndex
...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/retrievers/router_retriever/#router-retriever)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Retrievers
        ...
        *    Router Retriever [Router Retriever](https://docs.llamaindex.ai/en/stable/examples/retrievers/router_retriever/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/retrievers/router_retriever.ipynb)

Router Retriever[¶](https://docs.llamaindex.ai/en/stable/examples/retrievers/router_retriever/#router-retriever)
================================================================================================================
...
\# initialize LLM + splitter llm = OpenAI(model="gpt-4") splitter = SentenceSplitter(chunk\_size=1024) nodes = splitter.get\_nodes\_from\_documents(documents)
