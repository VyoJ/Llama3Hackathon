...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/pipeline/query_pipeline_async/#query-pipeline-with-asyncparallel-execution)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Query Pipeline
        ...
        *    Query Pipeline with Async/Parallel Execution [Query Pipeline with Async/Parallel Execution](https://docs.llamaindex.ai/en/stable/examples/pipeline/query_pipeline_async/)
...
Query Pipeline with Async/Parallel Execution[¶](https://docs.llamaindex.ai/en/stable/examples/pipeline/query_pipeline_async/#query-pipeline-with-asyncparallel-execution)
=========================================================================================================================================================================
