...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/low_level/retrieval/#building-retrieval-from-scratch)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Low Level
        ...
        *    Building Retrieval from Scratch [Building Retrieval from Scratch](https://docs.llamaindex.ai/en/stable/examples/low_level/retrieval/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jerryjliu/llama_index/blob/main/docs/docs/examples/low_level/retrieval.ipynb)

Building Retrieval from Scratch[¶](https://docs.llamaindex.ai/en/stable/examples/low_level/retrieval/#building-retrieval-from-scratch)
======================================================================================================================================
