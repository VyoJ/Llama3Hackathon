...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/ZepIndexDemo/#zep-vector-store)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Zep Vector Store [Zep Vector Store](https://docs.llamaindex.ai/en/stable/examples/vector_stores/ZepIndexDemo/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/vector_stores/ZepIndexDemo.ipynb)

Zep Vector Store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/ZepIndexDemo/#zep-vector-store)
===============================================================================================================
