...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/UpstashVectorDemo/#upstash-vector-store)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Upstash Vector Store [Upstash Vector Store](https://docs.llamaindex.ai/en/stable/examples/vector_stores/UpstashVectorDemo/)
...
Upstash Vector Store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/UpstashVectorDemo/#upstash-vector-store)
============================================================================================================================
