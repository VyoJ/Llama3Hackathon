...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/LanceDBIndexDemo/#lancedb-vector-store)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    LanceDB Vector Store [LanceDB Vector Store](https://docs.llamaindex.ai/en/stable/examples/vector_stores/LanceDBIndexDemo/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/vector_stores/LanceDBIndexDemo.ipynb)

LanceDB Vector Store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/LanceDBIndexDemo/#lancedb-vector-store)
===========================================================================================================================
