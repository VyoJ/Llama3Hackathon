...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/prompts/emotion_prompt/#emotionprompt-in-rag)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Prompts
        ...
        *    EmotionPrompt in RAG [EmotionPrompt in RAG](https://docs.llamaindex.ai/en/stable/examples/prompts/emotion_prompt/)
...
EmotionPrompt in RAG[¶](https://docs.llamaindex.ai/en/stable/examples/prompts/emotion_prompt/#emotionprompt-in-rag)
===================================================================================================================
