...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/VespaIndexDemo/#vespa-vector-store-demo)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Vespa Vector Store demo [Vespa Vector Store demo](https://docs.llamaindex.ai/en/stable/examples/vector_stores/VespaIndexDemo/)
...
*   [Abstraction level of this integration](https://docs.llamaindex.ai/en/stable/examples/vector_stores/VespaIndexDemo/#abstraction-level-of-this-integration)
  ...
  ![Image 3: #Vespa](https://vespa.ai/assets/vespa-ai-logo-rock.svg)

[![Image 4: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/vector_stores/VespaVectorStoreDemo.ipynb)

Vespa Vector Store demo[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/VespaIndexDemo/#vespa-vector-store-demo)
===============================================================================================================================
