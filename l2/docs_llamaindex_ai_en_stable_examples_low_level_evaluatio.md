...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/low_level/evaluation/#building-evaluation-from-scratch)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Low Level
        ...
        *    Building Evaluation from Scratch [Building Evaluation from Scratch](https://docs.llamaindex.ai/en/stable/examples/low_level/evaluation/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/low_level/evaluation.ipynb)

Building Evaluation from Scratch[¶](https://docs.llamaindex.ai/en/stable/examples/low_level/evaluation/#building-evaluation-from-scratch)
=========================================================================================================================================
