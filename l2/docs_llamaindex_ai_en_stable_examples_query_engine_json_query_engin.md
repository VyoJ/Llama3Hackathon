...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/query_engine/json_query_engine/#json-query-engine)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Query Engines
        ...
        *    JSON Query Engine [JSON Query Engine](https://docs.llamaindex.ai/en/stable/examples/query_engine/json_query_engine/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jerryjliu/llama_index/blob/main/docs/docs/examples/query_engine/json_query_engine.ipynb)

JSON Query Engine[¶](https://docs.llamaindex.ai/en/stable/examples/query_engine/json_query_engine/#json-query-engine)
=====================================================================================================================
...
**{nl\_response}**") ) display(Markdown(f"
