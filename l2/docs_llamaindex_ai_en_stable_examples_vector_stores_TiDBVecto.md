...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/TiDBVector/#tidb-vector-store)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    TiDB Vector Store [TiDB Vector Store](https://docs.llamaindex.ai/en/stable/examples/vector_stores/TiDBVector/)
...
TiDB Vector Store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/TiDBVector/#tidb-vector-store)
===============================================================================================================
