...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/low_level/vector_store/#building-a-very-simple-vector-store-from-scratch)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Low Level
        ...
        *    Building a (Very Simple) Vector Store from Scratch [Building a (Very Simple) Vector Store from Scratch](https://docs.llamaindex.ai/en/stable/examples/low_level/vector_store/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/low_level/vector_store.ipynb)

Building a (Very Simple) Vector Store from Scratch[¶](https://docs.llamaindex.ai/en/stable/examples/low_level/vector_store/#building-a-very-simple-vector-store-from-scratch)
=============================================================================================================================================================================
...
class VectorStore3B(VectorStore2):
    ...
    def query(
        ...
        if len(nodes) \== 0:
            ...
            similarities, node\_ids \= dense\_search(query, nodes)
            result\_nodes \= \[self.node\_dict\[node\_id\] for node\_id in node\_ids\]
        return VectorStoreQueryResult(
            nodes\=result\_nodes, similarities\=similarities, ids\=node\_ids
        )
