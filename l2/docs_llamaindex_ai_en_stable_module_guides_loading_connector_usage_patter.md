...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Loading](https://docs.llamaindex.ai/en/stable/module_guides/loading/)
        ...
        *   [Data Connectors](https://docs.llamaindex.ai/en/stable/module_guides/loading/connector/)
            ...
            *    Usage Pattern [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/loading/connector/usage_pattern/)
                
                Table of contents
                
                *   [Get Started](https://docs.llamaindex.ai/en/stable/module_guides/loading/connector/usage_pattern/#get-started)
