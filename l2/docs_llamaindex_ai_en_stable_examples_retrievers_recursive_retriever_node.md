...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/retrievers/recursive_retriever_nodes/#recursive-retriever-node-references)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Retrievers
        ...
        *    Recursive Retriever + Node References [Recursive Retriever + Node References](https://docs.llamaindex.ai/en/stable/examples/retrievers/recursive_retriever_nodes/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jerryjliu/llama_index/blob/main/docs/docs/examples/retrievers/recursive_retriever_nodes.ipynb)

Recursive Retriever + Node References[¶](https://docs.llamaindex.ai/en/stable/examples/retrievers/recursive_retriever_nodes/#recursive-retriever-node-references)
=================================================================================================================================================================
