...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/FaissIndexDemo/#faiss-vector-store)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Faiss Vector Store [Faiss Vector Store](https://docs.llamaindex.ai/en/stable/examples/vector_stores/FaissIndexDemo/)
...
Faiss Vector Store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/FaissIndexDemo/#faiss-vector-store)
=====================================================================================================================
