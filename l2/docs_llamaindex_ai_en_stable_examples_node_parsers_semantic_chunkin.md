Title: Semantic Chunker - LlamaIndex
...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/node_parsers/semantic_chunking/#semantic-chunker)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Node Parsers & Text Splitters
        ...
        *    Semantic Chunker [Semantic Chunker](https://docs.llamaindex.ai/en/stable/examples/node_parsers/semantic_chunking/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/node_parsers/semantic_chunking.ipynb)

Semantic Chunker[¶](https://docs.llamaindex.ai/en/stable/examples/node_parsers/semantic_chunking/#semantic-chunker)
===================================================================================================================
...
2024-01-11 15:04:44 (1.76 MB/s) - ‘pg\_essay.txt’ saved \[75042/75042\]
...
for n in response.source\_nodes: display\_source\_node(n, source\_length=20000)
