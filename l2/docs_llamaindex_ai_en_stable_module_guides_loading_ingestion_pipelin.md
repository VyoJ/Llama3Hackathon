...
*   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/loading/ingestion_pipeline/#usage-pattern)
*   [Connecting to Vector Databases](https://docs.llamaindex.ai/en/stable/module_guides/loading/ingestion_pipeline/#connecting-to-vector-databases)
*   [Calculating embeddings in a pipeline](https://docs.llamaindex.ai/en/stable/module_guides/loading/ingestion_pipeline/#calculating-embeddings-in-a-pipeline)
*   [Caching](https://docs.llamaindex.ai/en/stable/module_guides/loading/ingestion_pipeline/#caching)
    
    *   [Local Cache Management](https://docs.llamaindex.ai/en/stable/module_guides/loading/ingestion_pipeline/#local-cache-management)
    *   [Remote Cache Management](https://docs.llamaindex.ai/en/stable/module_guides/loading/ingestion_pipeline/#remote-cache-management)
    
*   [Async Support](https://docs.llamaindex.ai/en/stable/module_guides/loading/ingestion_pipeline/#async-support)
*   [Document Management](https://docs.llamaindex.ai/en/stable/module_guides/loading/ingestion_pipeline/#document-management)
*   [Parallel Processing](https://docs.llamaindex.ai/en/stable/module_guides/loading/ingestion_pipeline/#parallel-processing)
*   [Modules](https://docs.llamaindex.ai/en/stable/module_guides/loading/ingestion_pipeline/#modules)
