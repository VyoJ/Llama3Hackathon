...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/MilvusHybridIndexDemo/#milvus-vector-store-with-hybrid-retrieval)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Milvus Vector Store With Hybrid Retrieval [Milvus Vector Store With Hybrid Retrieval](https://docs.llamaindex.ai/en/stable/examples/vector_stores/MilvusHybridIndexDemo/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/vector_stores/MilvusIndexDemo.ipynb)

Milvus Vector Store With Hybrid Retrieval[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/MilvusHybridIndexDemo/#milvus-vector-store-with-hybrid-retrieval)
==========================================================================================================================================================================
