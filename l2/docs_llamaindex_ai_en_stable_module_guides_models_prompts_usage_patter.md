...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/models/prompts/usage_pattern/#usage-pattern)
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Prompts](https://docs.llamaindex.ai/en/stable/module_guides/models/prompts/)
        ...
        *    Usage pattern [Usage pattern](https://docs.llamaindex.ai/en/stable/module_guides/models/prompts/usage_pattern/)
            
            Table of contents
            
            *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/models/prompts/usage_pattern/#usage-pattern)
                
                *   [Defining a custom prompt](https://docs.llamaindex.ai/en/stable/module_guides/models/prompts/usage_pattern/#defining-a-custom-prompt)
                *   [Getting and Setting Custom Prompts](https://docs.llamaindex.ai/en/stable/module_guides/models/prompts/usage_pattern/#getting-and-setting-custom-prompts)
                    
                    *   [Commonly Used Prompts](https://docs.llamaindex.ai/en/stable/module_guides/models/prompts/usage_pattern/#commonly-used-prompts)
                    *   [Accessing Prompts](https://docs.llamaindex.ai/en/stable/module_guides/models/prompts/usage_pattern/#accessing-prompts)
                    *   [Updating Prompts](https://docs.llamaindex.ai/en/stable/module_guides/models/prompts/usage_pattern/#updating-prompts)
                    *   [Modify prompts used in query engine](https://docs.llamaindex.ai/en/stable/module_guides/models/prompts/usage_pattern/#modify-prompts-used-in-query-engine)
                    *   [Modify prompts used in index construction](https://docs.llamaindex.ai/en/stable/module_guides/models/prompts/usage_pattern/#modify-prompts-used-in-index-construction)
                    
                *   [\[Advanced\] Advanced Prompt Capabilities](https://docs.llamaindex.ai/en/stable/module_guides/models/prompts/usage_pattern/#advanced-advanced-prompt-capabilities)
                    
                    *   [Partial Formatting](https://docs.llamaindex.ai/en/stable/module_guides/models/prompts/usage_pattern/#partial-formatting)
                    *   [Template Variable Mappings](https://docs.llamaindex.ai/en/stable/module_guides/models/prompts/usage_pattern/#template-variable-mappings)
                    *   [Function Mappings](https://docs.llamaindex.ai/en/stable/module_guides/models/prompts/usage_pattern/#function-mappings)
