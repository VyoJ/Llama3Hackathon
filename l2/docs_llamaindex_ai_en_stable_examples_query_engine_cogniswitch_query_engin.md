...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/query_engine/cogniswitch_query_engine/#cogniswitchqueryengine)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Query Engines
        ...
        *    Cogniswitch query engine [Cogniswitch query engine](https://docs.llamaindex.ai/en/stable/examples/query_engine/cogniswitch_query_engine/)
