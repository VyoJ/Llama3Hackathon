...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/pipeline/query_pipeline_pandas/#query-pipeline-over-pandas-dataframes)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Query Pipeline
        ...
        *    Query Pipeline over Pandas DataFrames [Query Pipeline over Pandas DataFrames](https://docs.llamaindex.ai/en/stable/examples/pipeline/query_pipeline_pandas/)
...
Query Pipeline over Pandas DataFrames[¶](https://docs.llamaindex.ai/en/stable/examples/pipeline/query_pipeline_pandas/#query-pipeline-over-pandas-dataframes)
=============================================================================================================================================================
