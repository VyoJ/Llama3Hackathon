...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/multi_modal/gemini/#multi-modal-llm-using-googles-gemini-model-for-image-understanding-and-build-retrieval-augmented-generation-with-llamaindex)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Multi-Modal
        ...
        *    Multi-Modal LLM using Google's Gemini model for image understanding and build Retrieval Augmented Generation with LlamaIndex [Multi-Modal LLM using Google's Gemini model for image understanding and build Retrieval Augmented Generation with LlamaIndex](https://docs.llamaindex.ai/en/stable/examples/multi_modal/gemini/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/multi_modal/gemini.ipynb)

Multi-Modal LLM using Google's Gemini model for image understanding and build Retrieval Augmented Generation with LlamaIndex[¶](https://docs.llamaindex.ai/en/stable/examples/multi_modal/gemini/#multi-modal-llm-using-googles-gemini-model-for-image-understanding-and-build-retrieval-augmented-generation-with-llamaindex)
==============================================================================================================================================================================================================================================================================================================================
...
for res in results:
    ...
    for r in res:
        ...
        if r\[0\] \== "description":
            ...
            metadata\[r\[0\]\] \= r\[1\]
    text\_node.metadata \= metadata
    nodes.append(text\_node)

from llama\_index.core.schema import TextNode nodes = \[\] for res in results: text\_node = TextNode() metadata = {} for r in res: # set description as text of TextNode if r\[0\] == "description": text\_node.text = r\[1\] else: metadata\[r\[0\]\] = r\[1\] text\_node.metadata = metadata nodes.append(text\_node)
