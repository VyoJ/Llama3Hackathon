...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/llm/sagemaker_endpoint_llm/#interacting-with-llm-deployed-in-amazon-sagemaker-endpoint-with-llamaindex)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    LLMs
        ...
        *    Interacting with LLM deployed in Amazon SageMaker Endpoint with LlamaIndex [Interacting with LLM deployed in Amazon SageMaker Endpoint with LlamaIndex](https://docs.llamaindex.ai/en/stable/examples/llm/sagemaker_endpoint_llm/)
            ...
            *   [Basic Usage](https://docs.llamaindex.ai/en/stable/examples/llm/sagemaker_endpoint_llm/#basic-usage)
                ...
                *   [Streaming](https://docs.llamaindex.ai/en/stable/examples/llm/sagemaker_endpoint_llm/#streaming)
                    ...
                    *   [Using stream\_complete endpoint](https://docs.llamaindex.ai/en/stable/examples/llm/sagemaker_endpoint_llm/#using-stream_complete-endpoint)
                    *   [Using stream\_chat endpoint](https://docs.llamaindex.ai/en/stable/examples/llm/sagemaker_endpoint_llm/#using-stream_chat-endpoint)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/104BZb4U1KLzOYArnCzhqN-CqJWZDeqhz?usp=sharing)

Interacting with LLM deployed in Amazon SageMaker Endpoint with LlamaIndex[¶](https://docs.llamaindex.ai/en/stable/examples/llm/sagemaker_endpoint_llm/#interacting-with-llm-deployed-in-amazon-sagemaker-endpoint-with-llamaindex)
===================================================================================================================================================================================================================================
