...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/query_transformations/query_transform_cookbook/#query-transform-cookbook)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Query Transformations
        ...
        *    Query Transform Cookbook [Query Transform Cookbook](https://docs.llamaindex.ai/en/stable/examples/query_transformations/query_transform_cookbook/)
...
Query Transform Cookbook[¶](https://docs.llamaindex.ai/en/stable/examples/query_transformations/query_transform_cookbook/#query-transform-cookbook)
===================================================================================================================================================
