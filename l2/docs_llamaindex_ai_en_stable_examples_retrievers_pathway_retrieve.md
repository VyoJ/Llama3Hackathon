...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/retrievers/pathway_retriever/#pathway-retriever)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Retrievers
        ...
        *    Pathway Retriever [Pathway Retriever](https://docs.llamaindex.ai/en/stable/examples/retrievers/pathway_retriever/)
            ...
            *   [Building your own data processing pipeline](https://docs.llamaindex.ai/en/stable/examples/retrievers/pathway_retriever/#building-your-own-data-processing-pipeline)
                ...
                *   [Prerequisites](https://docs.llamaindex.ai/en/stable/examples/retrievers/pathway_retriever/#prerequisites_1)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/retrievers/pathway_retriever.ipynb)

Pathway Retriever[¶](https://docs.llamaindex.ai/en/stable/examples/retrievers/pathway_retriever/#pathway-retriever)
===================================================================================================================
