...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/existing_data/weaviate_existing_data/#guide-using-vector-store-index-with-existing-weaviate-vector-store)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Guide: Using Vector Store Index with Existing Weaviate Vector Store [Guide: Using Vector Store Index with Existing Weaviate Vector Store](https://docs.llamaindex.ai/en/stable/examples/vector_stores/existing_data/weaviate_existing_data/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/vector_stores/existing_data/weaviate_existing_data.ipynb)

Guide: Using Vector Store Index with Existing Weaviate Vector Store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/existing_data/weaviate_existing_data/#guide-using-vector-store-index-with-existing-weaviate-vector-store)
============================================================================================================================================================================================================================================
