...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/TairIndexDemo/#tair-vector-store)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Tair Vector Store [Tair Vector Store](https://docs.llamaindex.ai/en/stable/examples/vector_stores/TairIndexDemo/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/vector_stores/TairIndexDemo.ipynb)

Tair Vector Store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/TairIndexDemo/#tair-vector-store)
==================================================================================================================
