...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/MetalIndexDemo/#metal-vector-store)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Metal Vector Store [Metal Vector Store](https://docs.llamaindex.ai/en/stable/examples/vector_stores/MetalIndexDemo/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/vector_stores/MetalIndexDemo.ipynb)

Metal Vector Store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/MetalIndexDemo/#metal-vector-store)
=====================================================================================================================
