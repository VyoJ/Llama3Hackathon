...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/prompts/prompts_rag/#prompt-engineering-for-rag)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Prompts
        ...
        *    Prompt Engineering for RAG [Prompt Engineering for RAG](https://docs.llamaindex.ai/en/stable/examples/prompts/prompts_rag/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/prompts/prompts_rag.ipynb)

Prompt Engineering for RAG[¶](https://docs.llamaindex.ai/en/stable/examples/prompts/prompts_rag/#prompt-engineering-for-rag)
============================================================================================================================
