...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/low_level/fusion_retriever/#building-an-advanced-fusion-retriever-from-scratch)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Low Level
        ...
        *    Building an Advanced Fusion Retriever from Scratch [Building an Advanced Fusion Retriever from Scratch](https://docs.llamaindex.ai/en/stable/examples/low_level/fusion_retriever/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/low_level/fusion_retriever.ipynb)

Building an Advanced Fusion Retriever from Scratch[¶](https://docs.llamaindex.ai/en/stable/examples/low_level/fusion_retriever/#building-an-advanced-fusion-retriever-from-scratch)
===================================================================================================================================================================================
