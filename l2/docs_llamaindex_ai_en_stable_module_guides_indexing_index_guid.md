...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/indexing/index_guide/#how-each-index-works)
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Indexing](https://docs.llamaindex.ai/en/stable/module_guides/indexing/)
        ...
        *    Index Guide [Index Guide](https://docs.llamaindex.ai/en/stable/module_guides/indexing/index_guide/)
            
            Table of contents
            
            *   [Summary Index (formerly List Index)](https://docs.llamaindex.ai/en/stable/module_guides/indexing/index_guide/#summary-index-formerly-list-index)
                
                *   [Querying](https://docs.llamaindex.ai/en/stable/module_guides/indexing/index_guide/#querying)
                
            *   [Vector Store Index](https://docs.llamaindex.ai/en/stable/module_guides/indexing/index_guide/#vector-store-index)
                
                *   [Querying](https://docs.llamaindex.ai/en/stable/module_guides/indexing/index_guide/#querying_1)
                
            *   [Tree Index](https://docs.llamaindex.ai/en/stable/module_guides/indexing/index_guide/#tree-index)
                
                *   [Querying](https://docs.llamaindex.ai/en/stable/module_guides/indexing/index_guide/#querying_2)
                
            *   [Keyword Table Index](https://docs.llamaindex.ai/en/stable/module_guides/indexing/index_guide/#keyword-table-index)
                
                *   [Querying](https://docs.llamaindex.ai/en/stable/module_guides/indexing/index_guide/#querying_3)
                
            *   [Property Graph Index](https://docs.llamaindex.ai/en/stable/module_guides/indexing/index_guide/#property-graph-index)
                
                *   [Querying](https://docs.llamaindex.ai/en/stable/module_guides/indexing/index_guide/#querying_4)
...
How Each Index Works[#](https://docs.llamaindex.ai/en/stable/module_guides/indexing/index_guide/#how-each-index-works "Permanent link")
=======================================================================================================================================
