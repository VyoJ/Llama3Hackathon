...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/multi_modal/image_to_image_retrieval/#image-to-image-retrieval-using-clip-embedding-and-image-correlation-reasoning-using-gpt4v)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Multi-Modal
        ...
        *    Image to Image Retrieval using CLIP embedding and image correlation reasoning using GPT4V [Image to Image Retrieval using CLIP embedding and image correlation reasoning using GPT4V](https://docs.llamaindex.ai/en/stable/examples/multi_modal/image_to_image_retrieval/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/multi_modal/image_to_image_retrieval.ipynb)

Image to Image Retrieval using CLIP embedding and image correlation reasoning using GPT4V[¶](https://docs.llamaindex.ai/en/stable/examples/multi_modal/image_to_image_retrieval/#image-to-image-retrieval-using-clip-embedding-and-image-correlation-reasoning-using-gpt4v)
===========================================================================================================================================================================================================================================================================
