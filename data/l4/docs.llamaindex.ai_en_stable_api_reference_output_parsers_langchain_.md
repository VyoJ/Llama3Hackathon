...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/output_parsers/langchain/#llama_index.output_parsers.langchain.LangchainOutputParser)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Output Parsers](https://docs.llamaindex.ai/en/stable/api_reference/output_parsers/)
        ...
        *    Langchain [Langchain](https://docs.llamaindex.ai/en/stable/api_reference/output_parsers/langchain/)
            
            Table of contents
            
            *   [LangchainOutputParser](https://docs.llamaindex.ai/en/stable/api_reference/output_parsers/langchain/#llama_index.output_parsers.langchain.LangchainOutputParser)
                
                *   [parse](https://docs.llamaindex.ai/en/stable/api_reference/output_parsers/langchain/#llama_index.output_parsers.langchain.LangchainOutputParser.parse)
                *   [format](https://docs.llamaindex.ai/en/stable/api_reference/output_parsers/langchain/#llama_index.output_parsers.langchain.LangchainOutputParser.format)
