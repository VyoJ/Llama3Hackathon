...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/dynamodb/#llama_index.storage.index_store.dynamodb.DynamoDBIndexStore)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *    Storage
        ...
        *   [Index Store](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/)
            ...
            *    Dynamodb [Dynamodb](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/dynamodb/)
                
                Table of contents
                
                *   [DynamoDBIndexStore](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/dynamodb/#llama_index.storage.index_store.dynamodb.DynamoDBIndexStore)
                    
                    *   [from\_table\_name](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/dynamodb/#llama_index.storage.index_store.dynamodb.DynamoDBIndexStore.from_table_name)
