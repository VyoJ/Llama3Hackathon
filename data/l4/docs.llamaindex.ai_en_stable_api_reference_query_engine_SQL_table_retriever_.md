...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/SQL_table_retriever/#llama_index.core.query_engine.SQLTableRetrieverQueryEngine)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Query Engines](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/)
        ...
        *    SQL table retriever [SQL table retriever](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/SQL_table_retriever/)
            
            Table of contents
            
            *   [SQLTableRetrieverQueryEngine](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/SQL_table_retriever/#llama_index.core.query_engine.SQLTableRetrieverQueryEngine)
                
                *   [sql\_retriever](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/SQL_table_retriever/#llama_index.core.query_engine.SQLTableRetrieverQueryEngine.sql_retriever)
