...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/voyage_query_engine/#llama_index.packs.voyage_query_engine.VoyageQueryEnginePack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Voyage query engine [Voyage query engine](https://docs.llamaindex.ai/en/stable/api_reference/packs/voyage_query_engine/)
            
            Table of contents
            
            *   [VoyageQueryEnginePack](https://docs.llamaindex.ai/en/stable/api_reference/packs/voyage_query_engine/#llama_index.packs.voyage_query_engine.VoyageQueryEnginePack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/voyage_query_engine/#llama_index.packs.voyage_query_engine.VoyageQueryEnginePack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/voyage_query_engine/#llama_index.packs.voyage_query_engine.VoyageQueryEnginePack.run)
