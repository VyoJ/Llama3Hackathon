...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/retrievers/router/#llama_index.core.retrievers.RouterRetriever)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Retrievers](https://docs.llamaindex.ai/en/stable/api_reference/retrievers/)
        ...
        *    Router [Router](https://docs.llamaindex.ai/en/stable/api_reference/retrievers/router/)
            
            Table of contents
            
            *   [RouterRetriever](https://docs.llamaindex.ai/en/stable/api_reference/retrievers/router/#llama_index.core.retrievers.RouterRetriever)
