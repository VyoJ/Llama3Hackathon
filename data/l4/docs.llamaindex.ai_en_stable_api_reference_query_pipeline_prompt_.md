...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/prompt/#llama_index.core.prompts.base.PromptComponent.input_keys)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Query Pipeline](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/)
        ...
        *    Prompt [Prompt](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/prompt/)
            
            Table of contents
            
            *   [input\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/prompt/#llama_index.core.prompts.base.PromptComponent.input_keys)
            *   [output\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/prompt/#llama_index.core.prompts.base.PromptComponent.output_keys)
            *   [set\_callback\_manager](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/prompt/#llama_index.core.prompts.base.PromptComponent.set_callback_manager)
