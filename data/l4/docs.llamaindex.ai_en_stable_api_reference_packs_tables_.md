...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/tables/#llama_index.packs.tables.ChainOfTablePack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Tables [Tables](https://docs.llamaindex.ai/en/stable/api_reference/packs/tables/)
            
            Table of contents
            
            *   [ChainOfTablePack](https://docs.llamaindex.ai/en/stable/api_reference/packs/tables/#llama_index.packs.tables.ChainOfTablePack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/tables/#llama_index.packs.tables.ChainOfTablePack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/tables/#llama_index.packs.tables.ChainOfTablePack.run)
                
            *   [MixSelfConsistencyPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/tables/#llama_index.packs.tables.MixSelfConsistencyPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/tables/#llama_index.packs.tables.MixSelfConsistencyPack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/tables/#llama_index.packs.tables.MixSelfConsistencyPack.run)
