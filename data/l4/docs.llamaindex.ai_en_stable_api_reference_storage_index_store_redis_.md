...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/redis/#llama_index.storage.index_store.redis.RedisIndexStore)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *    Storage
        ...
        *   [Index Store](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/)
            ...
            *    Redis [Redis](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/redis/)
                
                Table of contents
                
                *   [RedisIndexStore](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/redis/#llama_index.storage.index_store.redis.RedisIndexStore)
                    
                    *   [from\_redis\_client](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/redis/#llama_index.storage.index_store.redis.RedisIndexStore.from_redis_client)
                    *   [from\_host\_and\_port](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/redis/#llama_index.storage.index_store.redis.RedisIndexStore.from_host_and_port)
