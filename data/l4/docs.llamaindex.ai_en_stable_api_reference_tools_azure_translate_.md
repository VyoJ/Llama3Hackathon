...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/azure_translate/#llama_index.tools.azure_translate.AzureTranslateToolSpec)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Azure translate [Azure translate](https://docs.llamaindex.ai/en/stable/api_reference/tools/azure_translate/)
            
            Table of contents
            
            *   [AzureTranslateToolSpec](https://docs.llamaindex.ai/en/stable/api_reference/tools/azure_translate/#llama_index.tools.azure_translate.AzureTranslateToolSpec)
                
                *   [translate](https://docs.llamaindex.ai/en/stable/api_reference/tools/azure_translate/#llama_index.tools.azure_translate.AzureTranslateToolSpec.translate)
