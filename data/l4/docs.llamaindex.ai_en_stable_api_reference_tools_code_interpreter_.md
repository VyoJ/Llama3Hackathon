...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/code_interpreter/#llama_index.tools.code_interpreter.CodeInterpreterToolSpec)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Code interpreter [Code interpreter](https://docs.llamaindex.ai/en/stable/api_reference/tools/code_interpreter/)
            
            Table of contents
            
            *   [CodeInterpreterToolSpec](https://docs.llamaindex.ai/en/stable/api_reference/tools/code_interpreter/#llama_index.tools.code_interpreter.CodeInterpreterToolSpec)
                
                *   [code\_interpreter](https://docs.llamaindex.ai/en/stable/api_reference/tools/code_interpreter/#llama_index.tools.code_interpreter.CodeInterpreterToolSpec.code_interpreter)
