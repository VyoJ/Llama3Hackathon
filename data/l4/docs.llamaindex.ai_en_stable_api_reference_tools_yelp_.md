...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/yelp/#llama_index.tools.yelp.YelpToolSpec)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Yelp [Yelp](https://docs.llamaindex.ai/en/stable/api_reference/tools/yelp/)
            
            Table of contents
            
            *   [YelpToolSpec](https://docs.llamaindex.ai/en/stable/api_reference/tools/yelp/#llama_index.tools.yelp.YelpToolSpec)
                
                *   [business\_search](https://docs.llamaindex.ai/en/stable/api_reference/tools/yelp/#llama_index.tools.yelp.YelpToolSpec.business_search)
                *   [business\_reviews](https://docs.llamaindex.ai/en/stable/api_reference/tools/yelp/#llama_index.tools.yelp.YelpToolSpec.business_reviews)
