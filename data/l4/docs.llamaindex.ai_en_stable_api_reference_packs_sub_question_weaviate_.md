Title: Sub question weaviate - LlamaIndex

URL Source: https://docs.llamaindex.ai/en/stable/api_reference/packs/sub_question_weaviate/

Markdown Content:
Sub question weaviate - LlamaIndex
===============
             

[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/sub_question_weaviate/#llama_index.packs.sub_question_weaviate.WeaviateSubQuestionPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Sub question weaviate [Sub question weaviate](https://docs.llamaindex.ai/en/stable/api_reference/packs/sub_question_weaviate/)
            
            Table of contents
            
            *   [WeaviateSubQuestionPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/sub_question_weaviate/#llama_index.packs.sub_question_weaviate.WeaviateSubQuestionPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/sub_question_weaviate/#llama_index.packs.sub_question_weaviate.WeaviateSubQuestionPack.get_modules)
                *   [retrieve](https://docs.llamaindex.ai/en/stable/api_reference/packs/sub_question_weaviate/#llama_index.packs.sub_question_weaviate.WeaviateSubQuestionPack.retrieve)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/sub_question_weaviate/#llama_index.packs.sub_question_weaviate.WeaviateSubQuestionPack.run)
...
WeaviateSubQuestionPack [#](https://docs.llamaindex.ai/en/stable/api_reference/packs/sub_question_weaviate/#llama_index.packs.sub_question_weaviate.WeaviateSubQuestionPack "Permanent link")
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span class="normal">79</span></pre></div></td><td class="code"><div><pre><span></span><code><span class="k">class</span> <span class="nc">WeaviateSubQuestionPack</span><span class="p">(</span><span class="n">BaseLlamaPack</span><span class="p">):</span>
<span class="w">    </span><span class="sd">"""Weaviate Sub-Question query engine pack."""</span>
...
<span class="w">        </span><span class="sd">"""Init params."""</span>
        ...
        <span class="n">query_engine_tools</span> <span class="o">=</span> <span class="p">[</span>
            <span class="n">QueryEngineTool</span><span class="p">(</span>
                <span class="n">query_engine</span><span class="o">=</span><span class="n">query_engine</span><span class="p">,</span> <span class="n">metadata</span><span class="o">=</span><span class="n">ToolMetadata</span><span class="p">(</span><span class="n">name</span><span class="o">=</span><span class="s2">"Vector Index"</span><span class="p">)</span>
            <span class="p">)</span>
        <span class="p">]</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">query_engine</span> <span class="o">=</span> <span class="n">SubQuestionQueryEngine</span><span class="o">.</span><span class="n">from_defaults</span><span class="p">(</span>
            <span class="n">query_engine_tools</span><span class="o">=</span><span class="n">query_engine_tools</span>
        <span class="p">)</span>
...
### get\_modules [#](https://docs.llamaindex.ai/en/stable/api_reference/packs/sub_question_weaviate/#llama_index.packs.sub_question_weaviate.WeaviateSubQuestionPack.get_modules "Permanent link")
...
### retrieve [#](https://docs.llamaindex.ai/en/stable/api_reference/packs/sub_question_weaviate/#llama_index.packs.sub_question_weaviate.WeaviateSubQuestionPack.retrieve "Permanent link")
...
### run [#](https://docs.llamaindex.ai/en/stable/api_reference/packs/sub_question_weaviate/#llama_index.packs.sub_question_weaviate.WeaviateSubQuestionPack.run "Permanent link")
...
[Previous Streamlit chatbot](https://docs.llamaindex.ai/en/stable/api_reference/packs/streamlit_chatbot/)[Next Subdoc summary](https://docs.llamaindex.ai/en/stable/api_reference/packs/subdoc_summary/)
