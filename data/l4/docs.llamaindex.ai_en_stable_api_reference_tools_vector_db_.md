...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/vector_db/#llama_index.tools.vector_db.VectorDBToolSpec)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Vector db [Vector db](https://docs.llamaindex.ai/en/stable/api_reference/tools/vector_db/)
            
            Table of contents
            
            *   [VectorDBToolSpec](https://docs.llamaindex.ai/en/stable/api_reference/tools/vector_db/#llama_index.tools.vector_db.VectorDBToolSpec)
                
                *   [auto\_retrieve\_fn](https://docs.llamaindex.ai/en/stable/api_reference/tools/vector_db/#llama_index.tools.vector_db.VectorDBToolSpec.auto_retrieve_fn)
