...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/load_and_search/#llama_index.core.tools.tool_spec.load_and_search.base.LoadAndSearchToolSpec)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Load and search [Load and search](https://docs.llamaindex.ai/en/stable/api_reference/tools/load_and_search/)
            
            Table of contents
            
            *   [LoadAndSearchToolSpec](https://docs.llamaindex.ai/en/stable/api_reference/tools/load_and_search/#llama_index.core.tools.tool_spec.load_and_search.base.LoadAndSearchToolSpec)
                
                *   [from\_defaults](https://docs.llamaindex.ai/en/stable/api_reference/tools/load_and_search/#llama_index.core.tools.tool_spec.load_and_search.base.LoadAndSearchToolSpec.from_defaults)
