...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/tool_runner/#llama_index.core.query_pipeline.components.tool_runner.ToolRunnerComponent.input_keys)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Query Pipeline](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/)
        ...
        *    Tool runner [Tool runner](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/tool_runner/)
            
            Table of contents
            
            *   [input\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/tool_runner/#llama_index.core.query_pipeline.components.tool_runner.ToolRunnerComponent.input_keys)
            *   [output\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/tool_runner/#llama_index.core.query_pipeline.components.tool_runner.ToolRunnerComponent.output_keys)
            *   [set\_callback\_manager](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/tool_runner/#llama_index.core.query_pipeline.components.tool_runner.ToolRunnerComponent.set_callback_manager)
