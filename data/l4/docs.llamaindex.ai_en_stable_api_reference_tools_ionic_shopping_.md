...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/ionic_shopping/#llama_index.tools.ionic_shopping.IonicShoppingToolSpec)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Ionic shopping [Ionic shopping](https://docs.llamaindex.ai/en/stable/api_reference/tools/ionic_shopping/)
            
            Table of contents
            
            *   [IonicShoppingToolSpec](https://docs.llamaindex.ai/en/stable/api_reference/tools/ionic_shopping/#llama_index.tools.ionic_shopping.IonicShoppingToolSpec)
                
                *   [query](https://docs.llamaindex.ai/en/stable/api_reference/tools/ionic_shopping/#llama_index.tools.ionic_shopping.IonicShoppingToolSpec.query)
