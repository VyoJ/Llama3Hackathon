...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/duckduckgo/#llama_index.tools.duckduckgo.DuckDuckGoSearchToolSpec)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Duckduckgo [Duckduckgo](https://docs.llamaindex.ai/en/stable/api_reference/tools/duckduckgo/)
            
            Table of contents
            
            *   [DuckDuckGoSearchToolSpec](https://docs.llamaindex.ai/en/stable/api_reference/tools/duckduckgo/#llama_index.tools.duckduckgo.DuckDuckGoSearchToolSpec)
                
                *   [duckduckgo\_instant\_search](https://docs.llamaindex.ai/en/stable/api_reference/tools/duckduckgo/#llama_index.tools.duckduckgo.DuckDuckGoSearchToolSpec.duckduckgo_instant_search)
                *   [duckduckgo\_full\_search](https://docs.llamaindex.ai/en/stable/api_reference/tools/duckduckgo/#llama_index.tools.duckduckgo.DuckDuckGoSearchToolSpec.duckduckgo_full_search)
