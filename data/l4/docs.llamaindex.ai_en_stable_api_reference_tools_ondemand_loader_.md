...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/ondemand_loader/#llama_index.core.tools.ondemand_loader_tool.OnDemandLoaderTool)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Ondemand loader [Ondemand loader](https://docs.llamaindex.ai/en/stable/api_reference/tools/ondemand_loader/)
            
            Table of contents
            
            *   [OnDemandLoaderTool](https://docs.llamaindex.ai/en/stable/api_reference/tools/ondemand_loader/#llama_index.core.tools.ondemand_loader_tool.OnDemandLoaderTool)
                
                *   [from\_defaults](https://docs.llamaindex.ai/en/stable/api_reference/tools/ondemand_loader/#llama_index.core.tools.ondemand_loader_tool.OnDemandLoaderTool.from_defaults)
                *   [from\_tool](https://docs.llamaindex.ai/en/stable/api_reference/tools/ondemand_loader/#llama_index.core.tools.ondemand_loader_tool.OnDemandLoaderTool.from_tool)
                *   [call](https://docs.llamaindex.ai/en/stable/api_reference/tools/ondemand_loader/#llama_index.core.tools.ondemand_loader_tool.OnDemandLoaderTool.call)
                *   [acall](https://docs.llamaindex.ai/en/stable/api_reference/tools/ondemand_loader/#llama_index.core.tools.ondemand_loader_tool.OnDemandLoaderTool.acall)
