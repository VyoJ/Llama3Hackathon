...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/node_parsers/langchain/#llama_index.core.node_parser.LangchainNodeParser)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Node Parsers & Text Splitters](https://docs.llamaindex.ai/en/stable/api_reference/node_parsers/)
        ...
        *    Langchain [Langchain](https://docs.llamaindex.ai/en/stable/api_reference/node_parsers/langchain/)
            
            Table of contents
            
            *   [LangchainNodeParser](https://docs.llamaindex.ai/en/stable/api_reference/node_parsers/langchain/#llama_index.core.node_parser.LangchainNodeParser)
                
                *   [split\_text](https://docs.llamaindex.ai/en/stable/api_reference/node_parsers/langchain/#llama_index.core.node_parser.LangchainNodeParser.split_text)
