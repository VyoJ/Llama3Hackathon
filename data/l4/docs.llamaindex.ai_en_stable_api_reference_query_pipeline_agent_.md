...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/agent/#llama_index.core.query_pipeline.components.agent.AgentFnComponent.input_keys)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Query Pipeline](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/)
        ...
        *    Agent [Agent](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/agent/)
            
            Table of contents
            
            *   [input\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/agent/#llama_index.core.query_pipeline.components.agent.AgentFnComponent.input_keys)
            *   [output\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/agent/#llama_index.core.query_pipeline.components.agent.AgentFnComponent.output_keys)
            *   [set\_callback\_manager](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/agent/#llama_index.core.query_pipeline.components.agent.AgentFnComponent.set_callback_manager)
            *   [validate\_component\_outputs](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/agent/#llama_index.core.query_pipeline.components.agent.AgentFnComponent.validate_component_outputs)
            *   [input\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/agent/#llama_index.core.query_pipeline.components.agent.CustomAgentComponent.input_keys)
            *   [output\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/agent/#llama_index.core.query_pipeline.components.agent.CustomAgentComponent.output_keys)
            *   [set\_callback\_manager](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/agent/#llama_index.core.query_pipeline.components.agent.CustomAgentComponent.set_callback_manager)
            *   [input\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/agent/#llama_index.core.query_pipeline.components.agent.AgentInputComponent.input_keys)
            *   [output\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/agent/#llama_index.core.query_pipeline.components.agent.AgentInputComponent.output_keys)
            *   [set\_callback\_manager](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/agent/#llama_index.core.query_pipeline.components.agent.AgentInputComponent.set_callback_manager)
            *   [validate\_component\_outputs](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/agent/#llama_index.core.query_pipeline.components.agent.AgentInputComponent.validate_component_outputs)
