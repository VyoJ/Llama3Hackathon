...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/arxiv/#llama_index.tools.arxiv.ArxivToolSpec)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Arxiv [Arxiv](https://docs.llamaindex.ai/en/stable/api_reference/tools/arxiv/)
            
            Table of contents
            
            *   [ArxivToolSpec](https://docs.llamaindex.ai/en/stable/api_reference/tools/arxiv/#llama_index.tools.arxiv.ArxivToolSpec)
                
                *   [arxiv\_query](https://docs.llamaindex.ai/en/stable/api_reference/tools/arxiv/#llama_index.tools.arxiv.ArxivToolSpec.arxiv_query)
...
### arxiv\_query [#](https://docs.llamaindex.ai/en/stable/api_reference/tools/arxiv/#llama_index.tools.arxiv.ArxivToolSpec.arxiv_query "Permanent link")

```
arxiv_query(query: str, sort_by: Optional[str] = 'relevance')
```
...
| --- | --- | --- | --- |
| `query` | `str` | 
The query to be passed to arXiv.
...
Either 'relevance' (default) or 'recent'
...
<span class="normal">37</span>
<span class="normal">38</span>
<span class="normal">39</span></pre></div></td><td class="code"><div><pre><span></span><code><span class="k">def</span> <span class="nf">arxiv_query</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">query</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span> <span class="n">sort_by</span><span class="p">:</span> <span class="n">Optional</span><span class="p">[</span><span class="nb">str</span><span class="p">]</span> <span class="o">=</span> <span class="s2">"relevance"</span><span class="p">):</span>
<span class="w">    </span><span class="sd">"""</span>
<span class="sd">    A tool to query arxiv.org</span>
<span class="sd">    ArXiv contains a variety of papers that are useful for answering</span>
<span class="sd">    mathematic and scientific questions.</span>
