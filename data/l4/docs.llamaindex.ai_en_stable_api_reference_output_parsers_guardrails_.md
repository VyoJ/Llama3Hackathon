...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/output_parsers/guardrails/#llama_index.output_parsers.guardrails.GuardrailsOutputParser)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Output Parsers](https://docs.llamaindex.ai/en/stable/api_reference/output_parsers/)
        ...
        *    Guardrails [Guardrails](https://docs.llamaindex.ai/en/stable/api_reference/output_parsers/guardrails/)
            
            Table of contents
            
            *   [GuardrailsOutputParser](https://docs.llamaindex.ai/en/stable/api_reference/output_parsers/guardrails/#llama_index.output_parsers.guardrails.GuardrailsOutputParser)
                
                *   [from\_rail](https://docs.llamaindex.ai/en/stable/api_reference/output_parsers/guardrails/#llama_index.output_parsers.guardrails.GuardrailsOutputParser.from_rail)
                *   [from\_rail\_string](https://docs.llamaindex.ai/en/stable/api_reference/output_parsers/guardrails/#llama_index.output_parsers.guardrails.GuardrailsOutputParser.from_rail_string)
                *   [parse](https://docs.llamaindex.ai/en/stable/api_reference/output_parsers/guardrails/#llama_index.output_parsers.guardrails.GuardrailsOutputParser.parse)
                *   [format](https://docs.llamaindex.ai/en/stable/api_reference/output_parsers/guardrails/#llama_index.output_parsers.guardrails.GuardrailsOutputParser.format)
