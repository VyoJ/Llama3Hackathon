...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/brave_search/#llama_index.tools.brave_search.BraveSearchToolSpec)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Brave search [Brave search](https://docs.llamaindex.ai/en/stable/api_reference/tools/brave_search/)
            
            Table of contents
            
            *   [BraveSearchToolSpec](https://docs.llamaindex.ai/en/stable/api_reference/tools/brave_search/#llama_index.tools.brave_search.BraveSearchToolSpec)
                
                *   [brave\_search](https://docs.llamaindex.ai/en/stable/api_reference/tools/brave_search/#llama_index.tools.brave_search.BraveSearchToolSpec.brave_search)
