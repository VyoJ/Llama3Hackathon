...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/retrievers/sql/#llama_index.core.retrievers.NLSQLRetriever)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Retrievers](https://docs.llamaindex.ai/en/stable/api_reference/retrievers/)
        ...
        *    Sql [Sql](https://docs.llamaindex.ai/en/stable/api_reference/retrievers/sql/)
            
            Table of contents
            
            *   [NLSQLRetriever](https://docs.llamaindex.ai/en/stable/api_reference/retrievers/sql/#llama_index.core.retrievers.NLSQLRetriever)
                
                *   [retrieve\_with\_metadata](https://docs.llamaindex.ai/en/stable/api_reference/retrievers/sql/#llama_index.core.retrievers.NLSQLRetriever.retrieve_with_metadata)
                *   [aretrieve\_with\_metadata](https://docs.llamaindex.ai/en/stable/api_reference/retrievers/sql/#llama_index.core.retrievers.NLSQLRetriever.aretrieve_with_metadata)
                
            *   [SQLParserMode](https://docs.llamaindex.ai/en/stable/api_reference/retrievers/sql/#llama_index.core.retrievers.SQLParserMode)
            *   [SQLRetriever](https://docs.llamaindex.ai/en/stable/api_reference/retrievers/sql/#llama_index.core.retrievers.SQLRetriever)
                
                *   [retrieve\_with\_metadata](https://docs.llamaindex.ai/en/stable/api_reference/retrievers/sql/#llama_index.core.retrievers.SQLRetriever.retrieve_with_metadata)
...
<span class="w">        </span><span class="sd">"""Load SQL parser."""</span>
        <span class="k">if</span> <span class="n">sql_parser_mode</span> <span class="o">==</span> <span class="n">SQLParserMode</span><span class="o">.</span><span class="n">DEFAULT</span><span class="p">:</span>
            <span class="k">return</span> <span class="n">DefaultSQLParser</span><span class="p">()</span>
        <span class="k">elif</span> <span class="n">sql_parser_mode</span> <span class="o">==</span> <span class="n">SQLParserMode</span><span class="o">.</span><span class="n">PGVECTOR</span><span class="p">:</span>
