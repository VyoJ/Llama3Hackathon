...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/storage/docstore/redis/#llama_index.storage.docstore.redis.RedisDocumentStore)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *    Storage
        ...
        *   [Docstore](https://docs.llamaindex.ai/en/stable/api_reference/storage/docstore/)
            ...
            *    Redis [Redis](https://docs.llamaindex.ai/en/stable/api_reference/storage/docstore/redis/)
                
                Table of contents
                
                *   [RedisDocumentStore](https://docs.llamaindex.ai/en/stable/api_reference/storage/docstore/redis/#llama_index.storage.docstore.redis.RedisDocumentStore)
                    
                    *   [from\_redis\_client](https://docs.llamaindex.ai/en/stable/api_reference/storage/docstore/redis/#llama_index.storage.docstore.redis.RedisDocumentStore.from_redis_client)
                    *   [from\_host\_and\_port](https://docs.llamaindex.ai/en/stable/api_reference/storage/docstore/redis/#llama_index.storage.docstore.redis.RedisDocumentStore.from_host_and_port)
