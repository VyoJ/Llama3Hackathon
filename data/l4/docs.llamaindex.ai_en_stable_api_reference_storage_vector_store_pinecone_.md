...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/storage/vector_store/pinecone/#llama_index.vector_stores.pinecone.PineconeVectorStore)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *    Storage
        ...
        *   [Vector Store](https://docs.llamaindex.ai/en/stable/api_reference/storage/vector_store/)
            ...
            *    Pinecone [Pinecone](https://docs.llamaindex.ai/en/stable/api_reference/storage/vector_store/pinecone/)
                
                Table of contents
                
                *   [PineconeVectorStore](https://docs.llamaindex.ai/en/stable/api_reference/storage/vector_store/pinecone/#llama_index.vector_stores.pinecone.PineconeVectorStore)
                    
                    *   [client](https://docs.llamaindex.ai/en/stable/api_reference/storage/vector_store/pinecone/#llama_index.vector_stores.pinecone.PineconeVectorStore.client)
                    *   [add](https://docs.llamaindex.ai/en/stable/api_reference/storage/vector_store/pinecone/#llama_index.vector_stores.pinecone.PineconeVectorStore.add)
                    *   [delete](https://docs.llamaindex.ai/en/stable/api_reference/storage/vector_store/pinecone/#llama_index.vector_stores.pinecone.PineconeVectorStore.delete)
                    *   [query](https://docs.llamaindex.ai/en/stable/api_reference/storage/vector_store/pinecone/#llama_index.vector_stores.pinecone.PineconeVectorStore.query)
