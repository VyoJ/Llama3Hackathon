...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/postgres/#llama_index.storage.index_store.postgres.PostgresIndexStore)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *    Storage
        ...
        *   [Index Store](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/)
            ...
            *    Postgres [Postgres](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/postgres/)
                
                Table of contents
                
                *   [PostgresIndexStore](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/postgres/#llama_index.storage.index_store.postgres.PostgresIndexStore)
                    
                    *   [from\_uri](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/postgres/#llama_index.storage.index_store.postgres.PostgresIndexStore.from_uri)
                    *   [from\_params](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/postgres/#llama_index.storage.index_store.postgres.PostgresIndexStore.from_params)
