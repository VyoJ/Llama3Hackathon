...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/readers/weaviate/#llama_index.readers.weaviate.WeaviateReader)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Readers](https://docs.llamaindex.ai/en/stable/api_reference/readers/)
        ...
        *    Weaviate [Weaviate](https://docs.llamaindex.ai/en/stable/api_reference/readers/weaviate/)
            
            Table of contents
            
            *   [WeaviateReader](https://docs.llamaindex.ai/en/stable/api_reference/readers/weaviate/#llama_index.readers.weaviate.WeaviateReader)
                
                *   [load\_data](https://docs.llamaindex.ai/en/stable/api_reference/readers/weaviate/#llama_index.readers.weaviate.WeaviateReader.load_data)
...
### load\_data [#](https://docs.llamaindex.ai/en/stable/api_reference/readers/weaviate/#llama_index.readers.weaviate.WeaviateReader.load_data "Permanent link")

```
load_data(class_name: Optional[str] = None, properties: Optional[List[str]] = None, graphql_query: Optional[str] = None, separate_documents: Optional[bool] = True) -> List[[Document](https://docs.llamaindex.ai/en/stable/api_reference/schema/#llama_index.core.schema.Document "llama_index.core.schema.Document")]
```

Load data from Weaviate.

If `graphql_query` is not found in load\_kwargs, we assume that `class_name` and `properties` are provided.
...
class\_name to retrieve documents from.
...
Raw GraphQL Query. We assume that the query is a Get query.
...
<span class="normal">114</span>
<span class="normal">115</span>
<span class="normal">116</span></pre></div></td><td class="code"><div><pre><span></span><code><span class="k">def</span> <span class="nf">load_data</span><span class="p">(</span>
    <span class="bp">self</span><span class="p">,</span>
    <span class="n">class_name</span><span class="p">:</span> <span class="n">Optional</span><span class="p">[</span><span class="nb">str</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
    <span class="n">properties</span><span class="p">:</span> <span class="n">Optional</span><span class="p">[</span><span class="n">List</span><span class="p">[</span><span class="nb">str</span><span class="p">]]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
    <span class="n">graphql_query</span><span class="p">:</span> <span class="n">Optional</span><span class="p">[</span><span class="nb">str</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
