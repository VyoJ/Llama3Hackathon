...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/readers/database/#llama_index.readers.database.DatabaseReader)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Readers](https://docs.llamaindex.ai/en/stable/api_reference/readers/)
        ...
        *    Database [Database](https://docs.llamaindex.ai/en/stable/api_reference/readers/database/)
            
            Table of contents
            
            *   [DatabaseReader](https://docs.llamaindex.ai/en/stable/api_reference/readers/database/#llama_index.readers.database.DatabaseReader)
                
                *   [load\_data](https://docs.llamaindex.ai/en/stable/api_reference/readers/database/#llama_index.readers.database.DatabaseReader.load_data)
