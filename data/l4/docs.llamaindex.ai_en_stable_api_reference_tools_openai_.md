...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/openai/#llama_index.tools.openai.OpenAIImageGenerationToolSpec)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Openai [Openai](https://docs.llamaindex.ai/en/stable/api_reference/tools/openai/)
            
            Table of contents
            
            *   [OpenAIImageGenerationToolSpec](https://docs.llamaindex.ai/en/stable/api_reference/tools/openai/#llama_index.tools.openai.OpenAIImageGenerationToolSpec)
                
                *   [image\_generation](https://docs.llamaindex.ai/en/stable/api_reference/tools/openai/#llama_index.tools.openai.OpenAIImageGenerationToolSpec.image_generation)
