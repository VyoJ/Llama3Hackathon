...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/llm/#llama_index.core.llms.llm.BaseLLMComponent.set_callback_manager)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Query Pipeline](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/)
        ...
        *    Llm [Llm](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/llm/)
            
            Table of contents
            
            *   [set\_callback\_manager](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/llm/#llama_index.core.llms.llm.BaseLLMComponent.set_callback_manager)
            *   [input\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/llm/#llama_index.core.llms.llm.LLMCompleteComponent.input_keys)
            *   [output\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/llm/#llama_index.core.llms.llm.LLMCompleteComponent.output_keys)
            *   [input\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/llm/#llama_index.core.llms.llm.LLMChatComponent.input_keys)
            *   [output\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/llm/#llama_index.core.llms.llm.LLMChatComponent.output_keys)
