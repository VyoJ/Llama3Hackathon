...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/node_parsers/sentence_window/#llama_index.core.node_parser.SentenceWindowNodeParser)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Node Parsers & Text Splitters](https://docs.llamaindex.ai/en/stable/api_reference/node_parsers/)
        ...
        *    Sentence window [Sentence window](https://docs.llamaindex.ai/en/stable/api_reference/node_parsers/sentence_window/)
            
            Table of contents
            
            *   [SentenceWindowNodeParser](https://docs.llamaindex.ai/en/stable/api_reference/node_parsers/sentence_window/#llama_index.core.node_parser.SentenceWindowNodeParser)
                
                *   [build\_window\_nodes\_from\_documents](https://docs.llamaindex.ai/en/stable/api_reference/node_parsers/sentence_window/#llama_index.core.node_parser.SentenceWindowNodeParser.build_window_nodes_from_documents)
