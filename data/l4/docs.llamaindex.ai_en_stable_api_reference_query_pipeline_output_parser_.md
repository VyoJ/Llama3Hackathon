...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/output_parser/#llama_index.core.output_parsers.base.OutputParserComponent.input_keys)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Query Pipeline](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/)
        ...
        *    Output parser [Output parser](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/output_parser/)
            
            Table of contents
            
            *   [input\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/output_parser/#llama_index.core.output_parsers.base.OutputParserComponent.input_keys)
            *   [output\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/output_parser/#llama_index.core.output_parsers.base.OutputParserComponent.output_keys)
            *   [set\_callback\_manager](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/output_parser/#llama_index.core.output_parsers.base.OutputParserComponent.set_callback_manager)
