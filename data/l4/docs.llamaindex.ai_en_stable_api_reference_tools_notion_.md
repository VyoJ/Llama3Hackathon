...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/notion/#llama_index.tools.notion.NotionToolSpec)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Notion [Notion](https://docs.llamaindex.ai/en/stable/api_reference/tools/notion/)
            
            Table of contents
            
            *   [NotionToolSpec](https://docs.llamaindex.ai/en/stable/api_reference/tools/notion/#llama_index.tools.notion.NotionToolSpec)
                
                *   [get\_fn\_schema\_from\_fn\_name](https://docs.llamaindex.ai/en/stable/api_reference/tools/notion/#llama_index.tools.notion.NotionToolSpec.get_fn_schema_from_fn_name)
                *   [load\_data](https://docs.llamaindex.ai/en/stable/api_reference/tools/notion/#llama_index.tools.notion.NotionToolSpec.load_data)
                *   [search\_data](https://docs.llamaindex.ai/en/stable/api_reference/tools/notion/#llama_index.tools.notion.NotionToolSpec.search_data)
...
<span class="w">        </span><span class="sd">"""Return map from function name."""</span>
        <span class="k">if</span> <span class="n">fn_name</span> <span class="o">==</span> <span class="s2">"load_data"</span><span class="p">:</span>
            <span class="k">return</span> <span class="n">NotionLoadDataSchema</span>
        <span class="k">elif</span> <span class="n">fn_name</span> <span class="o">==</span> <span class="s2">"search_data"</span><span class="p">:</span>
