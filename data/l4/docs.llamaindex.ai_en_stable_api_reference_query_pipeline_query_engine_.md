...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/query_engine/#llama_index.core.base.base_query_engine.QueryEngineComponent.input_keys)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Query Pipeline](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/)
        ...
        *    Query engine [Query engine](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/query_engine/)
            
            Table of contents
            
            *   [input\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/query_engine/#llama_index.core.base.base_query_engine.QueryEngineComponent.input_keys)
            *   [output\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/query_engine/#llama_index.core.base.base_query_engine.QueryEngineComponent.output_keys)
            *   [set\_callback\_manager](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/query_engine/#llama_index.core.base.base_query_engine.QueryEngineComponent.set_callback_manager)
