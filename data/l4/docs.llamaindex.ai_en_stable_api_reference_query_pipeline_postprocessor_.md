...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/postprocessor/#llama_index.core.postprocessor.types.PostprocessorComponent.input_keys)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Query Pipeline](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/)
        ...
        *    Postprocessor [Postprocessor](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/postprocessor/)
            
            Table of contents
            
            *   [input\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/postprocessor/#llama_index.core.postprocessor.types.PostprocessorComponent.input_keys)
            *   [output\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/postprocessor/#llama_index.core.postprocessor.types.PostprocessorComponent.output_keys)
            *   [set\_callback\_manager](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/postprocessor/#llama_index.core.postprocessor.types.PostprocessorComponent.set_callback_manager)
