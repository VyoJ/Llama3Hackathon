...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/storage/kvstore/mongodb/#llama_index.storage.kvstore.mongodb.MongoDBKVStore)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *    Storage
        ...
        *   [Kvstore](https://docs.llamaindex.ai/en/stable/api_reference/storage/kvstore/)
            ...
            *    Mongodb [Mongodb](https://docs.llamaindex.ai/en/stable/api_reference/storage/kvstore/mongodb/)
                
                Table of contents
                
                *   [MongoDBKVStore](https://docs.llamaindex.ai/en/stable/api_reference/storage/kvstore/mongodb/#llama_index.storage.kvstore.mongodb.MongoDBKVStore)
                    
                    *   [from\_uri](https://docs.llamaindex.ai/en/stable/api_reference/storage/kvstore/mongodb/#llama_index.storage.kvstore.mongodb.MongoDBKVStore.from_uri)
                    *   [from\_host\_and\_port](https://docs.llamaindex.ai/en/stable/api_reference/storage/kvstore/mongodb/#llama_index.storage.kvstore.mongodb.MongoDBKVStore.from_host_and_port)
                    *   [put](https://docs.llamaindex.ai/en/stable/api_reference/storage/kvstore/mongodb/#llama_index.storage.kvstore.mongodb.MongoDBKVStore.put)
                    *   [aput](https://docs.llamaindex.ai/en/stable/api_reference/storage/kvstore/mongodb/#llama_index.storage.kvstore.mongodb.MongoDBKVStore.aput)
                    *   [get](https://docs.llamaindex.ai/en/stable/api_reference/storage/kvstore/mongodb/#llama_index.storage.kvstore.mongodb.MongoDBKVStore.get)
                    *   [aget](https://docs.llamaindex.ai/en/stable/api_reference/storage/kvstore/mongodb/#llama_index.storage.kvstore.mongodb.MongoDBKVStore.aget)
                    *   [get\_all](https://docs.llamaindex.ai/en/stable/api_reference/storage/kvstore/mongodb/#llama_index.storage.kvstore.mongodb.MongoDBKVStore.get_all)
                    *   [aget\_all](https://docs.llamaindex.ai/en/stable/api_reference/storage/kvstore/mongodb/#llama_index.storage.kvstore.mongodb.MongoDBKVStore.aget_all)
                    *   [delete](https://docs.llamaindex.ai/en/stable/api_reference/storage/kvstore/mongodb/#llama_index.storage.kvstore.mongodb.MongoDBKVStore.delete)
                    *   [adelete](https://docs.llamaindex.ai/en/stable/api_reference/storage/kvstore/mongodb/#llama_index.storage.kvstore.mongodb.MongoDBKVStore.adelete)
