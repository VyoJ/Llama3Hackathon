...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/router/#llama_index.core.query_engine.RouterQueryEngine)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Query Engines](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/)
        ...
        *    Router [Router](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/router/)
            
            Table of contents
            
            *   [RouterQueryEngine](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/router/#llama_index.core.query_engine.RouterQueryEngine)
