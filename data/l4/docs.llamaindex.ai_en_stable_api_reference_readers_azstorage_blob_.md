...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/readers/azstorage_blob/#llama_index.readers.azstorage_blob.AzStorageBlobReader)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Readers](https://docs.llamaindex.ai/en/stable/api_reference/readers/)
        ...
        *    Azstorage blob [Azstorage blob](https://docs.llamaindex.ai/en/stable/api_reference/readers/azstorage_blob/)
            
            Table of contents
            
            *   [AzStorageBlobReader](https://docs.llamaindex.ai/en/stable/api_reference/readers/azstorage_blob/#llama_index.readers.azstorage_blob.AzStorageBlobReader)
                
                *   [list\_resources](https://docs.llamaindex.ai/en/stable/api_reference/readers/azstorage_blob/#llama_index.readers.azstorage_blob.AzStorageBlobReader.list_resources)
                *   [get\_resource\_info](https://docs.llamaindex.ai/en/stable/api_reference/readers/azstorage_blob/#llama_index.readers.azstorage_blob.AzStorageBlobReader.get_resource_info)
                *   [read\_file\_content](https://docs.llamaindex.ai/en/stable/api_reference/readers/azstorage_blob/#llama_index.readers.azstorage_blob.AzStorageBlobReader.read_file_content)
                *   [load\_data](https://docs.llamaindex.ai/en/stable/api_reference/readers/azstorage_blob/#llama_index.readers.azstorage_blob.AzStorageBlobReader.load_data)
