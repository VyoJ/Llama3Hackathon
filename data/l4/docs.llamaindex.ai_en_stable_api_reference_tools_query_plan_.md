Title: Query plan - LlamaIndex

URL Source: https://docs.llamaindex.ai/en/stable/api_reference/tools/query_plan/

Markdown Content:
Query plan - LlamaIndex
===============
             

[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/query_plan/#llama_index.core.tools.query_engine.QueryEngineTool)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Query plan [Query plan](https://docs.llamaindex.ai/en/stable/api_reference/tools/query_plan/)
            
            Table of contents
            
            *   [QueryEngineTool](https://docs.llamaindex.ai/en/stable/api_reference/tools/query_plan/#llama_index.core.tools.query_engine.QueryEngineTool)
...
QueryEngineTool [#](https://docs.llamaindex.ai/en/stable/api_reference/tools/query_plan/#llama_index.core.tools.query_engine.QueryEngineTool "Permanent link")
--------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[Previous Query engine](https://docs.llamaindex.ai/en/stable/api_reference/tools/query_engine/)[Next Requests](https://docs.llamaindex.ai/en/stable/api_reference/tools/requests/)
