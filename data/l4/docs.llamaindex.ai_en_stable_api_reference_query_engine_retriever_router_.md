...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/retriever_router/#llama_index.core.query_engine.RetrieverRouterQueryEngine)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Query Engines](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/)
        ...
        *    Retriever router [Retriever router](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/retriever_router/)
            
            Table of contents
            
            *   [RetrieverRouterQueryEngine](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/retriever_router/#llama_index.core.query_engine.RetrieverRouterQueryEngine)
