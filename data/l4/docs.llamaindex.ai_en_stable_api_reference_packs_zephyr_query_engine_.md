...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/zephyr_query_engine/#llama_index.packs.zephyr_query_engine.ZephyrQueryEnginePack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Zephyr query engine [Zephyr query engine](https://docs.llamaindex.ai/en/stable/api_reference/packs/zephyr_query_engine/)
            
            Table of contents
            
            *   [ZephyrQueryEnginePack](https://docs.llamaindex.ai/en/stable/api_reference/packs/zephyr_query_engine/#llama_index.packs.zephyr_query_engine.ZephyrQueryEnginePack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/zephyr_query_engine/#llama_index.packs.zephyr_query_engine.ZephyrQueryEnginePack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/zephyr_query_engine/#llama_index.packs.zephyr_query_engine.ZephyrQueryEnginePack.run)
