...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/chatgpt_plugin/#llama_index.tools.chatgpt_plugin.ChatGPTPluginToolSpec)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Chatgpt plugin [Chatgpt plugin](https://docs.llamaindex.ai/en/stable/api_reference/tools/chatgpt_plugin/)
            
            Table of contents
            
            *   [ChatGPTPluginToolSpec](https://docs.llamaindex.ai/en/stable/api_reference/tools/chatgpt_plugin/#llama_index.tools.chatgpt_plugin.ChatGPTPluginToolSpec)
                
                *   [load\_openapi\_spec](https://docs.llamaindex.ai/en/stable/api_reference/tools/chatgpt_plugin/#llama_index.tools.chatgpt_plugin.ChatGPTPluginToolSpec.load_openapi_spec)
