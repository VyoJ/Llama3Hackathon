...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/custom/#llama_index.core.base.query_pipeline.query.CustomQueryComponent.input_keys)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Query Pipeline](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/)
        ...
        *    Custom [Custom](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/custom/)
            
            Table of contents
            
            *   [input\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/custom/#llama_index.core.base.query_pipeline.query.CustomQueryComponent.input_keys)
            *   [output\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/custom/#llama_index.core.base.query_pipeline.query.CustomQueryComponent.output_keys)
            *   [set\_callback\_manager](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/custom/#llama_index.core.base.query_pipeline.query.CustomQueryComponent.set_callback_manager)
