...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/program/evaporate/#llama_index.program.evaporate.DFEvaporateProgram)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Programs](https://docs.llamaindex.ai/en/stable/api_reference/program/)
        ...
        *    Evaporate [Evaporate](https://docs.llamaindex.ai/en/stable/api_reference/program/evaporate/)
            
            Table of contents
            
            *   [DFEvaporateProgram](https://docs.llamaindex.ai/en/stable/api_reference/program/evaporate/#llama_index.program.evaporate.DFEvaporateProgram)
                
                *   [output\_cls](https://docs.llamaindex.ai/en/stable/api_reference/program/evaporate/#llama_index.program.evaporate.DFEvaporateProgram.output_cls)
                *   [fit](https://docs.llamaindex.ai/en/stable/api_reference/program/evaporate/#llama_index.program.evaporate.DFEvaporateProgram.fit)
