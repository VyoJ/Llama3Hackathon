...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/readers/dashvector/#llama_index.readers.dashvector.DashVectorReader)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Readers](https://docs.llamaindex.ai/en/stable/api_reference/readers/)
        ...
        *    Dashvector [Dashvector](https://docs.llamaindex.ai/en/stable/api_reference/readers/dashvector/)
            
            Table of contents
            
            *   [DashVectorReader](https://docs.llamaindex.ai/en/stable/api_reference/readers/dashvector/#llama_index.readers.dashvector.DashVectorReader)
                
                *   [load\_data](https://docs.llamaindex.ai/en/stable/api_reference/readers/dashvector/#llama_index.readers.dashvector.DashVectorReader.load_data)
...
### load\_data [#](https://docs.llamaindex.ai/en/stable/api_reference/readers/dashvector/#llama_index.readers.dashvector.DashVectorReader.load_data "Permanent link")

```
load_data(collection_name: str, id_to_text_map: Dict[str, str], vector: Optional[List[float]], top_k: int, separate_documents: bool = True, filter: Optional[str] = None, include_vector: bool = True) -> List[[Document](https://docs.llamaindex.ai/en/stable/api_reference/schema/#llama_index.core.schema.Document "llama_index.core.schema.Document")]
```
...
<span class="normal">83</span>
<span class="normal">84</span>
<span class="normal">85</span></pre></div></td><td class="code"><div><pre><span></span><code><span class="k">def</span> <span class="nf">load_data</span><span class="p">(</span>
    <span class="bp">self</span><span class="p">,</span>
    <span class="n">collection_name</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span>
    <span class="n">id_to_text_map</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="nb">str</span><span class="p">],</span>
    <span class="n">vector</span><span class="p">:</span> <span class="n">Optional</span><span class="p">[</span><span class="n">List</span><span class="p">[</span><span class="nb">float</span><span class="p">]],</span>
