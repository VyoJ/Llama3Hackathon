...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/query_transform/#llama_index.core.indices.query.query_transform.base.QueryTransformComponent.input_keys)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Query Pipeline](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/)
        ...
        *    Query transform [Query transform](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/query_transform/)
            
            Table of contents
            
            *   [input\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/query_transform/#llama_index.core.indices.query.query_transform.base.QueryTransformComponent.input_keys)
            *   [output\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/query_transform/#llama_index.core.indices.query.query_transform.base.QueryTransformComponent.output_keys)
            *   [set\_callback\_manager](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/query_transform/#llama_index.core.indices.query.query_transform.base.QueryTransformComponent.set_callback_manager)
