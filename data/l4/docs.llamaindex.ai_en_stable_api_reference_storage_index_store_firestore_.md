...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/firestore/#llama_index.storage.index_store.firestore.FirestoreIndexStore)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *    Storage
        ...
        *   [Index Store](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/)
            ...
            *    Firestore [Firestore](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/firestore/)
                
                Table of contents
                
                *   [FirestoreIndexStore](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/firestore/#llama_index.storage.index_store.firestore.FirestoreIndexStore)
                    
                    *   [from\_database](https://docs.llamaindex.ai/en/stable/api_reference/storage/index_store/firestore/#llama_index.storage.index_store.firestore.FirestoreIndexStore.from_database)
