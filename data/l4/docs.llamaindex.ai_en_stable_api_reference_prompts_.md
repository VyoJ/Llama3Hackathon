...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.ChatMessage)
...
*   [ChatMessage](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.ChatMessage)
*   [MessageRole](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.MessageRole)
*   [BasePromptTemplate](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.BasePromptTemplate)
*   [ChatPromptTemplate](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.ChatPromptTemplate)
    
    *   [from\_messages](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.ChatPromptTemplate.from_messages)
    
*   [LangchainPromptTemplate](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.LangchainPromptTemplate)
    
    *   [partial\_format](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.LangchainPromptTemplate.partial_format)
    *   [format](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.LangchainPromptTemplate.format)
    *   [format\_messages](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.LangchainPromptTemplate.format_messages)
    
*   [PromptTemplate](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.PromptTemplate)
    
    *   [partial\_format](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.PromptTemplate.partial_format)
    *   [format](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.PromptTemplate.format)
    *   [format\_messages](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.PromptTemplate.format_messages)
    
*   [PromptType](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.PromptType)
*   [SelectorPromptTemplate](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.SelectorPromptTemplate)
    
    *   [format](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.SelectorPromptTemplate.format)
    *   [format\_messages](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.SelectorPromptTemplate.format_messages)
    
*   [display\_prompt\_dict](https://docs.llamaindex.ai/en/stable/api_reference/prompts/#llama_index.core.prompts.display_prompt_dict)
