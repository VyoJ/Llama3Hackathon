...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/bing_search/#llama_index.tools.bing_search.BingSearchToolSpec)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Bing search [Bing search](https://docs.llamaindex.ai/en/stable/api_reference/tools/bing_search/)
            
            Table of contents
            
            *   [BingSearchToolSpec](https://docs.llamaindex.ai/en/stable/api_reference/tools/bing_search/#llama_index.tools.bing_search.BingSearchToolSpec)
                
                *   [bing\_news\_search](https://docs.llamaindex.ai/en/stable/api_reference/tools/bing_search/#llama_index.tools.bing_search.BingSearchToolSpec.bing_news_search)
                *   [bing\_image\_search](https://docs.llamaindex.ai/en/stable/api_reference/tools/bing_search/#llama_index.tools.bing_search.BingSearchToolSpec.bing_image_search)
                *   [bing\_video\_search](https://docs.llamaindex.ai/en/stable/api_reference/tools/bing_search/#llama_index.tools.bing_search.BingSearchToolSpec.bing_video_search)
