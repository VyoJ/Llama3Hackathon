...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/node_parsers/json/#llama_index.core.node_parser.JSONNodeParser)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Node Parsers & Text Splitters](https://docs.llamaindex.ai/en/stable/api_reference/node_parsers/)
        ...
        *    Json [Json](https://docs.llamaindex.ai/en/stable/api_reference/node_parsers/json/)
            
            Table of contents
            
            *   [JSONNodeParser](https://docs.llamaindex.ai/en/stable/api_reference/node_parsers/json/#llama_index.core.node_parser.JSONNodeParser)
                
                *   [class\_name](https://docs.llamaindex.ai/en/stable/api_reference/node_parsers/json/#llama_index.core.node_parser.JSONNodeParser.class_name)
                *   [get\_nodes\_from\_node](https://docs.llamaindex.ai/en/stable/api_reference/node_parsers/json/#llama_index.core.node_parser.JSONNodeParser.get_nodes_from_node)
