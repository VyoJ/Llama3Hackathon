...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/streamlit_chatbot/#llama_index.packs.streamlit_chatbot.StreamlitChatPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Streamlit chatbot [Streamlit chatbot](https://docs.llamaindex.ai/en/stable/api_reference/packs/streamlit_chatbot/)
            
            Table of contents
            
            *   [StreamlitChatPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/streamlit_chatbot/#llama_index.packs.streamlit_chatbot.StreamlitChatPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/streamlit_chatbot/#llama_index.packs.streamlit_chatbot.StreamlitChatPack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/streamlit_chatbot/#llama_index.packs.streamlit_chatbot.StreamlitChatPack.run)
