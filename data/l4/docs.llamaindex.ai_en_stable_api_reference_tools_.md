...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/#llama_index.core.tools.types.AsyncBaseTool)
...
*   [AsyncBaseTool](https://docs.llamaindex.ai/en/stable/api_reference/tools/#llama_index.core.tools.types.AsyncBaseTool)
    
    *   [call](https://docs.llamaindex.ai/en/stable/api_reference/tools/#llama_index.core.tools.types.AsyncBaseTool.call)
    *   [acall](https://docs.llamaindex.ai/en/stable/api_reference/tools/#llama_index.core.tools.types.AsyncBaseTool.acall)
    
*   [BaseToolAsyncAdapter](https://docs.llamaindex.ai/en/stable/api_reference/tools/#llama_index.core.tools.types.BaseToolAsyncAdapter)
*   [BaseTool](https://docs.llamaindex.ai/en/stable/api_reference/tools/#llama_index.core.tools.types.BaseTool)
    
    *   [to\_langchain\_tool](https://docs.llamaindex.ai/en/stable/api_reference/tools/#llama_index.core.tools.types.BaseTool.to_langchain_tool)
    *   [to\_langchain\_structured\_tool](https://docs.llamaindex.ai/en/stable/api_reference/tools/#llama_index.core.tools.types.BaseTool.to_langchain_structured_tool)
    
*   [ToolMetadata](https://docs.llamaindex.ai/en/stable/api_reference/tools/#llama_index.core.tools.types.ToolMetadata)
    
    *   [fn\_schema\_str](https://docs.llamaindex.ai/en/stable/api_reference/tools/#llama_index.core.tools.types.ToolMetadata.fn_schema_str)
    *   [get\_name](https://docs.llamaindex.ai/en/stable/api_reference/tools/#llama_index.core.tools.types.ToolMetadata.get_name)
    *   [to\_openai\_function](https://docs.llamaindex.ai/en/stable/api_reference/tools/#llama_index.core.tools.types.ToolMetadata.to_openai_function)
    *   [to\_openai\_tool](https://docs.llamaindex.ai/en/stable/api_reference/tools/#llama_index.core.tools.types.ToolMetadata.to_openai_tool)
    
*   [ToolOutput](https://docs.llamaindex.ai/en/stable/api_reference/tools/#llama_index.core.tools.types.ToolOutput)
