...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/input/#llama_index.core.query_pipeline.components.input.InputComponent.input_keys)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Query Pipeline](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/)
        ...
        *    Input [Input](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/input/)
            
            Table of contents
            
            *   [input\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/input/#llama_index.core.query_pipeline.components.input.InputComponent.input_keys)
            *   [output\_keys](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/input/#llama_index.core.query_pipeline.components.input.InputComponent.output_keys)
            *   [validate\_component\_inputs](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/input/#llama_index.core.query_pipeline.components.input.InputComponent.validate_component_inputs)
            *   [validate\_component\_outputs](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/input/#llama_index.core.query_pipeline.components.input.InputComponent.validate_component_outputs)
            *   [set\_callback\_manager](https://docs.llamaindex.ai/en/stable/api_reference/query_pipeline/input/#llama_index.core.query_pipeline.components.input.InputComponent.set_callback_manager)
