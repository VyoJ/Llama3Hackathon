...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/python_file/#llama_index.tools.python_file.PythonFileToolSpec)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Python file [Python file](https://docs.llamaindex.ai/en/stable/api_reference/tools/python_file/)
            
            Table of contents
            
            *   [PythonFileToolSpec](https://docs.llamaindex.ai/en/stable/api_reference/tools/python_file/#llama_index.tools.python_file.PythonFileToolSpec)
                
                *   [function\_definitions](https://docs.llamaindex.ai/en/stable/api_reference/tools/python_file/#llama_index.tools.python_file.PythonFileToolSpec.function_definitions)
                *   [get\_function](https://docs.llamaindex.ai/en/stable/api_reference/tools/python_file/#llama_index.tools.python_file.PythonFileToolSpec.get_function)
                *   [get\_functions](https://docs.llamaindex.ai/en/stable/api_reference/tools/python_file/#llama_index.tools.python_file.PythonFileToolSpec.get_functions)
...
<span class="s2">                        """</span>
    ...
    <span class="k">def</span> <span class="nf">get_functions</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">names</span><span class="p">:</span> <span class="n">List</span><span class="p">[</span><span class="nb">str</span><span class="p">])</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
<span class="w">        </span><span class="sd">"""</span>
...
### function\_definitions [#](https://docs.llamaindex.ai/en/stable/api_reference/tools/python_file/#llama_index.tools.python_file.PythonFileToolSpec.function_definitions "Permanent link")
...
<span class="normal">28</span>
<span class="normal">29</span>
<span class="normal">30</span></pre></div></td><td class="code"><div><pre><span></span><code>    <span class="k">def</span> <span class="nf">function_definitions</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">external</span><span class="p">:</span> <span class="n">Optional</span><span class="p">[</span><span class="nb">bool</span><span class="p">]</span> <span class="o">=</span> <span class="kc">True</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
<span class="w">        </span><span class="sd">"""</span>
<span class="sd">        Use this function to get the name and arguments of all function definitions in the python file.</span>
...
### get\_function [#](https://docs.llamaindex.ai/en/stable/api_reference/tools/python_file/#llama_index.tools.python_file.PythonFileToolSpec.get_function "Permanent link")
...
<span class="normal">45</span>
<span class="normal">46</span>
<span class="normal">47</span></pre></div></td><td class="code"><div><pre><span></span><code>    <span class="k">def</span> <span class="nf">get_function</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">name</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
<span class="w">        </span><span class="sd">"""</span>
<span class="sd">        Use this function to get the name and arguments of a single function definition in the python file.</span>
