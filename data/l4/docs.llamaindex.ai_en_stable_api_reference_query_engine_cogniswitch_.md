...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/cogniswitch/#llama_index.core.query_engine.CogniswitchQueryEngine)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Query Engines](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/)
        ...
        *    Cogniswitch [Cogniswitch](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/cogniswitch/)
            
            Table of contents
            
            *   [CogniswitchQueryEngine](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/cogniswitch/#llama_index.core.query_engine.CogniswitchQueryEngine)
                
                *   [query\_knowledge](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/cogniswitch/#llama_index.core.query_engine.CogniswitchQueryEngine.query_knowledge)
...
<span class="sd">        """</span>
    ...
    <span class="k">def</span> <span class="nf">_query</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">query_bundle</span><span class="p">:</span> <span class="n">QueryBundle</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Response</span><span class="p">:</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">query_knowledge</span><span class="p">(</span><span class="n">query_bundle</span><span class="o">.</span><span class="n">query_str</span><span class="p">)</span>
...
### query\_knowledge [#](https://docs.llamaindex.ai/en/stable/api_reference/query_engine/cogniswitch/#llama_index.core.query_engine.CogniswitchQueryEngine.query_knowledge "Permanent link")
...
<span class="normal">51</span>
<span class="normal">52</span>
<span class="normal">53</span></pre></div></td><td class="code"><div><pre><span></span><code><span class="k">def</span> <span class="nf">query_knowledge</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">query</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Response</span><span class="p">:</span>
<span class="w">    </span><span class="sd">"""</span>
<span class="sd">    Send a query to the Cogniswitch service and retrieve the response.</span>
