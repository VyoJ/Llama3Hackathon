...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/program/llm_text_completion/#llama_index.core.program.llm_program.LLMTextCompletionProgram)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Programs](https://docs.llamaindex.ai/en/stable/api_reference/program/)
        ...
        *    Llm text completion [Llm text completion](https://docs.llamaindex.ai/en/stable/api_reference/program/llm_text_completion/)
            
            Table of contents
            
            *   [LLMTextCompletionProgram](https://docs.llamaindex.ai/en/stable/api_reference/program/llm_text_completion/#llama_index.core.program.llm_program.LLMTextCompletionProgram)
