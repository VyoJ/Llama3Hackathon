...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/tools/azure_cv/#llama_index.tools.azure_cv.AzureCVToolSpec)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Tools](https://docs.llamaindex.ai/en/stable/api_reference/tools/)
        ...
        *    Azure cv [Azure cv](https://docs.llamaindex.ai/en/stable/api_reference/tools/azure_cv/)
            
            Table of contents
            
            *   [AzureCVToolSpec](https://docs.llamaindex.ai/en/stable/api_reference/tools/azure_cv/#llama_index.tools.azure_cv.AzureCVToolSpec)
                
                *   [process\_image](https://docs.llamaindex.ai/en/stable/api_reference/tools/azure_cv/#llama_index.tools.azure_cv.AzureCVToolSpec.process_image)
