...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/cookbooks/cohere_retriever_eval/#cohere-init8-and-binary-embeddings-retrieval-evaluation)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/evaluation/cookbooks/cohere_retriever_eval.ipynb)

Cohere init8 and binary Embeddings Retrieval Evaluation[¶](https://docs.llamaindex.ai/en/stable/examples/cookbooks/cohere_retriever_eval/#cohere-init8-and-binary-embeddings-retrieval-evaluation)
==================================================================================================================================================================================================
...
Installation[¶](https://docs.llamaindex.ai/en/stable/examples/cookbooks/cohere_retriever_eval/#installation)
------------------------------------------------------------------------------------------------------------
...
Setup API Keys[¶](https://docs.llamaindex.ai/en/stable/examples/cookbooks/cohere_retriever_eval/#setup-api-keys)
----------------------------------------------------------------------------------------------------------------
...
os.environ\["COHERE\_API\_KEY"\] \= "YOUR COHEREAI API KEY"

import os os.environ\["OPENAI\_API\_KEY"\] = "YOUR OPENAI KEY" os.environ\["COHERE\_API\_KEY"\] = "YOUR COHEREAI API KEY"

Setup[¶](https://docs.llamaindex.ai/en/stable/examples/cookbooks/cohere_retriever_eval/#setup)
----------------------------------------------------------------------------------------------
...
from llama\_index.core.evaluation import generate\_question\_context\_pairs from llama\_index.core import VectorStoreIndex, SimpleDirectoryReader from llama\_index.core.node\_parser import SentenceSplitter from llama\_index.llms.openai import OpenAI from llama\_index.embeddings.cohere import CohereEmbedding

Download Data[¶](https://docs.llamaindex.ai/en/stable/examples/cookbooks/cohere_retriever_eval/#download-data)
--------------------------------------------------------------------------------------------------------------
...
\--2024-03-27 20:26:33--  https://raw.githubusercontent.com/run-llama/llama\_index/main/docs/docs/examples/data/paul\_graham/paul\_graham\_essay.txt
