Title: MyScale Reader - LlamaIndex
...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/data_connectors/MyScaleReaderDemo/#myscale-reader)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jerryjliu/llama_index/blob/main/docs/docs/examples/data_connectors/MyScaleReaderDemo.ipynb)

MyScale Reader[¶](https://docs.llamaindex.ai/en/stable/examples/data_connectors/MyScaleReaderDemo/#myscale-reader)
==================================================================================================================
...
reader \= MyScaleReader(myscale\_host\=host, username\=username, password\=password)
...
[Previous MongoDB Reader](https://docs.llamaindex.ai/en/stable/examples/data_connectors/MongoDemo/)[Next Notion Reader](https://docs.llamaindex.ai/en/stable/examples/data_connectors/NotionDemo/)
