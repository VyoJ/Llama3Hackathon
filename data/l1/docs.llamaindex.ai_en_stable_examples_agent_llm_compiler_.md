...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Agents
        ...
        *    LLM Compiler Agent Cookbook [LLM Compiler Agent Cookbook](https://docs.llamaindex.ai/en/stable/examples/agent/llm_compiler/)
...
LLM Compiler Agent Cookbook[¶](https://docs.llamaindex.ai/en/stable/examples/agent/llm_compiler/#llm-compiler-agent-cookbook)
=============================================================================================================================
