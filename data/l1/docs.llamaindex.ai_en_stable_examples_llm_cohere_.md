...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/llm/cohere/#cohere)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    LLMs
        ...
        *    Cohere [Cohere](https://docs.llamaindex.ai/en/stable/examples/llm/cohere/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/llm/cohere.ipynb)

Cohere[¶](https://docs.llamaindex.ai/en/stable/examples/llm/cohere/#cohere)
===========================================================================
