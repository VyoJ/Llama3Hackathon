...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Agents
        ...
        *    Retrieval-Augmented OpenAI Agent [Retrieval-Augmented OpenAI Agent](https://docs.llamaindex.ai/en/stable/examples/agent/openai_agent_retrieval/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/agent/openai_agent_retrieval.ipynb)

Retrieval-Augmented OpenAI Agent[¶](https://docs.llamaindex.ai/en/stable/examples/agent/openai_agent_retrieval/#retrieval-augmented-openai-agent)
=================================================================================================================================================
