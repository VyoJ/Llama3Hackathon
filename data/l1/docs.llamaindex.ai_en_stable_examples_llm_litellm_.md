...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/llm/litellm/#litellm)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    LLMs
        ...
        *    LiteLLM [LiteLLM](https://docs.llamaindex.ai/en/stable/examples/llm/litellm/)
            
            Table of contents
            
            *   [LiteLLM supports 100+ LLM APIs (Anthropic, Replicate, Huggingface, TogetherAI, Cohere, etc.). Complete List](https://docs.llamaindex.ai/en/stable/examples/llm/litellm/#litellm-supports-100-llm-apis-anthropic-replicate-huggingface-togetherai-cohere-etc-complete-list)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jerryjliu/llama_index/blob/main/docs/docs/examples/llm/litellm.ipynb)

LiteLLM[¶](https://docs.llamaindex.ai/en/stable/examples/llm/litellm/#litellm)
==============================================================================
