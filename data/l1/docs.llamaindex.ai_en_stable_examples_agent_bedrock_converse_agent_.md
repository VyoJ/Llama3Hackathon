...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Agents
        ...
        *    Function Calling AWS Bedrock Converse Agent [Function Calling AWS Bedrock Converse Agent](https://docs.llamaindex.ai/en/stable/examples/agent/bedrock_converse_agent/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/agent/bedrock_converse_agent.ipynb)

Function Calling AWS Bedrock Converse Agent[¶](https://docs.llamaindex.ai/en/stable/examples/agent/bedrock_converse_agent/#function-calling-aws-bedrock-converse-agent)
=======================================================================================================================================================================
