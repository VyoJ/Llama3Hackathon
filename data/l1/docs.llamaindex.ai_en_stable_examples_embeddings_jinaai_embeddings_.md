...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/embeddings/jinaai_embeddings/#jina-embeddings)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Embeddings
        ...
        *    Jina Embeddings [Jina Embeddings](https://docs.llamaindex.ai/en/stable/examples/embeddings/jinaai_embeddings/)
