...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/chat_engine/chat_engine_react/#chat-engine-react-agent-mode)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Chat Engines
        ...
        *    Chat Engine - ReAct Agent Mode [Chat Engine - ReAct Agent Mode](https://docs.llamaindex.ai/en/stable/examples/chat_engine/chat_engine_react/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jerryjliu/llama_index/blob/main/docs/docs/examples/chat_engine/chat_engine_react.ipynb)

Chat Engine - ReAct Agent Mode[¶](https://docs.llamaindex.ai/en/stable/examples/chat_engine/chat_engine_react/#chat-engine-react-agent-mode)
============================================================================================================================================
