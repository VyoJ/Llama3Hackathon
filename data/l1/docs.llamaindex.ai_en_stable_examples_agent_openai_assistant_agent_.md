...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Agents
        ...
        *    OpenAI Assistant Agent [OpenAI Assistant Agent](https://docs.llamaindex.ai/en/stable/examples/agent/openai_assistant_agent/)
            ...
            *   [Assistant Agent with your own Vector Store / Retrieval API](https://docs.llamaindex.ai/en/stable/examples/agent/openai_assistant_agent/#assistant-agent-with-your-own-vector-store-retrieval-api)
...
OpenAI Assistant Agent[¶](https://docs.llamaindex.ai/en/stable/examples/agent/openai_assistant_agent/#openai-assistant-agent)
=============================================================================================================================
...
data/10k/uber\_2021. 100%\[===================>\]   1.79M  --.-KB/s    in 0.07s   

2023-11-07 00:20:08 (24.3 MB/s) - ‘data/10k/uber\_2021.pdf’ saved \[1880483/1880483\]

--2023-11-07 00:20:08--  https://raw.githubusercontent.com/run-llama/llama\_index/main/docs/docs/examples/data/10k/lyft\_2021.pdf
Resolving raw.githubusercontent.com (raw.githubusercontent.com)... 2606:50c0:8000::154, 2606:50c0:8001::154, 2606:50c0:8002::154, ...
Connecting to raw.githubusercontent.com (raw.githubusercontent.com)|2606:50c0:8000::154|:443... connected.
HTTP request sent, awaiting response... 200 OK
...
data/10k/lyft\_2021. 100%\[===================>\]   1.37M  --.-KB/s    in 0.06s   
...
from llama\_index.agent.openai import OpenAIAssistantAgent from llama\_index.core import ( SimpleDirectoryReader, VectorStoreIndex, StorageContext, ) from llama\_index.vector\_stores.supabase import SupabaseVectorStore from llama\_index.core.tools import QueryEngineTool, ToolMetadata
...
\# load data
reader \= SimpleDirectoryReader(input\_files\=\["./data/10k/lyft\_2021.pdf"\])
docs \= reader.load\_data()
for doc in docs:
    doc.id\_ \= "lyft\_docs"

\# load data reader = SimpleDirectoryReader(input\_files=\["./data/10k/lyft\_2021.pdf"\]) docs = reader.load\_data() for doc in docs: doc.id\_ = "lyft\_docs"
...
index \= VectorStoreIndex.from\_documents(docs, storage\_context\=storage\_context)

vector\_store = SupabaseVectorStore( postgres\_connection\_string=( "postgresql://:@:/" ), collection\_name="base\_demo", ) storage\_context = StorageContext.from\_defaults(vector\_store=vector\_store) index = VectorStoreIndex.from\_documents(docs, storage\_context=storage\_context)
...
num\_docs \= vector\_store.get\_by\_id("lyft\_docs", limit\=1000)
print(len(num\_docs))

\# sanity check that the docs are in the vector store num\_docs = vector\_store.get\_by\_id("lyft\_docs", limit=1000) print(len(num\_docs))
...
\=== Calling Function ===
Calling function: lyft\_10k with args: {"input": "What are Lyft's risk factors?"}
