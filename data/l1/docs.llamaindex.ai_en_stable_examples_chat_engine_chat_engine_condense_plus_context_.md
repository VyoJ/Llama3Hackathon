...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/chat_engine/chat_engine_condense_plus_context/#chat-engine-condense-plus-context-mode)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Chat Engines
        ...
        *    Chat Engine - Condense Plus Context Mode [Chat Engine - Condense Plus Context Mode](https://docs.llamaindex.ai/en/stable/examples/chat_engine/chat_engine_condense_plus_context/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jerryjliu/llama_index/blob/main/docs/docs/examples/chat_engine/chat_engine_context.ipynb)

Chat Engine - Condense Plus Context Mode[¶](https://docs.llamaindex.ai/en/stable/examples/chat_engine/chat_engine_condense_plus_context/#chat-engine-condense-plus-context-mode)
================================================================================================================================================================================
