...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/chat_engine/chat_engine_context/#chat-engine-context-mode)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Chat Engines
        ...
        *    Chat Engine - Context Mode [Chat Engine - Context Mode](https://docs.llamaindex.ai/en/stable/examples/chat_engine/chat_engine_context/)
...
Chat Engine - Context Mode[¶](https://docs.llamaindex.ai/en/stable/examples/chat_engine/chat_engine_context/#chat-engine-context-mode)
======================================================================================================================================
