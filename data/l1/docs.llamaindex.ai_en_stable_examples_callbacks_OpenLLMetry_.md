...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Callbacks
        ...
        *    Observability with OpenLLMetry [Observability with OpenLLMetry](https://docs.llamaindex.ai/en/stable/examples/callbacks/OpenLLMetry/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jerryjliu/llama_index/blob/main/docs/docs/examples/callbacks/OpenLLMetry.ipynb)

Observability with OpenLLMetry[¶](https://docs.llamaindex.ai/en/stable/examples/callbacks/OpenLLMetry/#observability-with-openllmetry)
======================================================================================================================================
