...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/embeddings/fastembed/#qdrant-fastembed-embeddings)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/embeddings/clarifai.ipynb)

Qdrant FastEmbed Embeddings[¶](https://docs.llamaindex.ai/en/stable/examples/embeddings/fastembed/#qdrant-fastembed-embeddings)
===============================================================================================================================
