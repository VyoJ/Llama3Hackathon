...
*   [Learn](https://docs.llamaindex.ai/en/stable/understanding/)
    ...
    *    Building an agent
        ...
        *    Adding RAG to an agent [Adding RAG to an agent](https://docs.llamaindex.ai/en/stable/understanding/agent/rag_agent/)
            
            Table of contents
            
            *   [Bring in new dependencies](https://docs.llamaindex.ai/en/stable/understanding/agent/rag_agent/#bring-in-new-dependencies)
            *   [Add LLM to settings](https://docs.llamaindex.ai/en/stable/understanding/agent/rag_agent/#add-llm-to-settings)
            *   [Load and index documents](https://docs.llamaindex.ai/en/stable/understanding/agent/rag_agent/#load-and-index-documents)
            *   [Add a query engine tool](https://docs.llamaindex.ai/en/stable/understanding/agent/rag_agent/#add-a-query-engine-tool)
            *   [Ask a question using multiple tools](https://docs.llamaindex.ai/en/stable/understanding/agent/rag_agent/#ask-a-question-using-multiple-tools)
...
Adding RAG to an agent[#](https://docs.llamaindex.ai/en/stable/understanding/agent/rag_agent/#adding-rag-to-an-agent "Permanent link")
======================================================================================================================================
