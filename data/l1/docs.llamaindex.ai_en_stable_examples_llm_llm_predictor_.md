Title: LLM Predictor - LlamaIndex
...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/llm/llm_predictor/#llm-predictor)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    LLMs
        ...
        *    LLM Predictor [LLM Predictor](https://docs.llamaindex.ai/en/stable/examples/llm/llm_predictor/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jerryjliu/llama_index/blob/main/docs/docs/examples/llm/llm_predictor.ipynb)

LLM Predictor[¶](https://docs.llamaindex.ai/en/stable/examples/llm/llm_predictor/#llm-predictor)
================================================================================================
...
async for token in stream: print(token, end="")
...
\## Test with ChatAnyscale llm = LangChainLLM(ChatAnyscale())
