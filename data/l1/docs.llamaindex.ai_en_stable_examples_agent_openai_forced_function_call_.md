...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Agents
        ...
        *    OpenAI agent: specifying a forced function call [OpenAI agent: specifying a forced function call](https://docs.llamaindex.ai/en/stable/examples/agent/openai_forced_function_call/)
            
            Table of contents
            
            *   ["Auto" function call](https://docs.llamaindex.ai/en/stable/examples/agent/openai_forced_function_call/#auto-function-call)
            *   [Forced function call](https://docs.llamaindex.ai/en/stable/examples/agent/openai_forced_function_call/#forced-function-call)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/agent/openai_forced_function_call.ipynb)

OpenAI agent: specifying a forced function call[¶](https://docs.llamaindex.ai/en/stable/examples/agent/openai_forced_function_call/#openai-agent-specifying-a-forced-function-call)
===================================================================================================================================================================================
...
The agent is forced to call the "useless\_tool" before selecting the "add" tool

In \[ \]:

Copied!

response \= agent.chat("What is 5 \* 2?", tool\_choice\="useless\_tool")
...
=== Calling Function ===
Calling function: useless\_tool with args: {}
