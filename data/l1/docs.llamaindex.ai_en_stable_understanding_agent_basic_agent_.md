...
*   [Learn](https://docs.llamaindex.ai/en/stable/understanding/)
    ...
    *    Building an agent
        ...
        *    Building a basic agent [Building a basic agent](https://docs.llamaindex.ai/en/stable/understanding/agent/basic_agent/)
            
            Table of contents
            
            *   [Getting started](https://docs.llamaindex.ai/en/stable/understanding/agent/basic_agent/#getting-started)
            *   [OpenAI Key](https://docs.llamaindex.ai/en/stable/understanding/agent/basic_agent/#openai-key)
            *   [Bring in dependencies](https://docs.llamaindex.ai/en/stable/understanding/agent/basic_agent/#bring-in-dependencies)
            *   [Create basic tools](https://docs.llamaindex.ai/en/stable/understanding/agent/basic_agent/#create-basic-tools)
            *   [Initialize the LLM](https://docs.llamaindex.ai/en/stable/understanding/agent/basic_agent/#initialize-the-llm)
            *   [Initialize the agent](https://docs.llamaindex.ai/en/stable/understanding/agent/basic_agent/#initialize-the-agent)
            *   [Ask a question](https://docs.llamaindex.ai/en/stable/understanding/agent/basic_agent/#ask-a-question)
...
Building a basic agent[#](https://docs.llamaindex.ai/en/stable/understanding/agent/basic_agent/#building-a-basic-agent "Permanent link")
========================================================================================================================================
