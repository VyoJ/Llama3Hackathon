...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Agents
        ...
        *    DashScope Agent Tutorial [DashScope Agent Tutorial](https://docs.llamaindex.ai/en/stable/examples/agent/dashscope_agent/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/agent/dashscope_agent.ipynb)

DashScope Agent Tutorial[¶](https://docs.llamaindex.ai/en/stable/examples/agent/dashscope_agent/#dashscope-agent-tutorial)
==========================================================================================================================
