...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/embeddings/google_palm/#google-palm-embeddings)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/embeddings/google_palm.ipynb)

Google PaLM Embeddings[¶](https://docs.llamaindex.ai/en/stable/examples/embeddings/google_palm/#google-palm-embeddings)
=======================================================================================================================
