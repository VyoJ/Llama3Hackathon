...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/embeddings/ollama_embedding/#ollama-embeddings)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jerryjliu/llama_index/blob/main/docs/docs/examples/embeddings/ollama_embedding.ipynb)

Ollama Embeddings[¶](https://docs.llamaindex.ai/en/stable/examples/embeddings/ollama_embedding/#ollama-embeddings)
==================================================================================================================
