...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Agents
        ...
        *    Benchmarking OpenAI Retrieval API (through Assistant Agent) [Benchmarking OpenAI Retrieval API (through Assistant Agent)](https://docs.llamaindex.ai/en/stable/examples/agent/openai_retrieval_benchmark/)
            
            Table of contents
            
            *   [Setup Data](https://docs.llamaindex.ai/en/stable/examples/agent/openai_retrieval_benchmark/#setup-data)
            *   [Define Eval Modules](https://docs.llamaindex.ai/en/stable/examples/agent/openai_retrieval_benchmark/#define-eval-modules)
                
                *   [Setup "Golden Dataset"](https://docs.llamaindex.ai/en/stable/examples/agent/openai_retrieval_benchmark/#setup-golden-dataset)
                    
                    *   [Option 1: Pull Existing Dataset](https://docs.llamaindex.ai/en/stable/examples/agent/openai_retrieval_benchmark/#option-1-pull-existing-dataset)
...
Benchmarking OpenAI Retrieval API (through Assistant Agent)[¶](https://docs.llamaindex.ai/en/stable/examples/agent/openai_retrieval_benchmark/#benchmarking-openai-retrieval-api-through-assistant-agent)
=========================================================================================================================================================================================================
...
from pathlib import Path from llama\_index.core import Document, VectorStoreIndex from llama\_index.readers.file import PyMuPDFReader from llama\_index.core.node\_parser import SimpleNodeParser from llama\_index.llms.openai import OpenAI
...
\--2023-11-08 22:20:10--  https://www.dropbox.com/scl/fi/fh9vsmmm8vu0j50l3ss38/llama2\_eval\_qr\_dataset.json?rlkey=kkoaez7aqeb4z25gzc06ak6kb&dl=1
...
Location: https://uc63170224c66fda29da619e304b.dl.dropboxusercontent.com/cd/0/inline/CHOj1FEf2Dd6npmREaKmwUEIJ4S5QcrgeISKh55BE27i9tqrcE94Oym\_0\_z0EL9mBTmF9udNCxWwnFSHlio3ib6G\_f\_j3xiUzn5AVvQsKDPROYjazkJz\_ChUVv3xkT-Pzuk/file?dl=1# \[following\]
--2023-11-08 22:20:11--  https://uc63170224c66fda29da619e304b.dl.dropboxusercontent.com/cd/0/inline/CHOj1FEf2Dd6npmREaKmwUEIJ4S5QcrgeISKh55BE27i9tqrcE94Oym\_0\_z0EL9mBTmF9udNCxWwnFSHlio3ib6G\_f\_j3xiUzn5AVvQsKDPROYjazkJz\_ChUVv3xkT-Pzuk/file?dl=1
...
data/llama2\_eval\_qr 100%\[===================>\]  59.23K  --.-KB/s    in 0.02s   
