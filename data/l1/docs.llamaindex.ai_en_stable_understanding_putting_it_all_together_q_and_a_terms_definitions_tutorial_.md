...
URL Source: https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/
...
*   [Learn](https://docs.llamaindex.ai/en/stable/understanding/)
    ...
    *   [Putting it all Together](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/)
        ...
        *   [Q&A Patterns](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/)
            ...
            *    A Guide to Extracting Terms and Definitions [A Guide to Extracting Terms and Definitions](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/)
                
                Table of contents
                
                *   [Uploading Text](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#uploading-text)
                *   [LLM Settings](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#llm-settings)
                *   [Extracting and Storing Terms](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#extracting-and-storing-terms)
                *   [Saving Extracted Terms](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#saving-extracted-terms)
                *   [Querying for Extracted Terms/Definitions](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#querying-for-extracted-termsdefinitions)
                *   [Dry Run Test](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#dry-run-test)
                *   [Improvement #1 - Create a Starting Index](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#improvement-1-create-a-starting-index)
                *   [Improvement #2 - (Refining) Better Prompts](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#improvement-2-refining-better-prompts)
                *   [Improvement #3 - Image Support](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#improvement-3-image-support)
                *   [Conclusion/TLDR](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#conclusiontldr)
...
A Guide to Extracting Terms and Definitions[#](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#a-guide-to-extracting-terms-and-definitions "Permanent link")
===========================================================================================================================================================================================================================
...
Uploading Text[#](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#uploading-text "Permanent link")
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
LLM Settings[#](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#llm-settings "Permanent link")
-------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Extracting and Storing Terms[#](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#extracting-and-storing-terms "Permanent link")
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Saving Extracted Terms[#](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#saving-extracted-terms "Permanent link")
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Querying for Extracted Terms/Definitions[#](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#querying-for-extracted-termsdefinitions "Permanent link")
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Dry Run Test[#](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#dry-run-test "Permanent link")
-------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Improvement #1 - Create a Starting Index[#](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#improvement-1-create-a-starting-index "Permanent link")
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Improvement #2 - (Refining) Better Prompts[#](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#improvement-2-refining-better-prompts "Permanent link")
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Improvement #3 - Image Support[#](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#improvement-3-image-support "Permanent link")
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Conclusion/TLDR[#](https://docs.llamaindex.ai/en/stable/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#conclusiontldr "Permanent link")
------------------------------------------------------------------------------------------------------------------------------------------------------------------
