...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/data_connectors/DeepLakeReader/#deeplake-reader)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/data_connectors/DeepLakeReader.ipynb)

DeepLake Reader[¶](https://docs.llamaindex.ai/en/stable/examples/data_connectors/DeepLakeReader/#deeplake-reader)
=================================================================================================================
