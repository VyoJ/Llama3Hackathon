...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/llm/gemini/#gemini)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    LLMs
        ...
        *    Gemini [Gemini](https://docs.llamaindex.ai/en/stable/examples/llm/gemini/)
            
            Table of contents
            
            *   [Basic Usage](https://docs.llamaindex.ai/en/stable/examples/llm/gemini/#basic-usage)
                
                *   [Call complete with a prompt](https://docs.llamaindex.ai/en/stable/examples/llm/gemini/#call-complete-with-a-prompt)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/llm/gemini.ipynb)

Gemini[¶](https://docs.llamaindex.ai/en/stable/examples/llm/gemini/#gemini)
===========================================================================
...
from llama\_index.llms.gemini import Gemini llm = Gemini()
