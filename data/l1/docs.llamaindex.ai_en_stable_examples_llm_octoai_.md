...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/llm/octoai/#octoai)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    LLMs
        ...
        *    OctoAI [OctoAI](https://docs.llamaindex.ai/en/stable/examples/llm/octoai/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/llm/octoai.ipynb)

OctoAI[¶](https://docs.llamaindex.ai/en/stable/examples/llm/octoai/#octoai)
===========================================================================
