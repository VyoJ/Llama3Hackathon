Title: Adding other tools - LlamaIndex
...
*   [Learn](https://docs.llamaindex.ai/en/stable/understanding/)
    ...
    *    Building an agent
        ...
        *    Adding other tools [Adding other tools](https://docs.llamaindex.ai/en/stable/understanding/agent/tools/)
            
            Table of contents
            
            *   [Using an existing tool from LlamaHub](https://docs.llamaindex.ai/en/stable/understanding/agent/tools/#using-an-existing-tool-from-llamahub)
            *   [Building and contributing your own tools](https://docs.llamaindex.ai/en/stable/understanding/agent/tools/#building-and-contributing-your-own-tools)
...
Adding other tools[#](https://docs.llamaindex.ai/en/stable/understanding/agent/tools/#adding-other-tools "Permanent link")
==========================================================================================================================
