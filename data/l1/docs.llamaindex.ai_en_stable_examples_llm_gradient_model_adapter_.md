...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/llm/gradient_model_adapter/#gradient-model-adapter)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    LLMs
        ...
        *    Gradient Model Adapter [Gradient Model Adapter](https://docs.llamaindex.ai/en/stable/examples/llm/gradient_model_adapter/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/llm/gradient_model_adapter.ipynb)

Gradient Model Adapter[¶](https://docs.llamaindex.ai/en/stable/examples/llm/gradient_model_adapter/#gradient-model-adapter)
===========================================================================================================================
