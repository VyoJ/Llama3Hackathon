...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/agent/agent_builder/#gpt-builder-demo)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Agents
        ...
        *    GPT Builder Demo [GPT Builder Demo](https://docs.llamaindex.ai/en/stable/examples/agent/agent_builder/)
...
GPT Builder Demo[¶](https://docs.llamaindex.ai/en/stable/examples/agent/agent_builder/#gpt-builder-demo)
========================================================================================================
...
=== Calling Function ===
Calling function: get\_tools with args: {
  "task": "tell me about Toronto"
}
Got output: \['Toronto'\]
========================
