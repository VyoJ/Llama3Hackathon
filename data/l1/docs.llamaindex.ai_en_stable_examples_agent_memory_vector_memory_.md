...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Agents
        ...
        *    Vector Memory [Vector Memory](https://docs.llamaindex.ai/en/stable/examples/agent/memory/vector_memory/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/agent/memory/vector_memory.ipynb)

Vector Memory[¶](https://docs.llamaindex.ai/en/stable/examples/agent/memory/vector_memory/#vector-memory)
=========================================================================================================
