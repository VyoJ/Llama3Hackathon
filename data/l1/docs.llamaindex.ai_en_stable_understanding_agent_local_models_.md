Title: Agents with local models - LlamaIndex
...
*   [Learn](https://docs.llamaindex.ai/en/stable/understanding/)
    ...
    *    Building an agent
        ...
        *    Agents with local models [Agents with local models](https://docs.llamaindex.ai/en/stable/understanding/agent/local_models/)
            
            Table of contents
            
            *   [Install Ollama](https://docs.llamaindex.ai/en/stable/understanding/agent/local_models/#install-ollama)
            *   [Pick and run a model](https://docs.llamaindex.ai/en/stable/understanding/agent/local_models/#pick-and-run-a-model)
            *   [Switch to local agent](https://docs.llamaindex.ai/en/stable/understanding/agent/local_models/#switch-to-local-agent)
            *   [Ask the question again](https://docs.llamaindex.ai/en/stable/understanding/agent/local_models/#ask-the-question-again)
...
Agents with local models[#](https://docs.llamaindex.ai/en/stable/understanding/agent/local_models/#agents-with-local-models "Permanent link")
=============================================================================================================================================
