...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Agents
        ...
        *    Language Agent Tree Search [Language Agent Tree Search](https://docs.llamaindex.ai/en/stable/examples/agent/lats_agent/)
...
Language Agent Tree Search[¶](https://docs.llamaindex.ai/en/stable/examples/agent/lats_agent/#language-agent-tree-search)
=========================================================================================================================
