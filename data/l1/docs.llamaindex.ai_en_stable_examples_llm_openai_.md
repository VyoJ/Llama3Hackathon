...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/llm/openai/#openai)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    LLMs
        ...
        *    OpenAI [OpenAI](https://docs.llamaindex.ai/en/stable/examples/llm/openai/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jerryjliu/llama_index/blob/main/docs/docs/examples/llm/openai.ipynb)

OpenAI[¶](https://docs.llamaindex.ai/en/stable/examples/llm/openai/#openai)
===========================================================================
