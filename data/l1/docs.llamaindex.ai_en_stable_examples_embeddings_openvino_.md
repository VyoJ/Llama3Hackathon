...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/embeddings/openvino/#local-embeddings-with-openvino)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Embeddings
        ...
        *    Local Embeddings with OpenVINO [Local Embeddings with OpenVINO](https://docs.llamaindex.ai/en/stable/examples/embeddings/openvino/)
...
Local Embeddings with OpenVINO[¶](https://docs.llamaindex.ai/en/stable/examples/embeddings/openvino/#local-embeddings-with-openvino)
====================================================================================================================================
