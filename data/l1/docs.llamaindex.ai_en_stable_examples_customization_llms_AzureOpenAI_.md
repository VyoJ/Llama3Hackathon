...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/customization/llms/AzureOpenAI/#azure-openai)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jerryjliu/llama_index/blob/main/docs/docs/examples/customization/llms/AzureOpenAI.ipynb)

Azure OpenAI[¶](https://docs.llamaindex.ai/en/stable/examples/customization/llms/AzureOpenAI/#azure-openai)
===========================================================================================================
