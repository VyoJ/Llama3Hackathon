...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/cookbooks/prometheus2_cookbook/#prometheus-2-cookbook)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Cookbooks
        ...
        *    Prometheus-2 Cookbook [Prometheus-2 Cookbook](https://docs.llamaindex.ai/en/stable/examples/cookbooks/prometheus2_cookbook/)
            ...
            *   [Installation](https://docs.llamaindex.ai/en/stable/examples/cookbooks/prometheus2_cookbook/#installation)
                ...
                *   [Correctness Evaluation](https://docs.llamaindex.ai/en/stable/examples/cookbooks/prometheus2_cookbook/#correctness-evaluation)
                    ...
                    *   [Observation:](https://docs.llamaindex.ai/en/stable/examples/cookbooks/prometheus2_cookbook/#observation_1)
                    
                *   [Faithfulness Evaluator](https://docs.llamaindex.ai/en/stable/examples/cookbooks/prometheus2_cookbook/#faithfulness-evaluator)
                    
                    *   [Observation:](https://docs.llamaindex.ai/en/stable/examples/cookbooks/prometheus2_cookbook/#observation_2)
                    
                *   [Relevancy Evaluator](https://docs.llamaindex.ai/en/stable/examples/cookbooks/prometheus2_cookbook/#relevancy-evaluator)
                    
                    *   [Observation:](https://docs.llamaindex.ai/en/stable/examples/cookbooks/prometheus2_cookbook/#observation_3)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/cookbooks/prometheus2_cookbook.ipynb)

Prometheus-2 Cookbook[¶](https://docs.llamaindex.ai/en/stable/examples/cookbooks/prometheus2_cookbook/#prometheus-2-cookbook)
=============================================================================================================================
...
def parser\_function( outputs: str, ) -> Tuple\[Optional\[bool\], Optional\[float\], Optional\[str\]\]: parts = outputs.split("\[RESULT\]") if len(parts) == 2: feedback, result = parts\[0\].strip(), parts\[1\].strip() if result == "A": return True, 0.0, feedback elif result == "B": return True, 1.0, feedback return None, None, None
