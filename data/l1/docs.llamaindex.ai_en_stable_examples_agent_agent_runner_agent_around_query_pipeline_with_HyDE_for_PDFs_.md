...
Building a Multi-PDF Agent using Query Pipelines and HyDE[¶](https://docs.llamaindex.ai/en/stable/examples/agent/agent_runner/agent_around_query_pipeline_with_HyDE_for_PDFs/#building-a-multi-pdf-agent-using-query-pipelines-and-hyde)
========================================================================================================================================================================================================================================
...
Task and State[¶](https://docs.llamaindex.ai/en/stable/examples/agent/agent_runner/agent_around_query_pipeline_with_HyDE_for_PDFs/#task-and-state)
--------------------------------------------------------------------------------------------------------------------------------------------------
...
**Agent Input Component**[¶](https://docs.llamaindex.ai/en/stable/examples/agent/agent_runner/agent_around_query_pipeline_with_HyDE_for_PDFs/#agent-input-component)
--------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Define Agent Prompt[¶](https://docs.llamaindex.ai/en/stable/examples/agent/agent_runner/agent_around_query_pipeline_with_HyDE_for_PDFs/#define-agent-prompt)
============================================================================================================================================================
