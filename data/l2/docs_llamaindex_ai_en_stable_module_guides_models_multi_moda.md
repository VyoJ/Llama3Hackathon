...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/models/multi_modal/#beta-multi-modal-models)
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Models](https://docs.llamaindex.ai/en/stable/module_guides/models/)
        ...
        *    Multi Modal [Multi Modal](https://docs.llamaindex.ai/en/stable/module_guides/models/multi_modal/)
            
            Table of contents
            
            *   [Concept](https://docs.llamaindex.ai/en/stable/module_guides/models/multi_modal/#concept)
            *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/models/multi_modal/#usage-pattern)
                
                *   [End to End Multi-Modal Work Flow](https://docs.llamaindex.ai/en/stable/module_guides/models/multi_modal/#end-to-end-multi-modal-work-flow)
                *   [Multi-Modal LLM Models](https://docs.llamaindex.ai/en/stable/module_guides/models/multi_modal/#multi-modal-llm-models)
                *   [Multi Modal Vector Stores](https://docs.llamaindex.ai/en/stable/module_guides/models/multi_modal/#multi-modal-vector-stores)
                
            *   [Multi-Modal LLM Modules](https://docs.llamaindex.ai/en/stable/module_guides/models/multi_modal/#multi-modal-llm-modules)
            *   [Multi-Modal Retrieval Augmented Generation](https://docs.llamaindex.ai/en/stable/module_guides/models/multi_modal/#multi-modal-retrieval-augmented-generation)
            *   [Evaluation](https://docs.llamaindex.ai/en/stable/module_guides/models/multi_modal/#evaluation)
...
\[Beta\] Multi-modal models[#](https://docs.llamaindex.ai/en/stable/module_guides/models/multi_modal/#beta-multi-modal-models "Permanent link")
===============================================================================================================================================
