...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/AmazonNeptuneVectorDemo/#amazon-neptune-neptune-analytics-vector-store)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Amazon Neptune - Neptune Analytics vector store [Amazon Neptune - Neptune Analytics vector store](https://docs.llamaindex.ai/en/stable/examples/vector_stores/AmazonNeptuneVectorDemo/)
...
Amazon Neptune - Neptune Analytics vector store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/AmazonNeptuneVectorDemo/#amazon-neptune-neptune-analytics-vector-store)
======================================================================================================================================================================================
