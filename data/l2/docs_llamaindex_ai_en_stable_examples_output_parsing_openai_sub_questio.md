...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/output_parsing/openai_sub_question/#openai-function-calling-for-sub-question-query-engine)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Output Parsers
        ...
        *    OpenAI function calling for Sub-Question Query Engine [OpenAI function calling for Sub-Question Query Engine](https://docs.llamaindex.ai/en/stable/examples/output_parsing/openai_sub_question/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/output_parsing/openai_sub_question.ipynb)

OpenAI function calling for Sub-Question Query Engine[¶](https://docs.llamaindex.ai/en/stable/examples/output_parsing/openai_sub_question/#openai-function-calling-for-sub-question-query-engine)
=================================================================================================================================================================================================
