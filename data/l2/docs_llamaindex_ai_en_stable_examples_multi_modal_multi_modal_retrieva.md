...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/multi_modal/multi_modal_retrieval/#multi-modal-retrieval-using-gpt-text-embedding-and-clip-image-embedding-for-wikipedia-articles)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Multi-Modal
        ...
        *    Multi-Modal Retrieval using GPT text embedding and CLIP image embedding for Wikipedia Articles [Multi-Modal Retrieval using GPT text embedding and CLIP image embedding for Wikipedia Articles](https://docs.llamaindex.ai/en/stable/examples/multi_modal/multi_modal_retrieval/)
            ...
            *   [Build Multi Modal Vector Store using Text and Image embeddings under different collections](https://docs.llamaindex.ai/en/stable/examples/multi_modal/multi_modal_retrieval/#build-multi-modal-vector-store-using-text-and-image-embeddings-under-different-collections)
                ...
                *   [Build a separate CLIP image embedding index under a differnt collection wikipedia\_img](https://docs.llamaindex.ai/en/stable/examples/multi_modal/multi_modal_retrieval/#build-a-separate-clip-image-embedding-index-under-a-differnt-collection-wikipedia_img)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/multi_modal/multi_modal_retrieval.ipynb)

Multi-Modal Retrieval using GPT text embedding and CLIP image embedding for Wikipedia Articles[¶](https://docs.llamaindex.ai/en/stable/examples/multi_modal/multi_modal_retrieval/#multi-modal-retrieval-using-gpt-text-embedding-and-clip-image-embedding-for-wikipedia-articles)
==================================================================================================================================================================================================================================================================================
