...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/AstraDBIndexDemo/#astra-db)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Astra DB [Astra DB](https://docs.llamaindex.ai/en/stable/examples/vector_stores/AstraDBIndexDemo/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/vector_stores/AstraDBIndexDemo.ipynb)

Astra DB[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/AstraDBIndexDemo/#astra-db)
===================================================================================================
