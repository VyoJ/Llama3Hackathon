...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/SimpleIndexDemoLlama-Local/#local-llama2-vectorstoreindex)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Local Llama2 + VectorStoreIndex [Local Llama2 + VectorStoreIndex](https://docs.llamaindex.ai/en/stable/examples/vector_stores/SimpleIndexDemoLlama-Local/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/vector_stores/SimpleIndexDemoLlama-Local.ipynb)

Local Llama2 + VectorStoreIndex[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/SimpleIndexDemoLlama-Local/#local-llama2-vectorstoreindex)
=========================================================================================================================================================
