...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/MilvusIndexDemo/#milvus-vector-store)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Milvus Vector Store [Milvus Vector Store](https://docs.llamaindex.ai/en/stable/examples/vector_stores/MilvusIndexDemo/)
...
Milvus Vector Store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/MilvusIndexDemo/#milvus-vector-store)
========================================================================================================================
