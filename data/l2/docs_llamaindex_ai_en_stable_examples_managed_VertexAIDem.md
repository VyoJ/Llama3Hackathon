...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/managed/VertexAIDemo/#google-cloud-llamaindex-on-vertex-ai-for-rag)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Managed Indexes
        ...
        *    Google Cloud LlamaIndex on Vertex AI for RAG [Google Cloud LlamaIndex on Vertex AI for RAG](https://docs.llamaindex.ai/en/stable/examples/managed/VertexAIDemo/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/managed/VertexAIDemo.ipynb)

Google Cloud LlamaIndex on Vertex AI for RAG[¶](https://docs.llamaindex.ai/en/stable/examples/managed/VertexAIDemo/#google-cloud-llamaindex-on-vertex-ai-for-rag)
=================================================================================================================================================================
