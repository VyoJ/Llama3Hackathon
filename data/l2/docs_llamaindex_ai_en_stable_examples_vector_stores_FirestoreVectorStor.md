...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/FirestoreVectorStore/#firestore-vector-store)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/examples/vector_stores/FirestoreVectorStore.ipynb)

Firestore Vector Store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/FirestoreVectorStore/#firestore-vector-store)
===================================================================================================================================
...
Before You Begin[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/FirestoreVectorStore/#before-you-begin)
-----------------------------------------------------------------------------------------------------------------------
...
Library Installation[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/FirestoreVectorStore/#library-installation)
-------------------------------------------------------------------------------------------------------------------------------
...
### ☁ Set Your Google Cloud Project[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/FirestoreVectorStore/#set-your-google-cloud-project)
...
PROJECT\_ID \= "YOUR\_PROJECT\_ID"  \# @param {type:"string"}

\# Set the project id
!gcloud config set project {PROJECT\_ID}

\# @markdown Please fill in the value below with your Google Cloud project ID and then run the cell. PROJECT\_ID = "YOUR\_PROJECT\_ID" # @param {type:"string"} # Set the project id !gcloud config set project {PROJECT\_ID}

### 🔐 Authentication[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/FirestoreVectorStore/#authentication)
...
from google.colab import auth auth.authenticate\_user()

Basic Usage[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/FirestoreVectorStore/#basic-usage)
=============================================================================================================
