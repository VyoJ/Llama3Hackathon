...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/LanternIndexDemo/#lantern-vector-store)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Lantern Vector Store [Lantern Vector Store](https://docs.llamaindex.ai/en/stable/examples/vector_stores/LanternIndexDemo/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/vector_stores/Lantern.ipynb)

Lantern Vector Store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/LanternIndexDemo/#lantern-vector-store)
===========================================================================================================================
