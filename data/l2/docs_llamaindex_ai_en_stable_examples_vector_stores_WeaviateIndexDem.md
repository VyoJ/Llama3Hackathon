...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/WeaviateIndexDemo/#weaviate-vector-store)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Weaviate Vector Store [Weaviate Vector Store](https://docs.llamaindex.ai/en/stable/examples/vector_stores/WeaviateIndexDemo/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/vector_stores/WeaviateIndexDemo.ipynb)

Weaviate Vector Store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/WeaviateIndexDemo/#weaviate-vector-store)
==============================================================================================================================
...
vector\_store.delete\_index()  \# calling the function again does nothing

vector\_store.delete\_index() # calling the function again does nothing

Connection Termination[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/WeaviateIndexDemo/#connection-termination)
================================================================================================================================
