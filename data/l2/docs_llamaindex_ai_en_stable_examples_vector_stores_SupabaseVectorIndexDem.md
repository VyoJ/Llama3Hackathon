...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/SupabaseVectorIndexDemo/#supabase-vector-store)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Supabase Vector Store [Supabase Vector Store](https://docs.llamaindex.ai/en/stable/examples/vector_stores/SupabaseVectorIndexDemo/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/vector_stores/SupabaseVectorIndexDemo.ipynb)

Supabase Vector Store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/SupabaseVectorIndexDemo/#supabase-vector-store)
====================================================================================================================================
