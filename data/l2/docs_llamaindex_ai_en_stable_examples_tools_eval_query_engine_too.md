...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/tools/eval_query_engine_tool/#evaluation-query-engine-tool)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Tools
        ...
        *    Evaluation Query Engine Tool [Evaluation Query Engine Tool](https://docs.llamaindex.ai/en/stable/examples/tools/eval_query_engine_tool/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/tools/eval_query_engine_tool.ipynb)

Evaluation Query Engine Tool[¶](https://docs.llamaindex.ai/en/stable/examples/tools/eval_query_engine_tool/#evaluation-query-engine-tool)
=========================================================================================================================================
