...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/llm/rungpt/#rungpt)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jerryjliu/llama_index/blob/main/docs/docs/examples/llm/rungpt.ipynb)

RunGPT[¶](https://docs.llamaindex.ai/en/stable/examples/llm/rungpt/#rungpt)
===========================================================================
