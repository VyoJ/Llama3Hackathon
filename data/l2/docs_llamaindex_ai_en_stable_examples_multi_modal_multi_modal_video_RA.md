...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/multi_modal/multi_modal_video_RAG/#multimodal-rag-for-processing-videos-using-openai-gpt4v-and-lancedb-vectorstore)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Multi-Modal
        ...
        *    Multimodal RAG for processing videos using OpenAI GPT4V and LanceDB vectorstore [Multimodal RAG for processing videos using OpenAI GPT4V and LanceDB vectorstore](https://docs.llamaindex.ai/en/stable/examples/multi_modal/multi_modal_video_RAG/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/multi_modal/multi_modal_video_RAG.ipynb)

Multimodal RAG for processing videos using OpenAI GPT4V and LanceDB vectorstore[¶](https://docs.llamaindex.ai/en/stable/examples/multi_modal/multi_modal_video_RAG/#multimodal-rag-for-processing-videos-using-openai-gpt4v-and-lancedb-vectorstore)
====================================================================================================================================================================================================================================================
