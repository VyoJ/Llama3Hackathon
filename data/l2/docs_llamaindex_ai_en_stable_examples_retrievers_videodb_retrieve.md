...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/retrievers/videodb_retriever/#videodb-retriever)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Retrievers
        ...
        *    VideoDB Retriever [VideoDB Retriever](https://docs.llamaindex.ai/en/stable/examples/retrievers/videodb_retriever/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/retrievers/videodb_retriever.ipynb)

VideoDB Retriever[¶](https://docs.llamaindex.ai/en/stable/examples/retrievers/videodb_retriever/#videodb-retriever)
===================================================================================================================
