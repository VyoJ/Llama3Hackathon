...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/models/llms/#using-llms)
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Models](https://docs.llamaindex.ai/en/stable/module_guides/models/)
        ...
        *    LLMs
            ...
            *    Using LLMs [Using LLMs](https://docs.llamaindex.ai/en/stable/module_guides/models/llms/)
                
                Table of contents
                
                *   [Concept](https://docs.llamaindex.ai/en/stable/module_guides/models/llms/#concept)
                *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/models/llms/#usage-pattern)
                *   [A Note on Tokenization](https://docs.llamaindex.ai/en/stable/module_guides/models/llms/#a-note-on-tokenization)
                *   [LLM Compatibility Tracking](https://docs.llamaindex.ai/en/stable/module_guides/models/llms/#llm-compatibility-tracking)
                    
                    *   [Paid LLM APIs](https://docs.llamaindex.ai/en/stable/module_guides/models/llms/#paid-llm-apis)
                    *   [Open Source LLMs](https://docs.llamaindex.ai/en/stable/module_guides/models/llms/#open-source-llms)
                    
                *   [Modules](https://docs.llamaindex.ai/en/stable/module_guides/models/llms/#modules)
                *   [Further reading](https://docs.llamaindex.ai/en/stable/module_guides/models/llms/#further-reading)
...
Using LLMs[#](https://docs.llamaindex.ai/en/stable/module_guides/models/llms/#using-llms "Permanent link")
==========================================================================================================
