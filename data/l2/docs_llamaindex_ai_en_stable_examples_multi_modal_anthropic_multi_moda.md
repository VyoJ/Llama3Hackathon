...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/multi_modal/anthropic_multi_modal/#multi-modal-llm-using-anthropic-model-for-image-reasoning)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Multi-Modal
        ...
        *    Multi-Modal LLM using Anthropic model for image reasoning [Multi-Modal LLM using Anthropic model for image reasoning](https://docs.llamaindex.ai/en/stable/examples/multi_modal/anthropic_multi_modal/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/multi_modal/anthropic_multi_modal.ipynb)

Multi-Modal LLM using Anthropic model for image reasoning[¶](https://docs.llamaindex.ai/en/stable/examples/multi_modal/anthropic_multi_modal/#multi-modal-llm-using-anthropic-model-for-image-reasoning)
========================================================================================================================================================================================================
