...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/JaguarIndexDemo/#jaguar-vector-store)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Jaguar Vector Store [Jaguar Vector Store](https://docs.llamaindex.ai/en/stable/examples/vector_stores/JaguarIndexDemo/)
...
Jaguar Vector Store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/JaguarIndexDemo/#jaguar-vector-store)
========================================================================================================================
