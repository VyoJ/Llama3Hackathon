Title: Transformations - LlamaIndex
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Loading](https://docs.llamaindex.ai/en/stable/module_guides/loading/)
        ...
        *   [Ingestion Pipeline](https://docs.llamaindex.ai/en/stable/module_guides/loading/ingestion_pipeline/)
            ...
            *    Transformations [Transformations](https://docs.llamaindex.ai/en/stable/module_guides/loading/ingestion_pipeline/transformations/)
                
                Table of contents
                
                *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/loading/ingestion_pipeline/transformations/#usage-pattern)
                *   [Combining with An Index](https://docs.llamaindex.ai/en/stable/module_guides/loading/ingestion_pipeline/transformations/#combining-with-an-index)
