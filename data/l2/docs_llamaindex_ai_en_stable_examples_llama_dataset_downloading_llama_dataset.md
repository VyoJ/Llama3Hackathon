...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/llama_datasets/downloading_llama_datasets.ipynb)

Downloading a LlamaDataset from LlamaHub[¶](https://docs.llamaindex.ai/en/stable/examples/llama_dataset/downloading_llama_datasets/#downloading-a-llamadataset-from-llamahub)
=============================================================================================================================================================================
