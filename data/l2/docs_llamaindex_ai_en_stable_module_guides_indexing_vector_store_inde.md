Title: Vector Store Index - LlamaIndex
...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/indexing/vector_store_index/#using-vectorstoreindex)
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Indexing](https://docs.llamaindex.ai/en/stable/module_guides/indexing/)
        ...
        *    Vector Store Index [Vector Store Index](https://docs.llamaindex.ai/en/stable/module_guides/indexing/vector_store_index/)
            
            Table of contents
            
            *   [Loading data into the index](https://docs.llamaindex.ai/en/stable/module_guides/indexing/vector_store_index/#loading-data-into-the-index)
                
                *   [Basic usage](https://docs.llamaindex.ai/en/stable/module_guides/indexing/vector_store_index/#basic-usage)
                *   [Using the ingestion pipeline to create nodes](https://docs.llamaindex.ai/en/stable/module_guides/indexing/vector_store_index/#using-the-ingestion-pipeline-to-create-nodes)
                *   [Creating and managing nodes directly](https://docs.llamaindex.ai/en/stable/module_guides/indexing/vector_store_index/#creating-and-managing-nodes-directly)
                    
                    *   [Handling Document Updates](https://docs.llamaindex.ai/en/stable/module_guides/indexing/vector_store_index/#handling-document-updates)
                    
                
            *   [Storing the vector index](https://docs.llamaindex.ai/en/stable/module_guides/indexing/vector_store_index/#storing-the-vector-index)
            *   [Composable Retrieval](https://docs.llamaindex.ai/en/stable/module_guides/indexing/vector_store_index/#composable-retrieval)
...
Using VectorStoreIndex[#](https://docs.llamaindex.ai/en/stable/module_guides/indexing/vector_store_index/#using-vectorstoreindex "Permanent link")
==================================================================================================================================================
