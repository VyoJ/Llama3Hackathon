...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/RedisIndexDemo/#redis-vector-store)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    Redis Vector Store [Redis Vector Store](https://docs.llamaindex.ai/en/stable/examples/vector_stores/RedisIndexDemo/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/vector_stores/RedisIndexDemo.ipynb)

Redis Vector Store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/RedisIndexDemo/#redis-vector-store)
=====================================================================================================================
