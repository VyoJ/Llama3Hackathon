...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/pipeline/query_pipeline_routing/#query-pipeline-with-routing)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Query Pipeline
        ...
        *    Query Pipeline with Routing [Query Pipeline with Routing](https://docs.llamaindex.ai/en/stable/examples/pipeline/query_pipeline_routing/)
...
Query Pipeline with Routing[¶](https://docs.llamaindex.ai/en/stable/examples/pipeline/query_pipeline_routing/#query-pipeline-with-routing)
==========================================================================================================================================
