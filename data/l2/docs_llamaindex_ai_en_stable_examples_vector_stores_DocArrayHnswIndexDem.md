...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/vector_stores/DocArrayHnswIndexDemo/#docarray-hnsw-vector-store)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Vector Stores
        ...
        *    DocArray Hnsw Vector Store [DocArray Hnsw Vector Store](https://docs.llamaindex.ai/en/stable/examples/vector_stores/DocArrayHnswIndexDemo/)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/vector_stores/DocArrayHnswIndexDemo.ipynb)

DocArray Hnsw Vector Store[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/DocArrayHnswIndexDemo/#docarray-hnsw-vector-store)
============================================================================================================================================
