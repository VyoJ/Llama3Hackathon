...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/output_parsing/lmformatenforcer_regular_expressions/#lm-format-enforcer-regular-expression-generation)
...
[![Image 3: Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/run-llama/llama_index/blob/main/docs/docs/examples/output_parsing/lmformatenforcer_regular_expressions.ipynb)

LM Format Enforcer Regular Expression Generation[¶](https://docs.llamaindex.ai/en/stable/examples/output_parsing/lmformatenforcer_regular_expressions/#lm-format-enforcer-regular-expression-generation)
========================================================================================================================================================================================================
