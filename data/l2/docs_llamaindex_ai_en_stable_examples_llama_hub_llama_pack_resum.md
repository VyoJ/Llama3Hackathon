...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/llama_hub/llama_pack_resume/#llama-pack-resume-screener)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Llama Hub
        ...
        *    Llama Pack - Resume Screener 📄 [Llama Pack - Resume Screener 📄](https://docs.llamaindex.ai/en/stable/examples/llama_hub/llama_pack_resume/)
...
Llama Pack - Resume Screener 📄[¶](https://docs.llamaindex.ai/en/stable/examples/llama_hub/llama_pack_resume/#llama-pack-resume-screener)
=========================================================================================================================================
