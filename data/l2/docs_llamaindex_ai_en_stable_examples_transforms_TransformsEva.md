...
[Skip to content](https://docs.llamaindex.ai/en/stable/examples/transforms/TransformsEval/#transforms-evaluation)
...
*   [Examples](https://docs.llamaindex.ai/en/stable/examples/)
    ...
    *    Transforms
        ...
        *    Transforms Evaluation [Transforms Evaluation](https://docs.llamaindex.ai/en/stable/examples/transforms/TransformsEval/)
...
Transforms Evaluation[¶](https://docs.llamaindex.ai/en/stable/examples/transforms/TransformsEval/#transforms-evaluation)
========================================================================================================================
...
pipeline\_dict = {} html\_parser = HTMLNodeParser.from\_defaults() for k, extractor in extractor\_dict.items(): if k == "default": transformations = \[ html\_parser, sent\_parser\_o200, OpenAIEmbedding(), \] else: transformations = \[ html\_parser, sent\_parser\_o200, extractor, OpenAIEmbedding(), \] pipeline = IngestionPipeline(transformations=transformations) pipeline\_dict\[k\] = pipeline
