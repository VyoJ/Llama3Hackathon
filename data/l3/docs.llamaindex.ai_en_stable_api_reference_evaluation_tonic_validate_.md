...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/tonic_validate/#llama_index.evaluation.tonic_validate.AnswerConsistencyBinaryEvaluator)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Evaluation](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/)
        ...
        *    Tonic validate [Tonic validate](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/tonic_validate/)
            
            Table of contents
            
            *   [AnswerConsistencyBinaryEvaluator](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/tonic_validate/#llama_index.evaluation.tonic_validate.AnswerConsistencyBinaryEvaluator)
            *   [AnswerConsistencyEvaluator](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/tonic_validate/#llama_index.evaluation.tonic_validate.AnswerConsistencyEvaluator)
            *   [AnswerSimilarityEvaluator](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/tonic_validate/#llama_index.evaluation.tonic_validate.AnswerSimilarityEvaluator)
            *   [AugmentationAccuracyEvaluator](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/tonic_validate/#llama_index.evaluation.tonic_validate.AugmentationAccuracyEvaluator)
            *   [AugmentationPrecisionEvaluator](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/tonic_validate/#llama_index.evaluation.tonic_validate.AugmentationPrecisionEvaluator)
            *   [RetrievalPrecisionEvaluator](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/tonic_validate/#llama_index.evaluation.tonic_validate.RetrievalPrecisionEvaluator)
            *   [TonicValidateEvaluator](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/tonic_validate/#llama_index.evaluation.tonic_validate.TonicValidateEvaluator)
                
                *   [aevaluate\_run](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/tonic_validate/#llama_index.evaluation.tonic_validate.TonicValidateEvaluator.aevaluate_run)
                *   [evaluate\_run](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/tonic_validate/#llama_index.evaluation.tonic_validate.TonicValidateEvaluator.evaluate_run)
