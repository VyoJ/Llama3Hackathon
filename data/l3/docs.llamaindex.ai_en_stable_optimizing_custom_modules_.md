...
[Skip to content](https://docs.llamaindex.ai/en/stable/optimizing/custom_modules/#writing-custom-modules)
...
*    Advanced Topics
    ...
    *    Writing Custom Modules [Writing Custom Modules](https://docs.llamaindex.ai/en/stable/optimizing/custom_modules/)
        
        Table of contents
        
        *   [Custom LLMs](https://docs.llamaindex.ai/en/stable/optimizing/custom_modules/#custom-llms)
        *   [Custom Embeddings](https://docs.llamaindex.ai/en/stable/optimizing/custom_modules/#custom-embeddings)
        *   [Custom Output Parsers](https://docs.llamaindex.ai/en/stable/optimizing/custom_modules/#custom-output-parsers)
        *   [Custom Transformations](https://docs.llamaindex.ai/en/stable/optimizing/custom_modules/#custom-transformations)
        *   [Custom Retrievers](https://docs.llamaindex.ai/en/stable/optimizing/custom_modules/#custom-retrievers)
        *   [Custom Postprocessors/Rerankers](https://docs.llamaindex.ai/en/stable/optimizing/custom_modules/#custom-postprocessorsrerankers)
        *   [Custom Query Engines](https://docs.llamaindex.ai/en/stable/optimizing/custom_modules/#custom-query-engines)
        *   [Custom Agents](https://docs.llamaindex.ai/en/stable/optimizing/custom_modules/#custom-agents)
        *   [Custom Query Components (for use in Query Pipeline)](https://docs.llamaindex.ai/en/stable/optimizing/custom_modules/#custom-query-components-for-use-in-query-pipeline)
        *   [Other Ways of Customization](https://docs.llamaindex.ai/en/stable/optimizing/custom_modules/#other-ways-of-customization)
...
Writing Custom Modules[#](https://docs.llamaindex.ai/en/stable/optimizing/custom_modules/#writing-custom-modules "Permanent link")
==================================================================================================================================
