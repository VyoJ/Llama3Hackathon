Title: Component Wise Evaluation - LlamaIndex
...
[Skip to content](https://docs.llamaindex.ai/en/stable/optimizing/evaluation/component_wise_evaluation/#component-wise-evaluation)
...
*    Advanced Topics
    ...
    *    Evaluation
        ...
        *    Component Wise Evaluation [Component Wise Evaluation](https://docs.llamaindex.ai/en/stable/optimizing/evaluation/component_wise_evaluation/)
            
            Table of contents
            
            *   [Utilizing public benchmarks](https://docs.llamaindex.ai/en/stable/optimizing/evaluation/component_wise_evaluation/#utilizing-public-benchmarks)
            *   [Evaluating Retrieval](https://docs.llamaindex.ai/en/stable/optimizing/evaluation/component_wise_evaluation/#evaluating-retrieval)
                
                *   [BEIR dataset](https://docs.llamaindex.ai/en/stable/optimizing/evaluation/component_wise_evaluation/#beir-dataset)
                
            *   [Evaluating the Query Engine Components (e.g. Without Retrieval)](https://docs.llamaindex.ai/en/stable/optimizing/evaluation/component_wise_evaluation/#evaluating-the-query-engine-components-eg-without-retrieval)
                
                *   [HotpotQA Dataset](https://docs.llamaindex.ai/en/stable/optimizing/evaluation/component_wise_evaluation/#hotpotqa-dataset)
...
Component Wise Evaluation[#](https://docs.llamaindex.ai/en/stable/optimizing/evaluation/component_wise_evaluation/#component-wise-evaluation "Permanent link")
==============================================================================================================================================================
