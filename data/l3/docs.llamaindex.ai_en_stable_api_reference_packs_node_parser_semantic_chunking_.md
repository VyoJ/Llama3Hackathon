...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/node_parser_semantic_chunking/#llama_index.packs.node_parser_semantic_chunking.SemanticChunkingQueryEnginePack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Node parser semantic chunking [Node parser semantic chunking](https://docs.llamaindex.ai/en/stable/api_reference/packs/node_parser_semantic_chunking/)
            
            Table of contents
            
            *   [SemanticChunkingQueryEnginePack](https://docs.llamaindex.ai/en/stable/api_reference/packs/node_parser_semantic_chunking/#llama_index.packs.node_parser_semantic_chunking.SemanticChunkingQueryEnginePack)
                
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/node_parser_semantic_chunking/#llama_index.packs.node_parser_semantic_chunking.SemanticChunkingQueryEnginePack.run)
