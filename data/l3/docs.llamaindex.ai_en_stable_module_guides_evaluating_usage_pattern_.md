Title: Usage Pattern (Response Evaluation) - LlamaIndex
...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern/#usage-pattern-response-evaluation)
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Evaluation](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/)
        ...
        *    Usage Pattern (Response Evaluation) [Usage Pattern (Response Evaluation)](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern/)
            
            Table of contents
            
            *   [Using BaseEvaluator](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern/#using-baseevaluator)
            *   [Using EvaluationResult](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern/#using-evaluationresult)
            *   [Evaluating Response Faithfulness (i.e. Hallucination)](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern/#evaluating-response-faithfulness-ie-hallucination)
            *   [Evaluating Query + Response Relevancy](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern/#evaluating-query-response-relevancy)
            *   [Question Generation](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern/#question-generation)
            *   [Batch Evaluation](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern/#batch-evaluation)
            *   [Integrations](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern/#integrations)
                
                *   [DeepEval](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern/#deepeval)
...
Usage Pattern (Response Evaluation)[#](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern/#usage-pattern-response-evaluation "Permanent link")
=======================================================================================================================================================================
...
Evaluating Response Faithfulness (i.e. Hallucination)[#](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern/#evaluating-response-faithfulness-ie-hallucination "Permanent link")
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
![Image 5](https://docs.llamaindex.ai/en/stable/_static/evaluation/eval_query_sources.png)
