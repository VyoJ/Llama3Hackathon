...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/self_discover/#llama_index.packs.self_discover.SelfDiscoverPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Self discover [Self discover](https://docs.llamaindex.ai/en/stable/api_reference/packs/self_discover/)
            
            Table of contents
            
            *   [SelfDiscoverPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/self_discover/#llama_index.packs.self_discover.SelfDiscoverPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/self_discover/#llama_index.packs.self_discover.SelfDiscoverPack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/self_discover/#llama_index.packs.self_discover.SelfDiscoverPack.run)
