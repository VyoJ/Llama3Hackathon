...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/agent/lats/#llama_index.agent.lats.LATSAgentWorker)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Agents](https://docs.llamaindex.ai/en/stable/api_reference/agent/)
        ...
        *    Lats [Lats](https://docs.llamaindex.ai/en/stable/api_reference/agent/lats/)
            
            Table of contents
            
            *   [LATSAgentWorker](https://docs.llamaindex.ai/en/stable/api_reference/agent/lats/#llama_index.agent.lats.LATSAgentWorker)
