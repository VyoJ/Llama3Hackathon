...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/chat_engines/context/#llama_index.core.chat_engine.ContextChatEngine)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Chat Engines](https://docs.llamaindex.ai/en/stable/api_reference/chat_engines/)
        ...
        *    Context [Context](https://docs.llamaindex.ai/en/stable/api_reference/chat_engines/context/)
            
            Table of contents
            
            *   [ContextChatEngine](https://docs.llamaindex.ai/en/stable/api_reference/chat_engines/context/#llama_index.core.chat_engine.ContextChatEngine)
                
                *   [chat\_history](https://docs.llamaindex.ai/en/stable/api_reference/chat_engines/context/#llama_index.core.chat_engine.ContextChatEngine.chat_history)
                *   [from\_defaults](https://docs.llamaindex.ai/en/stable/api_reference/chat_engines/context/#llama_index.core.chat_engine.ContextChatEngine.from_defaults)
