...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/ollama_query_engine/#llama_index.packs.ollama_query_engine.OllamaQueryEnginePack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Ollama query engine [Ollama query engine](https://docs.llamaindex.ai/en/stable/api_reference/packs/ollama_query_engine/)
            
            Table of contents
            
            *   [OllamaQueryEnginePack](https://docs.llamaindex.ai/en/stable/api_reference/packs/ollama_query_engine/#llama_index.packs.ollama_query_engine.OllamaQueryEnginePack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/ollama_query_engine/#llama_index.packs.ollama_query_engine.OllamaQueryEnginePack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/ollama_query_engine/#llama_index.packs.ollama_query_engine.OllamaQueryEnginePack.run)
