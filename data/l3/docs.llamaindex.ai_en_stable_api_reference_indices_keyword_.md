...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/indices/keyword/#llama_index.core.indices.KeywordTableIndex)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Indexes](https://docs.llamaindex.ai/en/stable/api_reference/indices/)
        ...
        *    Keyword [Keyword](https://docs.llamaindex.ai/en/stable/api_reference/indices/keyword/)
            
            Table of contents
            
            *   [KeywordTableIndex](https://docs.llamaindex.ai/en/stable/api_reference/indices/keyword/#llama_index.core.indices.KeywordTableIndex)
            *   [SimpleKeywordTableIndex](https://docs.llamaindex.ai/en/stable/api_reference/indices/keyword/#llama_index.core.indices.SimpleKeywordTableIndex)
            *   [RAKEKeywordTableIndex](https://docs.llamaindex.ai/en/stable/api_reference/indices/keyword/#llama_index.core.indices.RAKEKeywordTableIndex)
