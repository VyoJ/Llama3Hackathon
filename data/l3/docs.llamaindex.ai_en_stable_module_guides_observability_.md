Title: Observability - LlamaIndex
...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/observability/#observability)
...
*   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/observability/#usage-pattern)
*   [Partner One-Click Integrations](https://docs.llamaindex.ai/en/stable/module_guides/observability/#partner-one-click-integrations)
    
    *   [LlamaTrace (Hosted Arize Phoenix)](https://docs.llamaindex.ai/en/stable/module_guides/observability/#llamatrace-hosted-arize-phoenix)
        
        *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/observability/#usage-pattern_1)
        *   [Guides](https://docs.llamaindex.ai/en/stable/module_guides/observability/#guides)
        
    *   [Arize Phoenix (local)](https://docs.llamaindex.ai/en/stable/module_guides/observability/#arize-phoenix-local)
        
        *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/observability/#usage-pattern_2)
        *   [Example Guides](https://docs.llamaindex.ai/en/stable/module_guides/observability/#example-guides)
        
    
*   [Other Partner One-Click Integrations (Legacy Modules)](https://docs.llamaindex.ai/en/stable/module_guides/observability/#other-partner-one-click-integrations-legacy-modules)
    
    *   [Langfuse](https://docs.llamaindex.ai/en/stable/module_guides/observability/#langfuse)
        
        *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/observability/#usage-pattern_3)
        *   [Guides](https://docs.llamaindex.ai/en/stable/module_guides/observability/#guides_1)
        
    *   [DeepEval](https://docs.llamaindex.ai/en/stable/module_guides/observability/#deepeval)
        
        *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/observability/#usage-pattern_4)
        
    *   [Weights and Biases Prompts](https://docs.llamaindex.ai/en/stable/module_guides/observability/#weights-and-biases-prompts)
        
        *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/observability/#usage-pattern_5)
        *   [Guides](https://docs.llamaindex.ai/en/stable/module_guides/observability/#guides_2)
        
    *   [OpenLLMetry](https://docs.llamaindex.ai/en/stable/module_guides/observability/#openllmetry)
        
        *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/observability/#usage-pattern_6)
        *   [Guides](https://docs.llamaindex.ai/en/stable/module_guides/observability/#guides_3)
        
    *   [OpenInference](https://docs.llamaindex.ai/en/stable/module_guides/observability/#openinference)
        
        *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/observability/#usage-pattern_7)
        *   [Guides](https://docs.llamaindex.ai/en/stable/module_guides/observability/#guides_4)
        
    *   [TruEra TruLens](https://docs.llamaindex.ai/en/stable/module_guides/observability/#truera-trulens)
        
        *   [Usage Pattern + Guides](https://docs.llamaindex.ai/en/stable/module_guides/observability/#usage-pattern-guides)
        *   [Guides](https://docs.llamaindex.ai/en/stable/module_guides/observability/#guides_5)
        
    *   [HoneyHive](https://docs.llamaindex.ai/en/stable/module_guides/observability/#honeyhive)
        
        *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/observability/#usage-pattern_8)
        *   [Guides](https://docs.llamaindex.ai/en/stable/module_guides/observability/#guides_6)
        
    *   [PromptLayer](https://docs.llamaindex.ai/en/stable/module_guides/observability/#promptlayer)
        
        *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/observability/#usage-pattern_9)
        *   [Guides](https://docs.llamaindex.ai/en/stable/module_guides/observability/#guides_7)
        
    *   [Langtrace](https://docs.llamaindex.ai/en/stable/module_guides/observability/#langtrace)
        
        *   [Install](https://docs.llamaindex.ai/en/stable/module_guides/observability/#install)
        *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/observability/#usage-pattern_10)
        *   [Guides](https://docs.llamaindex.ai/en/stable/module_guides/observability/#guides_8)
        
    *   [OpenLIT](https://docs.llamaindex.ai/en/stable/module_guides/observability/#openlit)
        
        *   [Install](https://docs.llamaindex.ai/en/stable/module_guides/observability/#install_1)
        *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/observability/#usage-pattern_11)
        *   [Guides](https://docs.llamaindex.ai/en/stable/module_guides/observability/#guides_9)
        
    *   [AgentOps](https://docs.llamaindex.ai/en/stable/module_guides/observability/#agentops)
        
        *   [Install](https://docs.llamaindex.ai/en/stable/module_guides/observability/#install_2)
        *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/observability/#usage-pattern_12)
        
    *   [Simple (LLM Inputs/Outputs)](https://docs.llamaindex.ai/en/stable/module_guides/observability/#simple-llm-inputsoutputs)
        
        *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/observability/#usage-pattern_13)
        
    
*   [More observability](https://docs.llamaindex.ai/en/stable/module_guides/observability/#more-observability)

Observability[#](https://docs.llamaindex.ai/en/stable/module_guides/observability/#observability "Permanent link")
==================================================================================================================
...
#### Usage Pattern[#](https://docs.llamaindex.ai/en/stable/module_guides/observability/#usage-pattern_3 "Permanent link")
...
#### Guides[#](https://docs.llamaindex.ai/en/stable/module_guides/observability/#guides_3 "Permanent link")
...
### TruEra TruLens[#](https://docs.llamaindex.ai/en/stable/module_guides/observability/#truera-trulens "Permanent link")
...
#### Install[#](https://docs.llamaindex.ai/en/stable/module_guides/observability/#install_2 "Permanent link")
