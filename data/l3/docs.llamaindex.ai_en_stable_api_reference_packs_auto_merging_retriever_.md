...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/auto_merging_retriever/#llama_index.packs.auto_merging_retriever.AutoMergingRetrieverPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Auto merging retriever [Auto merging retriever](https://docs.llamaindex.ai/en/stable/api_reference/packs/auto_merging_retriever/)
            
            Table of contents
            
            *   [AutoMergingRetrieverPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/auto_merging_retriever/#llama_index.packs.auto_merging_retriever.AutoMergingRetrieverPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/auto_merging_retriever/#llama_index.packs.auto_merging_retriever.AutoMergingRetrieverPack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/auto_merging_retriever/#llama_index.packs.auto_merging_retriever.AutoMergingRetrieverPack.run)
