Title: Usage Pattern (Retrieval) - LlamaIndex
...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern_retrieval/#usage-pattern-retrieval)
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Evaluation](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/)
        ...
        *    Usage Pattern (Retrieval) [Usage Pattern (Retrieval)](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern_retrieval/)
            
            Table of contents
            
            *   [Using RetrieverEvaluator](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern_retrieval/#using-retrieverevaluator)
            *   [Building an Evaluation Dataset](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern_retrieval/#building-an-evaluation-dataset)
                
                *   [Plugging it into RetrieverEvaluator](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern_retrieval/#plugging-it-into-retrieverevaluator)
...
Usage Pattern (Retrieval)[#](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/usage_pattern_retrieval/#usage-pattern-retrieval "Permanent link")
=============================================================================================================================================================
