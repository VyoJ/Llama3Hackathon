...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/agent/openai_legacy/#llama_index.agent.openai_legacy.ContextRetrieverOpenAIAgent)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Agents](https://docs.llamaindex.ai/en/stable/api_reference/agent/)
        ...
        *    Openai legacy [Openai legacy](https://docs.llamaindex.ai/en/stable/api_reference/agent/openai_legacy/)
            
            Table of contents
            
            *   [ContextRetrieverOpenAIAgent](https://docs.llamaindex.ai/en/stable/api_reference/agent/openai_legacy/#llama_index.agent.openai_legacy.ContextRetrieverOpenAIAgent)
                
                *   [from\_tools\_and\_retriever](https://docs.llamaindex.ai/en/stable/api_reference/agent/openai_legacy/#llama_index.agent.openai_legacy.ContextRetrieverOpenAIAgent.from_tools_and_retriever)
                *   [chat](https://docs.llamaindex.ai/en/stable/api_reference/agent/openai_legacy/#llama_index.agent.openai_legacy.ContextRetrieverOpenAIAgent.chat)
                *   [achat](https://docs.llamaindex.ai/en/stable/api_reference/agent/openai_legacy/#llama_index.agent.openai_legacy.ContextRetrieverOpenAIAgent.achat)
                *   [get\_tools](https://docs.llamaindex.ai/en/stable/api_reference/agent/openai_legacy/#llama_index.agent.openai_legacy.ContextRetrieverOpenAIAgent.get_tools)
                
            *   [FnRetrieverOpenAIAgent](https://docs.llamaindex.ai/en/stable/api_reference/agent/openai_legacy/#llama_index.agent.openai_legacy.FnRetrieverOpenAIAgent)
