...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/agents_lats/#llama_index.packs.agents_lats.LATSPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Agents lats [Agents lats](https://docs.llamaindex.ai/en/stable/api_reference/packs/agents_lats/)
            
            Table of contents
            
            *   [LATSPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/agents_lats/#llama_index.packs.agents_lats.LATSPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/agents_lats/#llama_index.packs.agents_lats.LATSPack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/agents_lats/#llama_index.packs.agents_lats.LATSPack.run)
