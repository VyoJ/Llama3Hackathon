...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/querying/router/#routers)
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Querying](https://docs.llamaindex.ai/en/stable/module_guides/querying/)
        ...
        *    Routing [Routing](https://docs.llamaindex.ai/en/stable/module_guides/querying/router/)
            
            Table of contents
            
            *   [Concept](https://docs.llamaindex.ai/en/stable/module_guides/querying/router/#concept)
            *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/querying/router/#usage-pattern)
            *   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/querying/router/#usage-pattern_1)
            *   [Defining a selector](https://docs.llamaindex.ai/en/stable/module_guides/querying/router/#defining-a-selector)
            *   [Using as a Query Engine](https://docs.llamaindex.ai/en/stable/module_guides/querying/router/#using-as-a-query-engine)
            *   [Using as a Retriever](https://docs.llamaindex.ai/en/stable/module_guides/querying/router/#using-as-a-retriever)
            *   [Using selector as a standalone module](https://docs.llamaindex.ai/en/stable/module_guides/querying/router/#using-selector-as-a-standalone-module)
...
Routers[#](https://docs.llamaindex.ai/en/stable/module_guides/querying/router/#routers "Permanent link")
========================================================================================================
