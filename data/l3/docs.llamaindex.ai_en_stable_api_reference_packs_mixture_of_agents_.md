...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/mixture_of_agents/#llama_index.packs.mixture_of_agents.MixtureOfAgentsPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Mixture of agents [Mixture of agents](https://docs.llamaindex.ai/en/stable/api_reference/packs/mixture_of_agents/)
            
            Table of contents
            
            *   [MixtureOfAgentsPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/mixture_of_agents/#llama_index.packs.mixture_of_agents.MixtureOfAgentsPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/mixture_of_agents/#llama_index.packs.mixture_of_agents.MixtureOfAgentsPack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/mixture_of_agents/#llama_index.packs.mixture_of_agents.MixtureOfAgentsPack.run)
