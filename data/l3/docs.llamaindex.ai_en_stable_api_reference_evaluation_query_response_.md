...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/query_response/#llama_index.core.evaluation.QueryResponseEvaluator)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Evaluation](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/)
        ...
        *    Query response [Query response](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/query_response/)
            
            Table of contents
            
            *   [QueryResponseEvaluator](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/query_response/#llama_index.core.evaluation.QueryResponseEvaluator)
            *   [RelevancyEvaluator](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/query_response/#llama_index.core.evaluation.RelevancyEvaluator)
                
                *   [aevaluate](https://docs.llamaindex.ai/en/stable/api_reference/evaluation/query_response/#llama_index.core.evaluation.RelevancyEvaluator.aevaluate)
