...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/deeplake_multimodal_retrieval/#llama_index.packs.deeplake_multimodal_retrieval.DeepLakeMultimodalRetrieverPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Deeplake multimodal retrieval [Deeplake multimodal retrieval](https://docs.llamaindex.ai/en/stable/api_reference/packs/deeplake_multimodal_retrieval/)
            
            Table of contents
            
            *   [DeepLakeMultimodalRetrieverPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/deeplake_multimodal_retrieval/#llama_index.packs.deeplake_multimodal_retrieval.DeepLakeMultimodalRetrieverPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/deeplake_multimodal_retrieval/#llama_index.packs.deeplake_multimodal_retrieval.DeepLakeMultimodalRetrieverPack.get_modules)
                *   [retrieve](https://docs.llamaindex.ai/en/stable/api_reference/packs/deeplake_multimodal_retrieval/#llama_index.packs.deeplake_multimodal_retrieval.DeepLakeMultimodalRetrieverPack.retrieve)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/deeplake_multimodal_retrieval/#llama_index.packs.deeplake_multimodal_retrieval.DeepLakeMultimodalRetrieverPack.run)
