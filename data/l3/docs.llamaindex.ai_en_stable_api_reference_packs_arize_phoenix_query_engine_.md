...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/arize_phoenix_query_engine/#llama_index.packs.arize_phoenix_query_engine.ArizePhoenixQueryEnginePack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Arize phoenix query engine [Arize phoenix query engine](https://docs.llamaindex.ai/en/stable/api_reference/packs/arize_phoenix_query_engine/)
            
            Table of contents
            
            *   [ArizePhoenixQueryEnginePack](https://docs.llamaindex.ai/en/stable/api_reference/packs/arize_phoenix_query_engine/#llama_index.packs.arize_phoenix_query_engine.ArizePhoenixQueryEnginePack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/arize_phoenix_query_engine/#llama_index.packs.arize_phoenix_query_engine.ArizePhoenixQueryEnginePack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/arize_phoenix_query_engine/#llama_index.packs.arize_phoenix_query_engine.ArizePhoenixQueryEnginePack.run)
