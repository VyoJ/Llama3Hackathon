...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/rag_cli_local/#llama_index.packs.rag_cli_local.LocalRAGCLIPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Rag cli local [Rag cli local](https://docs.llamaindex.ai/en/stable/api_reference/packs/rag_cli_local/)
            
            Table of contents
            
            *   [LocalRAGCLIPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/rag_cli_local/#llama_index.packs.rag_cli_local.LocalRAGCLIPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/rag_cli_local/#llama_index.packs.rag_cli_local.LocalRAGCLIPack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/rag_cli_local/#llama_index.packs.rag_cli_local.LocalRAGCLIPack.run)
