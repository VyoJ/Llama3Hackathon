...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/#usage-pattern)
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Querying](https://docs.llamaindex.ai/en/stable/module_guides/querying/)
        ...
        *   [Query Pipelines](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/)
            ...
            *    Usage Pattern [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/)
                
                Table of contents
                
                *   [Setting up a Pipeline](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/#setting-up-a-pipeline)
                    
                    *   [Defining a Sequential Chain](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/#defining-a-sequential-chain)
                    *   [Defining a DAG](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/#defining-a-dag)
                    
                *   [Running the Pipeline](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/#running-the-pipeline)
                    
                    *   [Single-Input/Single-Output](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/#single-inputsingle-output)
                    *   [Multi-Input/Multi-Output](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/#multi-inputmulti-output)
                    *   [Defining partials](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/#defining-partials)
                    *   [Batch Input](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/#batch-input)
                    *   [Intermediate outputs](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/#intermediate-outputs)
                    
                *   [Defining a Custom Query Component](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/#defining-a-custom-query-component)
                    
                    *   [Passing a Function to FnComponent](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/#passing-a-function-to-fncomponent)
                    *   [Subclassing a CustomQueryComponent](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/#subclassing-a-customquerycomponent)
                    
                *   [Ensuring outputs are compatible](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/#ensuring-outputs-are-compatible)
...
Usage Pattern[#](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/#usage-pattern "Permanent link")
====================================================================================================================================
...
Defining a Custom Query Component[#](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/usage_pattern/#defining-a-custom-query-component "Permanent link")
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
