...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/multi_document_agents/#llama_index.packs.multi_document_agents.MultiDocumentAgentsPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Multi document agents [Multi document agents](https://docs.llamaindex.ai/en/stable/api_reference/packs/multi_document_agents/)
            
            Table of contents
            
            *   [MultiDocumentAgentsPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/multi_document_agents/#llama_index.packs.multi_document_agents.MultiDocumentAgentsPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/multi_document_agents/#llama_index.packs.multi_document_agents.MultiDocumentAgentsPack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/multi_document_agents/#llama_index.packs.multi_document_agents.MultiDocumentAgentsPack.run)
