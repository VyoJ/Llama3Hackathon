...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/dense_x_retrieval/#llama_index.packs.dense_x_retrieval.DenseXRetrievalPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Dense x retrieval [Dense x retrieval](https://docs.llamaindex.ai/en/stable/api_reference/packs/dense_x_retrieval/)
            
            Table of contents
            
            *   [DenseXRetrievalPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/dense_x_retrieval/#llama_index.packs.dense_x_retrieval.DenseXRetrievalPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/dense_x_retrieval/#llama_index.packs.dense_x_retrieval.DenseXRetrievalPack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/dense_x_retrieval/#llama_index.packs.dense_x_retrieval.DenseXRetrievalPack.run)
