Title: Module Guides - LlamaIndex
...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/modules/#module-guides)
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Agents](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/)
        ...
        *    Module Guides [Module Guides](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/modules/)
            
            Table of contents
            
            *   [Agent with OpenAI Models](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/modules/#agent-with-openai-models)
            *   [\[Beta\] OpenAI Assistant Agent](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/modules/#beta-openai-assistant-agent)
            *   [Other Function Calling Agents](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/modules/#other-function-calling-agents)
            *   [ReAct Agent](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/modules/#react-agent)
            *   [Additional Agents (available on LlamaHub)](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/modules/#additional-agents-available-on-llamahub)
            *   [Custom Agents](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/modules/#custom-agents)
            *   [Lower-Level Agent API](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/modules/#lower-level-agent-api)
...
Module Guides[#](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/modules/#module-guides "Permanent link")
=============================================================================================================================
