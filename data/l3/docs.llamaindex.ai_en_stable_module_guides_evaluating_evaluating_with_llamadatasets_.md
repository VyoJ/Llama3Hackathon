Title: Evaluating With LabelledRagDataset's - LlamaIndex
...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/evaluating_with_llamadatasets/#evaluating-with-labelledragdatasets)
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Evaluation](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/)
        ...
        *    LlamaDatasets
            ...
            *    Evaluating With LabelledRagDataset's [Evaluating With LabelledRagDataset's](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/evaluating_with_llamadatasets/)
                
                Table of contents
                
                *   [Building A LabelledRagDataset](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/evaluating_with_llamadatasets/#building-a-labelledragdataset)
                *   [Using A LabelledRagDataset](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/evaluating_with_llamadatasets/#using-a-labelledragdataset)
                *   [Where To Find LabelledRagDataset's](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/evaluating_with_llamadatasets/#where-to-find-labelledragdatasets)
                    
                    *   [Contributing A LabelledRagDataset](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/evaluating_with_llamadatasets/#contributing-a-labelledragdataset)
                    
                *   [Now, Go And Build Robust LLM Applications](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/evaluating_with_llamadatasets/#now-go-and-build-robust-llm-applications)
                *   [Resources](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/evaluating_with_llamadatasets/#resources)
...
Evaluating With `LabelledRagDataset`'s[#](https://docs.llamaindex.ai/en/stable/module_guides/evaluating/evaluating_with_llamadatasets/#evaluating-with-labelledragdatasets "Permanent link")
============================================================================================================================================================================================
