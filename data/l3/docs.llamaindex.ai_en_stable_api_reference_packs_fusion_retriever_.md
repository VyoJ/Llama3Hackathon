...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/fusion_retriever/#llama_index.packs.fusion_retriever.HybridFusionRetrieverPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Fusion retriever [Fusion retriever](https://docs.llamaindex.ai/en/stable/api_reference/packs/fusion_retriever/)
            
            Table of contents
            
            *   [HybridFusionRetrieverPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/fusion_retriever/#llama_index.packs.fusion_retriever.HybridFusionRetrieverPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/fusion_retriever/#llama_index.packs.fusion_retriever.HybridFusionRetrieverPack.get_modules)
                *   [retrieve](https://docs.llamaindex.ai/en/stable/api_reference/packs/fusion_retriever/#llama_index.packs.fusion_retriever.HybridFusionRetrieverPack.retrieve)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/fusion_retriever/#llama_index.packs.fusion_retriever.HybridFusionRetrieverPack.run)
                
            *   [QueryRewritingRetrieverPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/fusion_retriever/#llama_index.packs.fusion_retriever.QueryRewritingRetrieverPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/fusion_retriever/#llama_index.packs.fusion_retriever.QueryRewritingRetrieverPack.get_modules)
                *   [retrieve](https://docs.llamaindex.ai/en/stable/api_reference/packs/fusion_retriever/#llama_index.packs.fusion_retriever.QueryRewritingRetrieverPack.retrieve)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/fusion_retriever/#llama_index.packs.fusion_retriever.QueryRewritingRetrieverPack.run)
