...
[Skip to content](https://docs.llamaindex.ai/en/stable/optimizing/building_rag_from_scratch/#building-rag-from-scratch-lower-level)
...
*    Advanced Topics
    ...
    *    Building RAG from Scratch (Lower-Level) [Building RAG from Scratch (Lower-Level)](https://docs.llamaindex.ai/en/stable/optimizing/building_rag_from_scratch/)
        
        Table of contents
        
        *   [Building Ingestion from Scratch](https://docs.llamaindex.ai/en/stable/optimizing/building_rag_from_scratch/#building-ingestion-from-scratch)
        *   [Building Vector Retrieval from Scratch](https://docs.llamaindex.ai/en/stable/optimizing/building_rag_from_scratch/#building-vector-retrieval-from-scratch)
        *   [Building Ingestion/Retrieval from Scratch (Open-Source/Local Components)](https://docs.llamaindex.ai/en/stable/optimizing/building_rag_from_scratch/#building-ingestionretrieval-from-scratch-open-sourcelocal-components)
        *   [Building a (Very Simple) Vector Store from Scratch](https://docs.llamaindex.ai/en/stable/optimizing/building_rag_from_scratch/#building-a-very-simple-vector-store-from-scratch)
        *   [Building Response Synthesis from Scratch](https://docs.llamaindex.ai/en/stable/optimizing/building_rag_from_scratch/#building-response-synthesis-from-scratch)
        *   [Building Evaluation from Scratch](https://docs.llamaindex.ai/en/stable/optimizing/building_rag_from_scratch/#building-evaluation-from-scratch)
        *   [Building Advanced RAG from Scratch](https://docs.llamaindex.ai/en/stable/optimizing/building_rag_from_scratch/#building-advanced-rag-from-scratch)
            
            *   [Building Hybrid Search from Scratch](https://docs.llamaindex.ai/en/stable/optimizing/building_rag_from_scratch/#building-hybrid-search-from-scratch)
            *   [Building a Router from Scratch](https://docs.llamaindex.ai/en/stable/optimizing/building_rag_from_scratch/#building-a-router-from-scratch)
            *   [Building RAG Fusion Retriever from Scratch](https://docs.llamaindex.ai/en/stable/optimizing/building_rag_from_scratch/#building-rag-fusion-retriever-from-scratch)
            
        *   [Building QA over Structured Data from Scratch](https://docs.llamaindex.ai/en/stable/optimizing/building_rag_from_scratch/#building-qa-over-structured-data-from-scratch)
...
Building RAG from Scratch (Lower-Level)[#](https://docs.llamaindex.ai/en/stable/optimizing/building_rag_from_scratch/#building-rag-from-scratch-lower-level "Permanent link")
=============================================================================================================================================================================
