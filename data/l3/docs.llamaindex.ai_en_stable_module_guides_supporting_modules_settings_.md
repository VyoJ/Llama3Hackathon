...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/supporting_modules/settings/#configuring-settings)
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *    Settings [Settings](https://docs.llamaindex.ai/en/stable/module_guides/supporting_modules/settings/)
        
        Table of contents
        
        *   [LLM](https://docs.llamaindex.ai/en/stable/module_guides/supporting_modules/settings/#llm)
        *   [Embed Model](https://docs.llamaindex.ai/en/stable/module_guides/supporting_modules/settings/#embed-model)
        *   [Node Parser / Text Splitter](https://docs.llamaindex.ai/en/stable/module_guides/supporting_modules/settings/#node-parser-text-splitter)
        *   [Transformations](https://docs.llamaindex.ai/en/stable/module_guides/supporting_modules/settings/#transformations)
        *   [Tokenizer](https://docs.llamaindex.ai/en/stable/module_guides/supporting_modules/settings/#tokenizer)
        *   [Callbacks](https://docs.llamaindex.ai/en/stable/module_guides/supporting_modules/settings/#callbacks)
        *   [Prompt Helper Arguments](https://docs.llamaindex.ai/en/stable/module_guides/supporting_modules/settings/#prompt-helper-arguments)
        *   [Setting local configurations](https://docs.llamaindex.ai/en/stable/module_guides/supporting_modules/settings/#setting-local-configurations)
...
Configuring Settings[#](https://docs.llamaindex.ai/en/stable/module_guides/supporting_modules/settings/#configuring-settings "Permanent link")
==============================================================================================================================================
