...
[Skip to content](https://docs.llamaindex.ai/en/stable/optimizing/fine-tuning/fine-tuning/#fine-tuning)
...
*    Advanced Topics
    ...
    *    Fine-Tuning [Fine-Tuning](https://docs.llamaindex.ai/en/stable/optimizing/fine-tuning/fine-tuning/)
        
        Table of contents
        
        *   [Overview](https://docs.llamaindex.ai/en/stable/optimizing/fine-tuning/fine-tuning/#overview)
            
            *   [Embedding Finetuning Benefits](https://docs.llamaindex.ai/en/stable/optimizing/fine-tuning/fine-tuning/#embedding-finetuning-benefits)
            *   [LLM Finetuning Benefits](https://docs.llamaindex.ai/en/stable/optimizing/fine-tuning/fine-tuning/#llm-finetuning-benefits)
            
        *   [Integrations with LlamaIndex](https://docs.llamaindex.ai/en/stable/optimizing/fine-tuning/fine-tuning/#integrations-with-llamaindex)
        *   [Finetuning Embeddings](https://docs.llamaindex.ai/en/stable/optimizing/fine-tuning/fine-tuning/#finetuning-embeddings)
        *   [Fine-tuning LLMs](https://docs.llamaindex.ai/en/stable/optimizing/fine-tuning/fine-tuning/#fine-tuning-llms)
            
            *   [Fine-tuning GPT-3.5 to distill GPT-4](https://docs.llamaindex.ai/en/stable/optimizing/fine-tuning/fine-tuning/#fine-tuning-gpt-35-to-distill-gpt-4)
            *   [Fine-tuning for Better Structured Outputs](https://docs.llamaindex.ai/en/stable/optimizing/fine-tuning/fine-tuning/#fine-tuning-for-better-structured-outputs)
            *   [Fine-tuning Llama 2 for Better Text-to-SQL](https://docs.llamaindex.ai/en/stable/optimizing/fine-tuning/fine-tuning/#fine-tuning-llama-2-for-better-text-to-sql)
            *   [Fine-tuning An Evaluator](https://docs.llamaindex.ai/en/stable/optimizing/fine-tuning/fine-tuning/#fine-tuning-an-evaluator)
            
        *   [Fine-tuning Cross-Encoders for Re-Ranking](https://docs.llamaindex.ai/en/stable/optimizing/fine-tuning/fine-tuning/#fine-tuning-cross-encoders-for-re-ranking)
        *   [Cohere Custom Reranker](https://docs.llamaindex.ai/en/stable/optimizing/fine-tuning/fine-tuning/#cohere-custom-reranker)
...
Fine-tuning[#](https://docs.llamaindex.ai/en/stable/optimizing/fine-tuning/fine-tuning/#fine-tuning "Permanent link")
=====================================================================================================================
