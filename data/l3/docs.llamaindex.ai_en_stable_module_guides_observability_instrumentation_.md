Title: Instrumentation - LlamaIndex
...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/observability/instrumentation/#instrumentation)
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Observability](https://docs.llamaindex.ai/en/stable/module_guides/observability/)
        ...
        *    Instrumentation [Instrumentation](https://docs.llamaindex.ai/en/stable/module_guides/observability/instrumentation/)
            
            Table of contents
            
            *   [Using the Instrumentation Module for Observability](https://docs.llamaindex.ai/en/stable/module_guides/observability/instrumentation/#using-the-instrumentation-module-for-observability)
            *   [Usage](https://docs.llamaindex.ai/en/stable/module_guides/observability/instrumentation/#usage)
                
                *   [Defining a custom EventHandler](https://docs.llamaindex.ai/en/stable/module_guides/observability/instrumentation/#defining-a-custom-eventhandler)
                *   [Defining a custom Event](https://docs.llamaindex.ai/en/stable/module_guides/observability/instrumentation/#defining-a-custom-event)
                *   [Defining a custom Span](https://docs.llamaindex.ai/en/stable/module_guides/observability/instrumentation/#defining-a-custom-span)
                *   [Entering/Exiting a Span](https://docs.llamaindex.ai/en/stable/module_guides/observability/instrumentation/#enteringexiting-a-span)
                *   [Making use of dispatcher hierarchy](https://docs.llamaindex.ai/en/stable/module_guides/observability/instrumentation/#making-use-of-dispatcher-hierarchy)
                
            *   [Notebook Guides:](https://docs.llamaindex.ai/en/stable/module_guides/observability/instrumentation/#notebook-guides)
            *   [API Reference](https://docs.llamaindex.ai/en/stable/module_guides/observability/instrumentation/#api-reference)
...
Instrumentation[#](https://docs.llamaindex.ai/en/stable/module_guides/observability/instrumentation/#instrumentation "Permanent link")
======================================================================================================================================
...
### Defining a custom `Span`[#](https://docs.llamaindex.ai/en/stable/module_guides/observability/instrumentation/#defining-a-custom-span "Permanent link")
