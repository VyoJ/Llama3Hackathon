...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/multi_tenancy_rag/#llama_index.packs.multi_tenancy_rag.MultiTenancyRAGPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Multi tenancy rag [Multi tenancy rag](https://docs.llamaindex.ai/en/stable/api_reference/packs/multi_tenancy_rag/)
            
            Table of contents
            
            *   [MultiTenancyRAGPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/multi_tenancy_rag/#llama_index.packs.multi_tenancy_rag.MultiTenancyRAGPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/multi_tenancy_rag/#llama_index.packs.multi_tenancy_rag.MultiTenancyRAGPack.get_modules)
                *   [add](https://docs.llamaindex.ai/en/stable/api_reference/packs/multi_tenancy_rag/#llama_index.packs.multi_tenancy_rag.MultiTenancyRAGPack.add)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/multi_tenancy_rag/#llama_index.packs.multi_tenancy_rag.MultiTenancyRAGPack.run)
