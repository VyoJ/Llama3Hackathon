Title: Chat Stores - LlamaIndex

URL Source: https://docs.llamaindex.ai/en/stable/module_guides/storing/chat_stores/

Markdown Content:
Chat Stores - LlamaIndex
===============
             

[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/storing/chat_stores/#chat-stores)
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Storing](https://docs.llamaindex.ai/en/stable/module_guides/storing/)
        ...
        *    Chat Stores [Chat Stores](https://docs.llamaindex.ai/en/stable/module_guides/storing/chat_stores/)
            
            Table of contents
            
            *   [SimpleChatStore](https://docs.llamaindex.ai/en/stable/module_guides/storing/chat_stores/#simplechatstore)
            *   [RedisChatStore](https://docs.llamaindex.ai/en/stable/module_guides/storing/chat_stores/#redischatstore)
            *   [AzureChatStore](https://docs.llamaindex.ai/en/stable/module_guides/storing/chat_stores/#azurechatstore)
...
Chat Stores[#](https://docs.llamaindex.ai/en/stable/module_guides/storing/chat_stores/#chat-stores "Permanent link")
====================================================================================================================
...
SimpleChatStore[#](https://docs.llamaindex.ai/en/stable/module_guides/storing/chat_stores/#simplechatstore "Permanent link")
----------------------------------------------------------------------------------------------------------------------------
...
RedisChatStore[#](https://docs.llamaindex.ai/en/stable/module_guides/storing/chat_stores/#redischatstore "Permanent link")
--------------------------------------------------------------------------------------------------------------------------
...
AzureChatStore[#](https://docs.llamaindex.ai/en/stable/module_guides/storing/chat_stores/#azurechatstore "Permanent link")
--------------------------------------------------------------------------------------------------------------------------
...
[Previous Index Stores](https://docs.llamaindex.ai/en/stable/module_guides/storing/index_stores/)[Next Key-Value Stores](https://docs.llamaindex.ai/en/stable/module_guides/storing/kv_stores/)
