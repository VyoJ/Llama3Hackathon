...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/infer_retrieve_rerank/#llama_index.packs.infer_retrieve_rerank.InferRetrieveRerankPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Infer retrieve rerank [Infer retrieve rerank](https://docs.llamaindex.ai/en/stable/api_reference/packs/infer_retrieve_rerank/)
            
            Table of contents
            
            *   [InferRetrieveRerankPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/infer_retrieve_rerank/#llama_index.packs.infer_retrieve_rerank.InferRetrieveRerankPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/infer_retrieve_rerank/#llama_index.packs.infer_retrieve_rerank.InferRetrieveRerankPack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/infer_retrieve_rerank/#llama_index.packs.infer_retrieve_rerank.InferRetrieveRerankPack.run)
