...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/fuzzy_citation/#llama_index.packs.fuzzy_citation.FuzzyCitationEnginePack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Fuzzy citation [Fuzzy citation](https://docs.llamaindex.ai/en/stable/api_reference/packs/fuzzy_citation/)
            
            Table of contents
            
            *   [FuzzyCitationEnginePack](https://docs.llamaindex.ai/en/stable/api_reference/packs/fuzzy_citation/#llama_index.packs.fuzzy_citation.FuzzyCitationEnginePack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/fuzzy_citation/#llama_index.packs.fuzzy_citation.FuzzyCitationEnginePack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/fuzzy_citation/#llama_index.packs.fuzzy_citation.FuzzyCitationEnginePack.run)
