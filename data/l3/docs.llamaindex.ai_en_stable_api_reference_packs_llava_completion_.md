...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/llava_completion/#llama_index.packs.llava_completion.LlavaCompletionPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Llava completion [Llava completion](https://docs.llamaindex.ai/en/stable/api_reference/packs/llava_completion/)
            
            Table of contents
            
            *   [LlavaCompletionPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/llava_completion/#llama_index.packs.llava_completion.LlavaCompletionPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/llava_completion/#llama_index.packs.llava_completion.LlavaCompletionPack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/llava_completion/#llama_index.packs.llava_completion.LlavaCompletionPack.run)
