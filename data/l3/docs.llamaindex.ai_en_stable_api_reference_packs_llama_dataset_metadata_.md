...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/llama_dataset_metadata/#llama_index.packs.llama_dataset_metadata.LlamaDatasetMetadataPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Llama dataset metadata [Llama dataset metadata](https://docs.llamaindex.ai/en/stable/api_reference/packs/llama_dataset_metadata/)
            
            Table of contents
            
            *   [LlamaDatasetMetadataPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/llama_dataset_metadata/#llama_index.packs.llama_dataset_metadata.LlamaDatasetMetadataPack)
                
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/llama_dataset_metadata/#llama_index.packs.llama_dataset_metadata.LlamaDatasetMetadataPack.run)
