...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/indices/colbert/#llama_index.indices.managed.colbert.ColbertIndex)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Indexes](https://docs.llamaindex.ai/en/stable/api_reference/indices/)
        ...
        *    Colbert [Colbert](https://docs.llamaindex.ai/en/stable/api_reference/indices/colbert/)
            
            Table of contents
            
            *   [ColbertIndex](https://docs.llamaindex.ai/en/stable/api_reference/indices/colbert/#llama_index.indices.managed.colbert.ColbertIndex)
                
                *   [query](https://docs.llamaindex.ai/en/stable/api_reference/indices/colbert/#llama_index.indices.managed.colbert.ColbertIndex.query)
