...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/deeplake_deepmemory_retriever/#llama_index.packs.deeplake_deepmemory_retriever.DeepMemoryRetrieverPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Deeplake deepmemory retriever [Deeplake deepmemory retriever](https://docs.llamaindex.ai/en/stable/api_reference/packs/deeplake_deepmemory_retriever/)
            
            Table of contents
            
            *   [DeepMemoryRetrieverPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/deeplake_deepmemory_retriever/#llama_index.packs.deeplake_deepmemory_retriever.DeepMemoryRetrieverPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/deeplake_deepmemory_retriever/#llama_index.packs.deeplake_deepmemory_retriever.DeepMemoryRetrieverPack.get_modules)
                *   [retrieve](https://docs.llamaindex.ai/en/stable/api_reference/packs/deeplake_deepmemory_retriever/#llama_index.packs.deeplake_deepmemory_retriever.DeepMemoryRetrieverPack.retrieve)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/deeplake_deepmemory_retriever/#llama_index.packs.deeplake_deepmemory_retriever.DeepMemoryRetrieverPack.run)
