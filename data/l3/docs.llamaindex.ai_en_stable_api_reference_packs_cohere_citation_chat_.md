...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/cohere_citation_chat/#llama_index.packs.cohere_citation_chat.CohereCitationChatEnginePack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Cohere citation chat [Cohere citation chat](https://docs.llamaindex.ai/en/stable/api_reference/packs/cohere_citation_chat/)
            
            Table of contents
            
            *   [CohereCitationChatEnginePack](https://docs.llamaindex.ai/en/stable/api_reference/packs/cohere_citation_chat/#llama_index.packs.cohere_citation_chat.CohereCitationChatEnginePack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/cohere_citation_chat/#llama_index.packs.cohere_citation_chat.CohereCitationChatEnginePack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/cohere_citation_chat/#llama_index.packs.cohere_citation_chat.CohereCitationChatEnginePack.run)
