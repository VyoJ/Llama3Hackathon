...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/agents_llm_compiler/#llama_index.packs.agents_llm_compiler.LLMCompilerAgentPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Agents llm compiler [Agents llm compiler](https://docs.llamaindex.ai/en/stable/api_reference/packs/agents_llm_compiler/)
            
            Table of contents
            
            *   [LLMCompilerAgentPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/agents_llm_compiler/#llama_index.packs.agents_llm_compiler.LLMCompilerAgentPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/agents_llm_compiler/#llama_index.packs.agents_llm_compiler.LLMCompilerAgentPack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/agents_llm_compiler/#llama_index.packs.agents_llm_compiler.LLMCompilerAgentPack.run)
