...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/module_usage/#module-usage)
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Querying](https://docs.llamaindex.ai/en/stable/module_guides/querying/)
        ...
        *   [Query Pipelines](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/)
            ...
            *    Module Usage [Module Usage](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/module_usage/)
                
                Table of contents
                
                *   [LLMs (both completion and chat)](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/module_usage/#llms-both-completion-and-chat)
                *   [Prompts](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/module_usage/#prompts)
                *   [Query Engines](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/module_usage/#query-engines)
                *   [Query Transforms](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/module_usage/#query-transforms)
                *   [Retrievers](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/module_usage/#retrievers)
                *   [Output Parsers](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/module_usage/#output-parsers)
                *   [Postprocessors/Rerankers](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/module_usage/#postprocessorsrerankers)
                *   [Response Synthesizers](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/module_usage/#response-synthesizers)
                *   [Other QueryPipeline objects](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/module_usage/#other-querypipeline-objects)
                *   [Custom Components](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/module_usage/#custom-components)
...
Module Usage[#](https://docs.llamaindex.ai/en/stable/module_guides/querying/pipeline/module_usage/#module-usage "Permanent link")
=================================================================================================================================
