...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/redis_ingestion_pipeline/#llama_index.packs.redis_ingestion_pipeline.RedisIngestionPipelinePack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Redis ingestion pipeline [Redis ingestion pipeline](https://docs.llamaindex.ai/en/stable/api_reference/packs/redis_ingestion_pipeline/)
            
            Table of contents
            
            *   [RedisIngestionPipelinePack](https://docs.llamaindex.ai/en/stable/api_reference/packs/redis_ingestion_pipeline/#llama_index.packs.redis_ingestion_pipeline.RedisIngestionPipelinePack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/redis_ingestion_pipeline/#llama_index.packs.redis_ingestion_pipeline.RedisIngestionPipelinePack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/redis_ingestion_pipeline/#llama_index.packs.redis_ingestion_pipeline.RedisIngestionPipelinePack.run)
