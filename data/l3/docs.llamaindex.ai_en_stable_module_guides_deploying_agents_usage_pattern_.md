...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/usage_pattern/#usage-pattern)
...
*   [Component Guides](https://docs.llamaindex.ai/en/stable/module_guides/)
    ...
    *   [Agents](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/)
        ...
        *    Usage Pattern [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/usage_pattern/)
            
            Table of contents
            
            *   [Getting Started](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/usage_pattern/#getting-started)
            *   [Defining Tools](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/usage_pattern/#defining-tools)
                
                *   [Query Engine Tools](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/usage_pattern/#query-engine-tools)
                *   [Use other agents as Tools](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/usage_pattern/#use-other-agents-as-tools)
                
            *   [Agent With Planning](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/usage_pattern/#agent-with-planning)
            *   [Lower-Level API](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/usage_pattern/#lower-level-api)
            *   [Customizing your Agent](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/usage_pattern/#customizing-your-agent)
            *   [Advanced Concepts (for OpenAIAgent, in beta)](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/usage_pattern/#advanced-concepts-for-openaiagent-in-beta)
                
                *   [Function Retrieval Agents](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/usage_pattern/#function-retrieval-agents)
                *   [Context Retrieval Agents](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/usage_pattern/#context-retrieval-agents)
                *   [Query Planning](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/usage_pattern/#query-planning)
...
Usage Pattern[#](https://docs.llamaindex.ai/en/stable/module_guides/deploying/agents/usage_pattern/#usage-pattern "Permanent link")
===================================================================================================================================
