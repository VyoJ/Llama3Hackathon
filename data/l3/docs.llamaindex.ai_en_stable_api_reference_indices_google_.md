...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/indices/google/#llama_index.indices.managed.google.GoogleIndex)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Indexes](https://docs.llamaindex.ai/en/stable/api_reference/indices/)
        ...
        *    Google [Google](https://docs.llamaindex.ai/en/stable/api_reference/indices/google/)
            
            Table of contents
            
            *   [GoogleIndex](https://docs.llamaindex.ai/en/stable/api_reference/indices/google/#llama_index.indices.managed.google.GoogleIndex)
                
                *   [corpus\_id](https://docs.llamaindex.ai/en/stable/api_reference/indices/google/#llama_index.indices.managed.google.GoogleIndex.corpus_id)
                *   [from\_corpus](https://docs.llamaindex.ai/en/stable/api_reference/indices/google/#llama_index.indices.managed.google.GoogleIndex.from_corpus)
                *   [create\_corpus](https://docs.llamaindex.ai/en/stable/api_reference/indices/google/#llama_index.indices.managed.google.GoogleIndex.create_corpus)
                *   [from\_documents](https://docs.llamaindex.ai/en/stable/api_reference/indices/google/#llama_index.indices.managed.google.GoogleIndex.from_documents)
                *   [insert\_documents](https://docs.llamaindex.ai/en/stable/api_reference/indices/google/#llama_index.indices.managed.google.GoogleIndex.insert_documents)
                *   [delete\_ref\_doc](https://docs.llamaindex.ai/en/stable/api_reference/indices/google/#llama_index.indices.managed.google.GoogleIndex.delete_ref_doc)
                *   [update\_ref\_doc](https://docs.llamaindex.ai/en/stable/api_reference/indices/google/#llama_index.indices.managed.google.GoogleIndex.update_ref_doc)
                *   [as\_retriever](https://docs.llamaindex.ai/en/stable/api_reference/indices/google/#llama_index.indices.managed.google.GoogleIndex.as_retriever)
                *   [as\_query\_engine](https://docs.llamaindex.ai/en/stable/api_reference/indices/google/#llama_index.indices.managed.google.GoogleIndex.as_query_engine)
