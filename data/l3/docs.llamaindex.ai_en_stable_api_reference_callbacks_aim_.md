...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/callbacks/aim/#llama_index.callbacks.aim.AimCallback)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Callbacks](https://docs.llamaindex.ai/en/stable/api_reference/callbacks/)
        ...
        *    Aim [Aim](https://docs.llamaindex.ai/en/stable/api_reference/callbacks/aim/)
            
            Table of contents
            
            *   [AimCallback](https://docs.llamaindex.ai/en/stable/api_reference/callbacks/aim/#llama_index.callbacks.aim.AimCallback)
                
                *   [on\_event\_start](https://docs.llamaindex.ai/en/stable/api_reference/callbacks/aim/#llama_index.callbacks.aim.AimCallback.on_event_start)
                *   [on\_event\_end](https://docs.llamaindex.ai/en/stable/api_reference/callbacks/aim/#llama_index.callbacks.aim.AimCallback.on_event_end)
