Title: Chroma autoretrieval - LlamaIndex
...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/chroma_autoretrieval/#llama_index.packs.chroma_autoretrieval.ChromaAutoretrievalPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Chroma autoretrieval [Chroma autoretrieval](https://docs.llamaindex.ai/en/stable/api_reference/packs/chroma_autoretrieval/)
            
            Table of contents
            
            *   [ChromaAutoretrievalPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/chroma_autoretrieval/#llama_index.packs.chroma_autoretrieval.ChromaAutoretrievalPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/chroma_autoretrieval/#llama_index.packs.chroma_autoretrieval.ChromaAutoretrievalPack.get_modules)
                *   [retrieve](https://docs.llamaindex.ai/en/stable/api_reference/packs/chroma_autoretrieval/#llama_index.packs.chroma_autoretrieval.ChromaAutoretrievalPack.retrieve)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/chroma_autoretrieval/#llama_index.packs.chroma_autoretrieval.ChromaAutoretrievalPack.run)
