Title: End-to-End Evaluation - LlamaIndex
...
[Skip to content](https://docs.llamaindex.ai/en/stable/optimizing/evaluation/e2e_evaluation/#end-to-end-evaluation)
...
*    Advanced Topics
    ...
    *    Evaluation
        ...
        *    End-to-End Evaluation [End-to-End Evaluation](https://docs.llamaindex.ai/en/stable/optimizing/evaluation/e2e_evaluation/)
            
            Table of contents
            
            *   [Setting up an Evaluation Set](https://docs.llamaindex.ai/en/stable/optimizing/evaluation/e2e_evaluation/#setting-up-an-evaluation-set)
            *   [The Spectrum of Evaluation Options](https://docs.llamaindex.ai/en/stable/optimizing/evaluation/e2e_evaluation/#the-spectrum-of-evaluation-options)
            *   [Discovery - Sensitivity Testing](https://docs.llamaindex.ai/en/stable/optimizing/evaluation/e2e_evaluation/#discovery-sensitivity-testing)
            *   [Metrics Ensembling](https://docs.llamaindex.ai/en/stable/optimizing/evaluation/e2e_evaluation/#metrics-ensembling)
...
End-to-End Evaluation[#](https://docs.llamaindex.ai/en/stable/optimizing/evaluation/e2e_evaluation/#end-to-end-evaluation "Permanent link")
===========================================================================================================================================
