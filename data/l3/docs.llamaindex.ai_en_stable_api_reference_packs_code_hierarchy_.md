...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/code_hierarchy/#llama_index.packs.code_hierarchy.CodeHierarchyAgentPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Code hierarchy [Code hierarchy](https://docs.llamaindex.ai/en/stable/api_reference/packs/code_hierarchy/)
            
            Table of contents
            
            *   [CodeHierarchyAgentPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/code_hierarchy/#llama_index.packs.code_hierarchy.CodeHierarchyAgentPack)
                
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/code_hierarchy/#llama_index.packs.code_hierarchy.CodeHierarchyAgentPack.run)
