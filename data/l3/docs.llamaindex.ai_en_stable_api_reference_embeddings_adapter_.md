...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Embeddings](https://docs.llamaindex.ai/en/stable/api_reference/embeddings/)
        ...
        *    Adapter [Adapter](https://docs.llamaindex.ai/en/stable/api_reference/embeddings/adapter/)
            
            Table of contents
            
            *   [LinearAdapterEmbeddingModel](https://docs.llamaindex.ai/en/stable/api_reference/embeddings/adapter/#llama_index.embeddings.adapter.LinearAdapterEmbeddingModel)
            *   [AdapterEmbeddingModel](https://docs.llamaindex.ai/en/stable/api_reference/embeddings/adapter/#llama_index.embeddings.adapter.AdapterEmbeddingModel)
