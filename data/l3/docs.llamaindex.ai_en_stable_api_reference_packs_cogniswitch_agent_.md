...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/cogniswitch_agent/#llama_index.packs.cogniswitch_agent.CogniswitchAgentPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Cogniswitch agent [Cogniswitch agent](https://docs.llamaindex.ai/en/stable/api_reference/packs/cogniswitch_agent/)
            
            Table of contents
            
            *   [CogniswitchAgentPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/cogniswitch_agent/#llama_index.packs.cogniswitch_agent.CogniswitchAgentPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/cogniswitch_agent/#llama_index.packs.cogniswitch_agent.CogniswitchAgentPack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/cogniswitch_agent/#llama_index.packs.cogniswitch_agent.CogniswitchAgentPack.run)
