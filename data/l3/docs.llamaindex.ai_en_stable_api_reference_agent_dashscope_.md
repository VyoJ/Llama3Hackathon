...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/agent/dashscope/#llama_index.agent.dashscope.DashScopeAgent)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Agents](https://docs.llamaindex.ai/en/stable/api_reference/agent/)
        ...
        *    Dashscope [Dashscope](https://docs.llamaindex.ai/en/stable/api_reference/agent/dashscope/)
            
            Table of contents
            
            *   [DashScopeAgent](https://docs.llamaindex.ai/en/stable/api_reference/agent/dashscope/#llama_index.agent.dashscope.DashScopeAgent)
