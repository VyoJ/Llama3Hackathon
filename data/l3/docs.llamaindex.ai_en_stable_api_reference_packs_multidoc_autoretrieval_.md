...
[Skip to content](https://docs.llamaindex.ai/en/stable/api_reference/packs/multidoc_autoretrieval/#llama_index.packs.multidoc_autoretrieval.MultiDocAutoRetrieverPack)
...
*   [API Reference](https://docs.llamaindex.ai/en/stable/api_reference/)
    ...
    *   [Llama Packs](https://docs.llamaindex.ai/en/stable/api_reference/packs/)
        ...
        *    Multidoc autoretrieval [Multidoc autoretrieval](https://docs.llamaindex.ai/en/stable/api_reference/packs/multidoc_autoretrieval/)
            
            Table of contents
            
            *   [MultiDocAutoRetrieverPack](https://docs.llamaindex.ai/en/stable/api_reference/packs/multidoc_autoretrieval/#llama_index.packs.multidoc_autoretrieval.MultiDocAutoRetrieverPack)
                
                *   [get\_modules](https://docs.llamaindex.ai/en/stable/api_reference/packs/multidoc_autoretrieval/#llama_index.packs.multidoc_autoretrieval.MultiDocAutoRetrieverPack.get_modules)
                *   [run](https://docs.llamaindex.ai/en/stable/api_reference/packs/multidoc_autoretrieval/#llama_index.packs.multidoc_autoretrieval.MultiDocAutoRetrieverPack.run)
