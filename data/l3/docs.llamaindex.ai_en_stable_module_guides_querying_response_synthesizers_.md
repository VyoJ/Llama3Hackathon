Title: Response Synthesizer - LlamaIndex
...
[Skip to content](https://docs.llamaindex.ai/en/stable/module_guides/querying/response_synthesizers/#response-synthesizer)
...
*   [Concept](https://docs.llamaindex.ai/en/stable/module_guides/querying/response_synthesizers/#concept)
*   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/querying/response_synthesizers/#usage-pattern)
*   [Usage Pattern](https://docs.llamaindex.ai/en/stable/module_guides/querying/response_synthesizers/#usage-pattern_1)
*   [Get Started](https://docs.llamaindex.ai/en/stable/module_guides/querying/response_synthesizers/#get-started)
*   [Configuring the Response Mode](https://docs.llamaindex.ai/en/stable/module_guides/querying/response_synthesizers/#configuring-the-response-mode)
*   [Custom Response Synthesizers](https://docs.llamaindex.ai/en/stable/module_guides/querying/response_synthesizers/#custom-response-synthesizers)
*   [Using Structured Answer Filtering](https://docs.llamaindex.ai/en/stable/module_guides/querying/response_synthesizers/#using-structured-answer-filtering)
*   [Using Custom Prompt Templates (with additional variables)](https://docs.llamaindex.ai/en/stable/module_guides/querying/response_synthesizers/#using-custom-prompt-templates-with-additional-variables)
*   [Modules](https://docs.llamaindex.ai/en/stable/module_guides/querying/response_synthesizers/#modules)

Response Synthesizer[#](https://docs.llamaindex.ai/en/stable/module_guides/querying/response_synthesizers/#response-synthesizer "Permanent link")
=================================================================================================================================================
...
Get Started[#](https://docs.llamaindex.ai/en/stable/module_guides/querying/response_synthesizers/#get-started "Permanent link")
-------------------------------------------------------------------------------------------------------------------------------
