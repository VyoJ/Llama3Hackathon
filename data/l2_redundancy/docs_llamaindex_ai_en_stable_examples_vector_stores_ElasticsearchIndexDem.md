Title: Elasticsearch Vector Store - LlamaIndex
...
Configuring ElasticsearchStore[¶](https://docs.llamaindex.ai/en/stable/examples/vector_stores/ElasticsearchIndexDemo/#configuring-elasticsearchstore)
-----------------------------------------------------------------------------------------------------------------------------------------------------
